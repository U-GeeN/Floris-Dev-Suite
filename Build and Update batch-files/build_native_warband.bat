...
copy "..\Files\Other Files\Native\*.*" ".\" >>Process_Log.txt
copy "..\Source\Source - Native Warband\Data\*.*" ".\" >>Process_Log.txt
copy "..\Source\Source - Native Warband\Module\*.*" ".\" >>Process_Log.txt
copy "..\Source\Source - Native Warband\Variables\*.*" ".\" >>Process_Log.txt
copy "..\Source\Source - Native Warband\Other Files\*.*" ".\" >>Process_Log.txt
copy "..\Module Info\*.*" ".\" >>Process_Log.txt
copy "..\Source\Files for Batch\*.*" ".\" >>Process_Log.txt
python info.py
python dircreate.py
echo Copy Files...
copy "..\Files\Operations\native_files.py" ".\" >>Process_Log.txt
...
python Skyboxes.py
copy ".\header_*.py" "..\Source\Source - Native Warband\header files\" >>Process_Log.txt
copy ".\ID_*.py" "..\Source\Source - Native Warband\ID files\" >>Process_Log.txt
copy ".\process_*.py" "..\Source\Source - Native Warband\process files\" >>Process_Log.txt
