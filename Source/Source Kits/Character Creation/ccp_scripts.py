...
("ccp_initialize_faction_items",
	[
		# Define Swadia items.
		(troop_set_slot, ccp_data, ccp_swadia_item_trade1, "itm_trade_tools"),
		(troop_set_slot, ccp_data, ccp_swadia_item_trade2, "itm_trade_iron"),
		(troop_set_slot, ccp_data, ccp_swadia_item_horse, "itm_ho_swa_saddle_black"),
		(troop_set_slot, ccp_data, ccp_swadia_item_richhorse, "itm_ho_swa_destrier_black"),
		(troop_set_slot, ccp_data, ccp_swadia_item_shield, "itm_sh_swa_hea_english_a"),
		(troop_set_slot, ccp_data, ccp_swadia_item_instrument, "itm_sh_pla_mus_violin"),
		(troop_set_slot, ccp_data, ccp_swadia_item_poorboots, "itm_bo_swa_t0_sandal"),
		(troop_set_slot, ccp_data, ccp_swadia_item_boots, "itm_bo_swa_t1_sandal"),
		(troop_set_slot, ccp_data, ccp_swadia_item_richboots, "itm_bo_swa_t2_hose"),
		(troop_set_slot, ccp_data, ccp_swadia_item_cloth, "itm_ar_swa_tun_tabard"),
		(troop_set_slot, ccp_data, ccp_swadia_item_dress, "itm_dress_swadia_common_a"),
		(troop_set_slot, ccp_data, ccp_swadia_item_armor, "itm_ar_swa_t2_gambeson_a"),
		(troop_set_slot, ccp_data, ccp_swadia_item_gauntlets, "itm_ga_vae_a2_leather"),         # "itm_ga_swa_a2_leather"),
		(troop_set_slot, ccp_data, ccp_swadia_item_hood, "itm_he_swa_t1_common_a"),
		(troop_set_slot, ccp_data, ccp_swadia_item_helmet, "itm_he_swa_t2_coif_a"),
		(troop_set_slot, ccp_data, ccp_swadia_item_ladyhelmet, "itm_he_swa_lad_common_a"),
		(troop_set_slot, ccp_data, ccp_swadia_item_axe, "itm_we_swa_axe_hatchet"),              # Diff 0
		(troop_set_slot, ccp_data, ccp_swadia_item_blunt, "itm_we_swa_blunt_club"),             # Diff 0
		(troop_set_slot, ccp_data, ccp_swadia_item_dagger, "itm_we_swa_sword_clamshelldagger"), # Diff 0
		(troop_set_slot, ccp_data, ccp_swadia_item_spear, "itm_we_swa_spear_boar"),             # Diff 0
		(troop_set_slot, ccp_data, ccp_swadia_item_sword, "itm_we_swa_sword_senlac"),           # Diff 0
		(troop_set_slot, ccp_data, ccp_swadia_item_bow, "itm_we_swa_bow_practice"),             # Diff 0
		(troop_set_slot, ccp_data, ccp_swadia_item_arrow, "itm_we_swa_arrow_gromite"),          # Diff n/a
		(troop_set_slot, ccp_data, ccp_swadia_item_throwing, "itm_we_swa_throw_darts"),         # Diff 1, but downgrades to lesser knives if needed.
		
		# Define Vaegir items.
		(troop_set_slot, ccp_data, ccp_vaegir_item_trade1, "itm_trade_furs"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_trade2, "itm_trade_raw_leather"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_horse, "itm_ho_vae_saddle_feather"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_richhorse, "itm_ho_vae_rus_brown"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_shield, "itm_sh_vae_kit_fur"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_instrument, "itm_sh_pla_mus_lyre"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_poorboots, "itm_bo_vae_t0_sandal"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_boots, "itm_bo_vae_t1_sandal"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_richboots, "itm_bo_vae_t2_shoes"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_cloth, "itm_ar_vae_tun_red"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_dress, "itm_dress_vaegir_common_a"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_armor, "itm_ar_vae_ban_tribal_a"),          # "itm_ar_vae_t2_leather_a"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_gauntlets, "itm_ga_vae_a2_leather"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_hood, "itm_he_vae_t1_common_a"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_helmet, "itm_he_vae_t2_furcap_a"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_ladyhelmet, "itm_he_vae_lad_common_a"),
		(troop_set_slot, ccp_data, ccp_vaegir_item_axe, "itm_we_vae_axe_onehanded"),           # Diff 0
		(troop_set_slot, ccp_data, ccp_vaegir_item_blunt, "itm_we_vae_blunt_hammer"),          # Diff 0
		(troop_set_slot, ccp_data, ccp_vaegir_item_dagger, "itm_we_vae_sword_sickle"),         # Diff 0
		(troop_set_slot, ccp_data, ccp_vaegir_item_spear, "itm_we_vae_spear_scythe"),          # Diff 0
		(troop_set_slot, ccp_data, ccp_vaegir_item_sword, "itm_we_vae_sword_sickle"),          # Diff 0
		(troop_set_slot, ccp_data, ccp_vaegir_item_bow, "itm_we_vae_bow_hunting"),             # Diff 2, but downgrades to lesser bow if needed.
		(troop_set_slot, ccp_data, ccp_vaegir_item_arrow, "itm_we_vae_arrow_sharp"),           # Diff n/a
		(troop_set_slot, ccp_data, ccp_vaegir_item_throwing, "itm_we_vae_sword_throw_knives"), # Diff 0
		
		# Define Khergit items.
		(troop_set_slot, ccp_data, ccp_khergit_item_trade1, "itm_trade_spice"),
		(troop_set_slot, ccp_data, ccp_khergit_item_trade2, "itm_trade_pottery"),
		(troop_set_slot, ccp_data, ccp_khergit_item_horse, "itm_ho_khe_saddle_coloured"),
		(troop_set_slot, ccp_data, ccp_khergit_item_richhorse, "itm_ho_khe_steppe_brownpainted"),
		(troop_set_slot, ccp_data, ccp_khergit_item_shield, "itm_sh_khe_rou_old"),
		(troop_set_slot, ccp_data, ccp_khergit_item_instrument, "itm_sh_pla_mus_lute"),
		(troop_set_slot, ccp_data, ccp_khergit_item_poorboots, "itm_bo_khe_t0_sandal"),
		(troop_set_slot, ccp_data, ccp_khergit_item_boots, "itm_bo_khe_t1_sandal"),
		(troop_set_slot, ccp_data, ccp_khergit_item_richboots, "itm_bo_khe_t2_boots"),
		(troop_set_slot, ccp_data, ccp_khergit_item_cloth, "itm_ar_khe_tun_furcoat"),
		(troop_set_slot, ccp_data, ccp_khergit_item_dress, "itm_dress_khergit_common_a"),
		(troop_set_slot, ccp_data, ccp_khergit_item_armor, "itm_ar_khe_t2_armor_a"),
		(troop_set_slot, ccp_data, ccp_khergit_item_gauntlets, "itm_ga_khe_a2_leather"),
		(troop_set_slot, ccp_data, ccp_khergit_item_hood, "itm_he_khe_t1_common_a"),
		(troop_set_slot, ccp_data, ccp_khergit_item_helmet, "itm_he_khe_t2_steppe_a"),
		(troop_set_slot, ccp_data, ccp_khergit_item_ladyhelmet, "itm_he_khe_lad_common_a"),
		(troop_set_slot, ccp_data, ccp_khergit_item_axe, "itm_we_khe_axe_steppe"),              # Diff 0
		(troop_set_slot, ccp_data, ccp_khergit_item_blunt, "itm_we_khe_blunt_club"),            # Diff 0
		(troop_set_slot, ccp_data, ccp_khergit_item_dagger, "itm_we_khe_sword_dagger"),         # Diff 0
		(troop_set_slot, ccp_data, ccp_khergit_item_spear, "itm_we_khe_spear_staff"),           # Diff 0
		(troop_set_slot, ccp_data, ccp_khergit_item_sword, "itm_we_khe_sword_executionerone"),  # Diff 0
		(troop_set_slot, ccp_data, ccp_khergit_item_bow, "itm_we_khe_bow_red"),                 # Diff 2, but downgrades to lesser bow if needed.
		(troop_set_slot, ccp_data, ccp_khergit_item_arrow, "itm_we_khe_arrow_khergit"),         # Diff n/a
		(troop_set_slot, ccp_data, ccp_khergit_item_throwing, "itm_we_khe_throw_stone"),        # Diff 0
		
		# Define Nord items.
		(troop_set_slot, ccp_data, ccp_nord_item_trade1, "itm_trade_wool_cloth"),
		(troop_set_slot, ccp_data, ccp_nord_item_trade2, "itm_trade_wool"),
		(troop_set_slot, ccp_data, ccp_nord_item_horse, "itm_ho_nor_mule"),
		(troop_set_slot, ccp_data, ccp_nord_item_richhorse, "itm_ho_nor_courser_greysteel"),
		(troop_set_slot, ccp_data, ccp_nord_item_shield, "itm_sh_nor_rou_small_a"),
		(troop_set_slot, ccp_data, ccp_nord_item_instrument, "itm_sh_pla_mus_lute"),
		(troop_set_slot, ccp_data, ccp_nord_item_poorboots, "itm_bo_nor_t0_sandal"),
		(troop_set_slot, ccp_data, ccp_nord_item_boots, "itm_bo_nor_t1_sandal"),
		(troop_set_slot, ccp_data, ccp_nord_item_richboots, "itm_bo_nor_t2_shoes"),
		(troop_set_slot, ccp_data, ccp_nord_item_cloth, "itm_ar_nor_tun_blue"),
		(troop_set_slot, ccp_data, ccp_nord_item_dress, "itm_dress_nord_common_a"),
		(troop_set_slot, ccp_data, ccp_nord_item_armor, "itm_ar_nor_t2_vikinglamellar_a"),
		(troop_set_slot, ccp_data, ccp_nord_item_gauntlets, "itm_ga_nor_a2_leather"),
		(troop_set_slot, ccp_data, ccp_nord_item_hood, "itm_he_nor_t1_common_a"),
		(troop_set_slot, ccp_data, ccp_nord_item_helmet, "itm_he_nor_t2_spangen_a"),
		(troop_set_slot, ccp_data, ccp_nord_item_ladyhelmet, "itm_he_nor_lad_common_a"),
		(troop_set_slot, ccp_data, ccp_nord_item_axe, "itm_we_nor_axe_jomsviking"),             # Diff 0
		(troop_set_slot, ccp_data, ccp_nord_item_blunt, "itm_we_nor_blunt_stick"),              # Diff 0
		(troop_set_slot, ccp_data, ccp_nord_item_dagger, "itm_we_nor_sword_seax"),              # Diff 0
		(troop_set_slot, ccp_data, ccp_nord_item_spear, "itm_we_nor_spear_sviar"),              # Diff 0
		(troop_set_slot, ccp_data, ccp_nord_item_sword, "itm_we_nor_sword_pict"),               # Diff 0
		(troop_set_slot, ccp_data, ccp_nord_item_bow, "itm_we_nor_bow_hunting"),                # Diff 0
		(troop_set_slot, ccp_data, ccp_nord_item_arrow, "itm_we_nor_arrow_bodkin"),             # Diff n/a
		(troop_set_slot, ccp_data, ccp_nord_item_throwing, "itm_we_nor_axe_throw_light"),       # Diff 1, but downgrades to lesser knives if needed.
		
		# Define Rhodok items.
		(troop_set_slot, ccp_data, ccp_rhodok_item_trade1, "itm_trade_velvet"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_trade2, "itm_trade_raw_dyes"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_horse, "itm_ho_rho_donkey_brown"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_richhorse, "itm_ho_rho_rouncy_brown"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_shield, "itm_sh_rho_buc_steel_a"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_instrument, "itm_sh_pla_mus_violin"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_poorboots, "itm_bo_rho_t0_sandal"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_boots, "itm_bo_rho_t1_bear"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_richboots, "itm_bo_rho_t2_highlander"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_cloth, "itm_ar_rho_tun_vest"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_dress, "itm_dress_rhodok_common_a"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_armor, "itm_ar_rho_ban_highlander_a"),      # "itm_ar_rho_t2_ragged_a"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_gauntlets, "itm_ga_rho_a2_leather"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_hood, "itm_he_rho_t1_common_a"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_helmet, "itm_he_rho_t2_beret_a"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_ladyhelmet, "itm_he_rho_lad_common_a"),
		(troop_set_slot, ccp_data, ccp_rhodok_item_axe, "itm_we_rho_axe_pick"),                # Diff 0
		(troop_set_slot, ccp_data, ccp_rhodok_item_blunt, "itm_we_rho_blunt_club"),            # Diff 0
		(troop_set_slot, ccp_data, ccp_rhodok_item_dagger, "itm_we_rho_sword_rondeldagger"),   # Diff 0
		(troop_set_slot, ccp_data, ccp_rhodok_item_spear, "itm_we_rho_spear_fork_pitch"),      # Diff 0
		(troop_set_slot, ccp_data, ccp_rhodok_item_sword, "itm_we_rho_sword_short"),           # Diff 0
		(troop_set_slot, ccp_data, ccp_rhodok_item_bow, "itm_we_rho_crossbow_hunting"),        # Diff 0
		(troop_set_slot, ccp_data, ccp_rhodok_item_arrow, "itm_we_rho_bolt"),                  # Diff n/a
		(troop_set_slot, ccp_data, ccp_rhodok_item_throwing, "itm_we_rho_throw_stone"),        # Diff 0
		
		# Define Sarrand items.
		(troop_set_slot, ccp_data, ccp_sarrand_item_trade1, "itm_trade_salt"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_trade2, "itm_trade_raw_date_fruit"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_horse, "itm_ho_sar_camel_bactrian"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_richhorse, "itm_ho_sar_arab_dun"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_shield, "itm_sh_sar_rou_plain"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_instrument, "itm_sh_pla_mus_lyre"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_poorboots, "itm_bo_sar_t0_sandal"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_boots, "itm_bo_sar_t1_sandal"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_richboots, "itm_bo_sar_t2_shoes"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_cloth, "itm_ar_sar_tun_robeblack"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_dress, "itm_dress_sarranid_common_a"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_armor, "itm_ar_sar_t3_leather_a"),         # "itm_ar_sar_t2_quilted_a"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_gauntlets, "itm_ga_sar_a2_leather"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_hood, "itm_he_sar_t1_common_a"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_helmet, "itm_he_sar_t2_tuareg_a"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_ladyhelmet, "itm_he_sar_lad_common_a"),
		(troop_set_slot, ccp_data, ccp_sarrand_item_axe, "itm_we_sar_axe_onehanded"),          # Diff 0
		(troop_set_slot, ccp_data, ccp_sarrand_item_blunt, "itm_we_sar_blunt_maceiron"),       # Diff 0
		(troop_set_slot, ccp_data, ccp_sarrand_item_dagger, "itm_we_sar_sword_khyber"),        # Diff 0
		(troop_set_slot, ccp_data, ccp_sarrand_item_spear, "itm_we_sar_spear_staff"),          # Diff 0
		(troop_set_slot, ccp_data, ccp_sarrand_item_sword, "itm_we_sar_sword_sarranid"),       # Diff 0
		(troop_set_slot, ccp_data, ccp_sarrand_item_bow, "itm_we_sar_bow_practice"),           # Diff 0
		(troop_set_slot, ccp_data, ccp_sarrand_item_arrow, "itm_we_sar_arrow_sarranid"),       # Diff n/a
		(troop_set_slot, ccp_data, ccp_sarrand_item_throwing, "itm_we_sar_spear_javelin"),     # Diff 1, but downgrades to lesser knives if needed.
...
("ccp_generate_skill_set",
	[
		...
		(try_begin), #Reason for adventuring
			...
			(val_add, ":strength", 2),
			(val_add, ":skill_powerstrike", 1),
			(call_script, "script_ccp_add_item", "itm_trade_smoked_fish"),
		(else_try),
			(eq,"$background_answer_4", cb4_loss),
			(val_add, ":charisma", 2),
			(val_add, ":skill_ironflesh", 1),
			(call_script, "script_ccp_add_item", "itm_trade_dried_meat"),
		(else_try),
			(eq,"$background_answer_4", cb4_wanderlust),
			(val_add, ":agility", 2),
			# (val_add, ":skill_pathfinding", 1),
		...
		(else_try),
			...
			(val_add, ":intelligence", 1),
			(val_add, ":skill_weaponmaster", 1),
			(call_script, "script_ccp_add_item", "itm_trade_cabbages"),
		(else_try),
			(eq,"$background_answer_4", cb4_greed),
			(val_add, ":agility", 1),
			(val_add, ":intelligence", 1),
			(val_add, ":skill_looting", 1),
			(call_script, "script_ccp_add_item", "itm_trade_apples"),
		...
		(else_try),
			...
			(val_add, ":strength", 1),
			(val_add, ":skill_woundtreatment", 1),
		    (call_script, "script_ccp_add_item", "itm_trade_sausages"),
		(else_try),
		    (eq,"$background_answer_4", floris_cb4_duty),
			(val_add, ":strength", 1),
			(val_add, ":agility", 1),
		...
		(try_begin),
			...
			(try_begin),
				...
				(party_set_slot, "$current_town", slot_town_player_acres, ":lands"),
				(ge, DEBUG_CCP_general, 1),
				(str_store_party_name, s31, "$current_town"),
				(assign, reg31, ":lands"),
