...
("ccp_character_creation", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
		...
		(assign, ":pos_x_labels", 870),
		(call_script, "script_gpu_create_text_label", "str_ccp_label_region", ":pos_x_labels", 590, ccp_obj_label_region, gpu_center_with_outline),
		(overlay_set_color, reg1, gpu_white),
		...
		(call_script, "script_gpu_create_checkbox_white", 755, 460, "str_ccp_label_fog_of_war", ccp_obj_checkbox_fogofwar, ccp_val_checkbox_fogofwar),
		...
		############### ATTRIBUTES CONTAINER BEGIN ###############	
			...
			(store_sub, ":pos_y_temp", ":pos_y_misc", 20), # line used for new crown image.
			(store_sub, ":pos_x_temp", ":pos_x_misc_icon", 5), # 12 as a shield.
