...
["tpe_normal_boots",           "Tournament Greaves", [("bo_khe_t4_sandal",0)], itp_type_foot_armor |itp_civilian  | itp_attach_armature,0, 34 , weight(1)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(10)|difficulty(0) ,imodbits_cloth ],
["tpe_enhanced_boots",         "Tournament Greaves", [("bo_vae_t6_leather",0)], itp_type_foot_armor |itp_civilian  | itp_attach_armature,0, 34 , weight(1)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(20)|difficulty(0) ,imodbits_cloth ],
["tpe_normal_spear",           "Tournament Spear", [("we_swa_spear_boar",0)], itp_type_polearm| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear|itcf_overswing_polearm, 0 , weight(4.5)|difficulty(0)|spd_rtng(85) | weapon_length(120)|swing_damage(12 , blunt) | thrust_damage(18 ,  blunt),imodbits_polearm ],
["tpe_enhanced_spear",         "Tournament Spear", [("we_swa_spear_boar",0)], itp_type_polearm| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear|itcf_overswing_polearm, 0 , weight(4.5)|difficulty(0)|spd_rtng(85) | weapon_length(140)|swing_damage(17 , blunt) | thrust_damage(25 ,  blunt),imodbits_polearm ],
["tpe_normal_bow",             "Tournament Bow", [("we_nor_bow_hunting",0), ("we_nor_bow_hunting_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bow_back, 0, weight(1.5)|spd_rtng(90) | shoot_speed(40) | thrust_damage(21, blunt),imodbits_bow ],
["tpe_enhanced_bow",           "Tournament Bow", [("we_nor_bow",0), ("we_nor_bow_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bow_back, 0, weight(1.5)|spd_rtng(95) | shoot_speed(40) | thrust_damage(29, blunt),imodbits_bow ],
["tpe_normal_crossbow",        "Tournament Crossbow", [("we_rho_crossbow_hunting",0)], itp_type_crossbow |itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 0, weight(3)|spd_rtng(50)| shoot_speed(68) | thrust_damage(40,blunt)|max_ammo(1),imodbits_crossbow],
["tpe_enhanced_crossbow",      "Tournament Crossbow", [("we_rho_crossbow",0)], itp_type_crossbow |itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 0, weight(3)|spd_rtng(60)| shoot_speed(68) | thrust_damage(56,blunt)|max_ammo(1),imodbits_crossbow],
["tpe_normal_javelin",         "Tournament Javelins", [("we_sar_spear_javelin",0),("we_sar_spear_javelin_quiver", ixmesh_carry)], itp_type_thrown |itp_primary|itp_next_item_as_melee,itcf_throw_javelin|itcf_carry_quiver_back|itcf_show_holster_when_drawn, 0, weight(5) | spd_rtng(85) | shoot_speed(28) | thrust_damage(24, blunt) | max_ammo(12) | weapon_length(75), imodbits_thrown],
	["tpe_normal_javelin_melee",   "practice_javelin_melee", [("we_sar_spear_javelin",0)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_staff, 0, weight(1)|difficulty(0)|spd_rtng(90) |swing_damage(12, blunt)| thrust_damage(16,  blunt)|weapon_length(75),imodbits_polearm ],
["tpe_enhanced_javelin",       "Tournament Javelins", [("we_sar_spear_javelin",0),("we_sar_spear_javelin_quiver", ixmesh_carry)], itp_type_thrown |itp_primary|itp_next_item_as_melee,itcf_throw_javelin|itcf_carry_quiver_back|itcf_show_holster_when_drawn, 0, weight(5) | spd_rtng(90) | shoot_speed(28) | thrust_damage(34, blunt) | max_ammo(12) | weapon_length(75), imodbits_thrown],
	["tpe_enhanced_javelin_melee", "Tournament Javelin Melee", [("we_sar_spear_javelin",0)], itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry , itc_staff, 0, weight(1)|difficulty(0)|spd_rtng(95) |swing_damage(12, blunt)| thrust_damage(22,  blunt)|weapon_length(90),imodbits_polearm ],
["tpe_normal_sword",           "Tournament Sword", [("we_pla_sword_reeve",0),("we_pla_scabbard_reeve", ixmesh_carry)], itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry|itp_wooden_attack, itc_longsword, 3,weight(1.5)|spd_rtng(95)|weapon_length(95)|swing_damage(18,blunt)|thrust_damage(16,blunt),imodbits_none],
["tpe_enhanced_sword",         "Tournament Sword", [("we_pla_sword_ritter",0),("we_pla_scabbard_ritter", ixmesh_carry)], itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_wooden_parry|itp_wooden_attack, itc_longsword, 243 , weight(1.5)|spd_rtng(105) | weapon_length(95)|swing_damage(25 , blunt) | thrust_damage(22 ,  blunt),imodbits_none ],
["tpe_normal_greatsword",      "Tournament Greatsword", [("we_pla_sword_grosser_messer",0),("we_pla_scabbard_grosser_messer", ixmesh_carry)], itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_greatsword, 21, weight(6.25)|spd_rtng(80)|weapon_length(93)|swing_damage(27,blunt)|thrust_damage(22,blunt),imodbits_none],
["tpe_enhanced_greatsword",    "Tournament Greatsword", [("we_pla_sword_zweilander",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back, 670 , weight(2.75)|spd_rtng(90) | weapon_length(130)|swing_damage(38 , blunt) | thrust_damage(27 ,  blunt),imodbits_sword_high ],
["tpe_normal_lance",           "Tournament Lance", [("we_swa_spear_lance_jousting",0)], itp_couchable|itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack, itc_greatlance, 18, weight(4.25) |spd_rtng(70)|weapon_length(200)|swing_damage(10,blunt)|thrust_damage(15,blunt),imodbits_none],
["tpe_enhanced_lance",         "Tournament Lance", [("we_swa_spear_lance_great",0)], itp_couchable|itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack, itc_greatlance, 90 , weight(4.25)|spd_rtng(75) | weapon_length(240)|swing_damage(14 , blunt) | thrust_damage(21 ,  blunt),imodbits_none ],
# ["tpe_enhanced_horse",         "Tournament Warhorse", [("ho_rho_charger_chain",0)], itp_type_horse, 0, 1224,abundance(50)|hit_points(165)|body_armor(40)|difficulty(0)|horse_speed(40)|horse_maneuver(41)|horse_charge(28)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
# These items are taken from OSP horse packs.  Need to find out exactly which ones.
...
# Edited for balance above this point.
["tpe_normal_throwing_daggers",   "Tournament Daggers", [("practice_dagger",0)], itp_type_thrown |itp_primary|itp_next_item_as_melee ,itcf_throw_knife, 0 , weight(3.5)|difficulty(0)|spd_rtng(100) | shoot_speed(25) | thrust_damage(16 , blunt)|max_ammo(25)|weapon_length(0),imodbits_missile,missile_distance_trigger],
