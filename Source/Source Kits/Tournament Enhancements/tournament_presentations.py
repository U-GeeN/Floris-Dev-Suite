  ...
  ("tpe_final_display", 0, mesh_load_window, [
    ...
    [
		...
		(try_begin),
			...
			(call_script, "script_tpe_award_loot", ":troop_first", wp_tpe_final_rank_1),
			(assign, ":prize", reg1),
		...
		(try_begin),
			...
			(try_begin),
				...
				(call_script, "script_tpe_award_loot", ":troop_second", wp_tpe_final_rank_2),
				(assign, ":prize", reg1),
				(str_store_item_name, s1, ":prize"),
				# OBJ (nil) - Cash Gain
				(create_text_overlay, reg1, "@{s1}", tf_left_align),
		...
		(try_begin),
			...
			(try_begin),
				...
				(call_script, "script_tpe_award_loot", ":troop_third", wp_tpe_final_rank_3),
				(assign, ":prize", reg1),
				(str_store_item_name, s1, ":prize"),
				# OBJ (nil) - Cash Gain
				(create_text_overlay, reg1, "@{s1}", tf_left_align),
