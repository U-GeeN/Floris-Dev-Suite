...
####################################################################################################################################
		...
		[
			...
			(try_for_range, ":index", 0, 9),
				...
				(else_try),
					...
					(call_script, "script_mmfix_item_max_amount", ":troop_id", ":index"),
					(assign, ":qty_max", reg0),
		...
		[
			...
			(try_for_range, ":index", 0, 9),
				...
				(else_try),
					...
					(call_script, "script_mmfix_item_max_amount", "trp_player", ":index"),
					(assign, ":qty_max", reg0),
			...
			(try_for_range, ":index", 0, "$g_lco_inv_slots"),
				...
				(else_try),
					...
					(call_script, "script_mmfix_item_max_amount", "trp_player", ":inventory_offset"),
					(assign, ":qty_max", reg0),
			...
			(try_for_range, ":index", 0, "$g_lco_garb_slots"),
				...
				(else_try),
					...
					(call_script, "script_mmfix_item_max_amount", "$g_lco_garbage_troop", ":inventory_offset"),
					(assign, ":qty_max", reg0),
		...
		[
			...
			(try_begin),
				...
				(try_begin),
					...
					(call_script, "script_mmfix_item_max_amount", ":troop_id", ":slot_id"),
			...
			(try_begin),
				...
				(try_begin),
					...
					(else_try),
						...
						(call_script, "script_mmfix_item_max_amount", ":troop_id", ":swap_slot"),
						(assign, ":out_quantity", reg0),
	...
	("lco_initialize_presentation",
		[
			...
			(try_begin),
				...
				# Initializing xp-to-level conversion table (recreating the table used by the game code internally)
				(troop_set_slot, lco_garbage,  0, 0),
				(troop_set_slot, lco_garbage,  1, 600),
				(troop_set_slot, lco_garbage,  2, 1360),
				(troop_set_slot, lco_garbage,  3, 2296),
				(troop_set_slot, lco_garbage,  4, 3426),
				(troop_set_slot, lco_garbage,  5, 4768),
				(troop_set_slot, lco_garbage,  6, 6345),
				(troop_set_slot, lco_garbage,  7, 8179),
				(troop_set_slot, lco_garbage,  8, 10297),
				(troop_set_slot, lco_garbage,  9, 13010),
				(troop_set_slot, lco_garbage, 10, 16161),
				(troop_set_slot, lco_garbage, 11, 19806),
				(troop_set_slot, lco_garbage, 12, 24007),
				(troop_set_slot, lco_garbage, 13, 28832),
				(troop_set_slot, lco_garbage, 14, 34362),
				(troop_set_slot, lco_garbage, 15, 40682),
				(troop_set_slot, lco_garbage, 16, 47892),
				(troop_set_slot, lco_garbage, 17, 56103),
				(troop_set_slot, lco_garbage, 18, 65441),
				(troop_set_slot, lco_garbage, 19, 77233),
				(troop_set_slot, lco_garbage, 20, 90809),
				(troop_set_slot, lco_garbage, 21, 106425),
				(troop_set_slot, lco_garbage, 22, 124371),
				(troop_set_slot, lco_garbage, 23, 144981),
				(troop_set_slot, lco_garbage, 24, 168636),
				(troop_set_slot, lco_garbage, 25, 195769),
				(troop_set_slot, lco_garbage, 26, 226879),
				(troop_set_slot, lco_garbage, 27, 262533),
				(troop_set_slot, lco_garbage, 28, 303381),
				(troop_set_slot, lco_garbage, 29, 350164),
				(troop_set_slot, lco_garbage, 30, 412091),
				(troop_set_slot, lco_garbage, 31, 484440),
				(troop_set_slot, lco_garbage, 32, 568947),
				(troop_set_slot, lco_garbage, 33, 667638),
				(troop_set_slot, lco_garbage, 34, 782877),
				(troop_set_slot, lco_garbage, 35, 917424),
				(troop_set_slot, lco_garbage, 36, 1074494),
				(troop_set_slot, lco_garbage, 37, 1257843),
				(troop_set_slot, lco_garbage, 38, 1471851),
				(troop_set_slot, lco_garbage, 39, 1721626),
				(troop_set_slot, lco_garbage, 40, 2070551),
				(troop_set_slot, lco_garbage, 41, 2489361),
				(troop_set_slot, lco_garbage, 42, 2992033),
				(troop_set_slot, lco_garbage, 43, 3595340),
				(troop_set_slot, lco_garbage, 44, 4319408),
				(troop_set_slot, lco_garbage, 45, 5188389),
				(troop_set_slot, lco_garbage, 46, 6231267),
				(troop_set_slot, lco_garbage, 47, 7482821),
				(troop_set_slot, lco_garbage, 48, 8984785),
				(troop_set_slot, lco_garbage, 49, 11236531),
				(troop_set_slot, lco_garbage, 50, 14051314),
				(troop_set_slot, lco_garbage, 51, 17569892),
				(troop_set_slot, lco_garbage, 52, 21968215),
				(troop_set_slot, lco_garbage, 53, 27466219),
				(troop_set_slot, lco_garbage, 54, 34338823),
				(troop_set_slot, lco_garbage, 55, 42929679),
				(troop_set_slot, lco_garbage, 56, 53668349),
				(troop_set_slot, lco_garbage, 57, 67091786),
				(troop_set_slot, lco_garbage, 58, 83871183),
				(troop_set_slot, lco_garbage, 59, 160204600),
				(troop_set_slot, lco_garbage, 60, 320304600),
				(troop_set_slot, lco_garbage, 61, 644046000),
				(troop_set_slot, lco_garbage, 62, 2050460000),
			(try_end),
	...
	("lco_xp_to_next_level",
		[
			...
			(troop_get_slot, ":next_level_xp", lco_garbage, ":level"),
			(store_sub, reg40, ":next_level_xp", ":xp"),
		]
	),
