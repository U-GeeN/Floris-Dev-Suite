...
ground_specs = [
    ...
    ("turf",gtf_overlay|gtf_has_color,"grassy_ground",2.5,"ground_earth_under_grass",(0.42,0.59,0.17)),
    ("steppe",gtf_overlay|gtf_dusty|gtf_has_color,"ground_steppe",3.5,"ground_earth_under_steppe",(0.85,0.73,0.36)),
    ("snow",gtf_overlay|gtf_has_color,"snow",5.2,"none",(1.4,1.4,1.4)),
    ("earth",gtf_overlay|gtf_dusty|gtf_has_color,"ground_earth",3.5,"none",(0.7,0.5,0.23)),
