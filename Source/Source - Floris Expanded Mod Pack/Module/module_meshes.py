...
##Narf's transitional armor begin
  #Note: This is one part of three. You find the other two parts in module_tableau_materials.py and module_items.py.
...
#Player flags
  ...
  ("banner_a15", 0, "banner_a21", 0, 0, 0, -90, 0, 0, 1, 1, 1),
...
# Floris Multiplayer begin
  ("mp_ui_host_maps_muiderslot", 0, "mp_ui_host_maps_muiderslot", 0, 0, 0, 0, 0, 0, 1, 1, 1),
# Floris Multiplayer end

# Floris - Report Screen
  ("report_screen", 0, "report_screen", 0, 0, 0, 0, 0, 0, 1, 1, 1),
# Floris - Report Screen End
