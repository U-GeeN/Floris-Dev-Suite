    ...
    [
      (ti_on_agent_spawn, 0, 0, [],
       [
         ...
         (call_script, "script_horse_assignment_advance_battle_horse_for_spawn", ":agent_no"),
       ...
       [
        ...
        (store_trigger_param_3, ":is_wounded"),
	        ...
	        (try_begin),
	          ...
	          (agent_is_human, ":dead_agent_no"),
	          (eq, ":is_wounded", 1),
	          (call_script, "script_horse_assignment_maybe_dismount_agent_after_battle_loss", ":dead_agent_no", 0),
	        (else_try),
	          (ge, ":dead_agent_no", 0),
	          (neg|agent_is_human, ":dead_agent_no"),
	          (agent_get_rider, ":rider_agent", ":dead_agent_no"),
	          (ge, ":rider_agent", 0),
	          (call_script, "script_horse_assignment_maybe_dismount_agent_after_battle_loss", ":rider_agent", 1),
	        (try_end),
