      ...
      (ti_on_agent_killed_or_wounded, 0, 0, [],
       [
        ...
        (try_begin),
          ...
          (agent_is_human, ":dead_agent_no"),
          (eq, ":is_wounded", 1),
          (call_script, "script_horse_assignment_maybe_dismount_agent_after_battle_loss", ":dead_agent_no"),
        (else_try),
          (ge, ":dead_agent_no", 0),
          (neg|agent_is_human, ":dead_agent_no"),
          (agent_get_rider, ":rider_agent", ":dead_agent_no"),
          (ge, ":rider_agent", 0),
          (call_script, "script_horse_assignment_maybe_dismount_agent_after_battle_loss", ":rider_agent"),
        (try_end),
