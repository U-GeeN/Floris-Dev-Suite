...
##    ),
##    
##Floris: in game_blood 1 and 2 there are changes from Blood enhancement tweak v0.5.
...
#     0.5                        #rotation damping
#    ),
#TEMPERED CHANGED HOOF DUST  uncomment the 2nd "game_hoof_dust" tuple to restore native hoof dust
     ("game_hoof_dust", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_2d_turbulance, "prt_mesh_dust_1",#prt_mesh_dust_1
     4, 12.0,  1, 0.01, 10.0, 15.0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.15), (1, 0),        #alpha keys
     (0, .6), (1, .8),        #red keys
     (0, 0.5),(1, 0.7),         #green keys
     (0, 0.3),(1, 0.5),         #blue keys
     (0.2, 8.0),   (1.0, 40),   #scale keys
     (0.4, 0.6, 0.4),           #emit box size
