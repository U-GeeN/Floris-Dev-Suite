...
##     ),
 ...
 ("collect_men", "Collect Five Men", 0,
  ...
  "{!}The Guildmaster of {s4} has asked you to deal with the leader of forest bandits."
  ),
  ("deal_with_taiga_bandit", "Deal with the leader of taiga bandits", 0,
  "{!}The Guildmaster of {s4} has asked you to deal with the leader of taiga bandits."
  ),
  ("deal_with_steppe_bandit", "Deal with the leader of steppe bandits", 0,
  "{!}The Guildmaster of {s4} has asked you to deal with the leader of steppe bandits."
  ),
  ("deal_with_sea_raider", "Deal with the leader of sea raiders", 0,
  "{!}The Guildmaster of {s4} has asked you to deal with the leader of sea raiders."
  ),
  ("deal_with_mountain_bandit", "Deal with the leader of mountain bandits", 0,
  "{!}The Guildmaster of {s4} has asked you to deal with the leader of mountain bandits."
  ),
  ...
  ## CC
  ### FLORIS TOURNAMENT QUEST NEEDS TO BE REMOVED IN 2.6.  ONLY KEPT FOR SAVE GAME COMPATIBILITY.
  ## Floris+ Quest Pack #1
