#####Floris Notes#####
# I've used animations from the following sources:
# - Combat Animation Enhancement v5.0 by Papa Lazarou
# - Native Warband v1.152 by TaleWorlds
######################
...
## Combat Animation Enhancement by Papa Lazarou - Archery
...
## Combat Animation Enhancement by Papa Lazarou - Two-handed Swords
...
## Combat Animation Enhancement by Papa Lazarou - One-handed Weapons
## Note from Papa Lazarou: I've included both the high and low thrusts for the one-handed swords - note that including both for 'ready', 'release' and 'continue' will lead to strange blending. I also swapped the animation that playes when the low thrust is blocked.
## Floris: I choose the low thrusts.
...
#   [ready_durn, "1h_thrust_ready_18.9.10", 0, 5, blend_in_ready],
...
#   [0.62, "1h_thrust_release_18.9.10", 0, 27, blend_in_release],
 ],
...
#   [0.35, "1h_thrust_ready_18.9.10", 0, 5, blend_in_ready],
 ],
...
## Combat Animation Enhancement by Papa Lazarou - One-handed Spear
...
## Combat Animation Enhancement by Papa Lazarou - Polearms
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_unarmed", 0, amf_client_prediction,
   [1.3, "crouch_down", 0, 50, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
