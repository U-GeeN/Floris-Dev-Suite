					   ...
					   [
                        ...
                        ("prsnt_upgrade_tree_troop_and_name",
                          [
                            ...
                            (store_skill_level, ":riding_skill", skl_riding, ":troop_no"),
                            (try_begin),
                              (gt, ":riding_skill", 0),
...
## WINDYPLAINS- ##
  ...
  ("improvised_cavalry_get_mounted_troop",
   [
     ...
     (try_begin),
       ...
       (store_sub, ":offset", ":original_troop", regular_troops_begin),
       (store_add, reg0, improvised_cavalry_begin, ":offset"),
     (try_end),
   ]),
  ...
  ("improvised_cavalry_get_original_troop",
   [
     ...
     (try_begin),
       ...
       (store_sub, ":offset", ":mounted_troop", improvised_cavalry_begin),
       (store_add, reg0, regular_troops_begin, ":offset"),
     (try_end),
   ]),
  ...
  ("horse_assignment_format_horse_to_s1",
   [
     ...
     (try_end),
     (str_store_string, s1, "@{s1} (armor: {reg3}, speed: {reg4}, maneuver: {reg5})"),
   ]),
   ...
   [
     ...
     (try_begin),
       ...
       (try_for_range, ":i_slot", 0, ":inv_cap"),
         ...
         (item_get_slot, ":item_difficulty", ":item_id", slot_item_difficulty),
         ...
         # Tier from item difficulty: 0=T1, 1-3=T2, 4-6=T3, 7-8=T4, 9-10=T5, 11-12=T6, 13+=T7
         (assign, ":item_tier", 1),
         (try_begin), (ge, ":item_difficulty", 13), (assign, ":item_tier", 7),
         (else_try), (ge, ":item_difficulty", 11), (assign, ":item_tier", 6),
         (else_try), (ge, ":item_difficulty", 9),  (assign, ":item_tier", 5),
         (else_try), (ge, ":item_difficulty", 7),  (assign, ":item_tier", 4),
         (else_try), (ge, ":item_difficulty", 4),  (assign, ":item_tier", 3),
         (else_try), (ge, ":item_difficulty", 1),  (assign, ":item_tier", 2),
         (try_end),
       ...
       (try_end),
       (call_script, "script_stack_econ_process_party_equipment", ":party_no"),
     (try_end),
   ]),
