...
from module_troops import improvised_cavalry_pairs
##diplomacy start+
...
improvised_cavalry_slot_initializers = []
for original_troop, mounted_troop in improvised_cavalry_pairs:
    improvised_cavalry_slot_initializers += [
        (troop_set_slot, original_troop, slot_troop_improvised_cavalry_variant, mounted_troop),
        (troop_set_slot, mounted_troop, slot_troop_improvised_cavalry_original, original_troop),
    ]
					   ...
					   [
                        ...
                        ("prsnt_upgrade_tree_troop_and_name",
                          [
                            ...
                            (try_begin),
                              (call_script, "script_improvised_cavalry_is_eligible_original_troop", ":troop_no"),
                              (eq, reg0, 1),
                              (create_mesh_overlay_with_item_id, reg1, "itm_ho_vae_rus_blueroan"),
                              (position_set_x, pos1, 130),
                              (position_set_y, pos1, 170),
                              (overlay_set_size, reg1, pos1),
                              (store_add, ":horse_icon_x", ":pos_x", 48),
                              (store_add, ":horse_icon_y", ":pos_y", 15),
                              (position_set_x, pos1, ":horse_icon_x"),
                              (position_set_y, pos1, ":horse_icon_y"),
                              (overlay_set_position, reg1, pos1),
                            (try_end),
                        ]),
...
## WINDYPLAINS- ##
  ...
  ("lieutenant_system_calculate_stats", [
    ...
    (assign, reg0, ":source_troop"),
    (str_store_troop_name, s0, ":source_troop"),
    (troop_get_class, reg1, ":source_troop"),
    (assign, reg2, ":candidate_idx"),
    (display_message, "@ENTRY source={s0} id={reg0} class={reg1}, candidate ID: {reg2}"),
    ...
    # Always initialize skill IDs and their associated attribute type for trp_temp_array_b (slots 10-34 and 70-94)
    # Attribute mapping: 0=STR, 1=AGI, 2=INT, 3=CHA
    (troop_set_slot, "trp_temp_array_b", 10, skl_ironflesh),         (troop_set_slot, "trp_temp_array_b", 70, 0),
    (troop_set_slot, "trp_temp_array_b", 11, skl_power_strike),      (troop_set_slot, "trp_temp_array_b", 71, 0),
    (troop_set_slot, "trp_temp_array_b", 12, skl_power_throw),       (troop_set_slot, "trp_temp_array_b", 72, 0),
    (troop_set_slot, "trp_temp_array_b", 13, skl_power_draw),        (troop_set_slot, "trp_temp_array_b", 73, 0),
    (troop_set_slot, "trp_temp_array_b", 14, skl_weapon_master),     (troop_set_slot, "trp_temp_array_b", 74, 1),
    (troop_set_slot, "trp_temp_array_b", 15, skl_shield),            (troop_set_slot, "trp_temp_array_b", 75, 1),
    (troop_set_slot, "trp_temp_array_b", 16, skl_athletics),         (troop_set_slot, "trp_temp_array_b", 76, 1),
    (troop_set_slot, "trp_temp_array_b", 17, skl_riding),            (troop_set_slot, "trp_temp_array_b", 77, 1),
    (troop_set_slot, "trp_temp_array_b", 18, skl_horse_archery),     (troop_set_slot, "trp_temp_array_b", 78, 1),
    (troop_set_slot, "trp_temp_array_b", 19, skl_looting),           (troop_set_slot, "trp_temp_array_b", 79, 1),
    (troop_set_slot, "trp_temp_array_b", 20, skl_foraging),          (troop_set_slot, "trp_temp_array_b", 80, 1),
    (troop_set_slot, "trp_temp_array_b", 21, skl_trainer),           (troop_set_slot, "trp_temp_array_b", 81, 2),
    (troop_set_slot, "trp_temp_array_b", 22, skl_tracking),          (troop_set_slot, "trp_temp_array_b", 82, 2),
    (troop_set_slot, "trp_temp_array_b", 23, skl_tactics),           (troop_set_slot, "trp_temp_array_b", 83, 2),
    (troop_set_slot, "trp_temp_array_b", 24, skl_pathfinding),       (troop_set_slot, "trp_temp_array_b", 84, 2),
    (troop_set_slot, "trp_temp_array_b", 25, skl_spotting),          (troop_set_slot, "trp_temp_array_b", 85, 2),
    (troop_set_slot, "trp_temp_array_b", 26, skl_inventory_management),(troop_set_slot, "trp_temp_array_b", 86, 2), 
    (troop_set_slot, "trp_temp_array_b", 27, skl_wound_treatment),    (troop_set_slot, "trp_temp_array_b", 87, 2), 
    (troop_set_slot, "trp_temp_array_b", 28, skl_surgery),            (troop_set_slot, "trp_temp_array_b", 88, 2), 
    (troop_set_slot, "trp_temp_array_b", 29, skl_first_aid),          (troop_set_slot, "trp_temp_array_b", 89, 2), 
    (troop_set_slot, "trp_temp_array_b", 30, skl_engineer),           (troop_set_slot, "trp_temp_array_b", 90, 2),
    (troop_set_slot, "trp_temp_array_b", 31, skl_persuasion),         (troop_set_slot, "trp_temp_array_b", 91, 2),
    (troop_set_slot, "trp_temp_array_b", 32, skl_prisoner_management),(troop_set_slot, "trp_temp_array_b", 92, 3), 
    (troop_set_slot, "trp_temp_array_b", 33, skl_leadership),         (troop_set_slot, "trp_temp_array_b", 93, 3), 
    (troop_set_slot, "trp_temp_array_b", 34, skl_trade),              (troop_set_slot, "trp_temp_array_b", 94, 3), 
    ...
    (try_begin),
      ...
      # Distribute surplus into STR / AGI / CHA.
      (try_for_range, ":unused_attr", 0, ":attr_surplus"),
        (store_random_in_range, ":attr_roll", 0, 7),
        (try_begin),
          (lt, ":attr_roll", 3),           # 50% -> CHA (rolls 0-1)
          (val_add, ":v_cha", 1),
        (else_try),
          (lt, ":attr_roll", 5),           # 25% -> STR (roll 2)
          (val_add, ":v_str", 1),
        (else_try),
      ...
      (store_add, ":target_skill_points", ":target_skill_points", 5),
      (store_sub, ":points_remaining", ":target_skill_points", ":current_skill_total"),
      # --- SKILL DISTRIBUTION ---
      # PRECOMPUTE SKILL CAPS
      (try_for_range, ":i", 10, 35),
        (store_add, ":attr_type_slot", ":i", 60),
        (troop_get_slot, ":attr_id", "trp_temp_array_b", ":attr_type_slot"),

        (try_begin),
            (eq, ":attr_id", 0), (assign, ":base", ":v_str"),
        (else_try),
            (eq, ":attr_id", 1), (assign, ":base", ":v_agi"),
        (else_try),
            (eq, ":attr_id", 2), (assign, ":base", ":v_int"),
        (else_try),
            (assign, ":base", ":v_cha"),
        (try_end),

        (store_div, ":cap", ":base", 3),
        (val_min, ":cap", 10),

        # Skip restricted skills by setting their cap to 0
        (troop_get_slot, ":skl", "trp_temp_array_b", ":i"),
        (store_add, ":val_slot", ":i", 30),
        (troop_get_slot, ":l_val", "trp_temp_array_b", ":val_slot"),
        (try_begin),
          (eq, ":skl", skl_inventory_management),
          (assign, ":cap", 0),
        (else_try),
          (eq, ":l_val", 0),
          (this_or_next|eq, ":skl", skl_horse_archery),
          (this_or_next|eq, ":skl", skl_power_throw),
          (eq, ":skl", skl_power_draw),
          (assign, ":cap", 0),
        (try_end),

        (store_add, ":cap_slot", ":i", 90),
        (troop_set_slot, "trp_temp_array_b", ":cap_slot", ":cap"),
      (try_end),
      ...
      (try_for_range, ":unused", 0, 100),
        ...
        (try_begin),
          (lt, ":is_random", 25), # 25% Random selection
          (assign, ":found", 0),
          (try_for_range, ":unused_attempt", 0, 50),
            ...
            (troop_get_slot, ":l_val", "trp_temp_array_b", ":val_slot"),
            (store_add, ":cap_slot", ":rand_idx", 90),
            (troop_get_slot, ":cap", "trp_temp_array_b", ":cap_slot"),
        ...
        (else_try),
          ...
          (try_for_range, ":i", 10, 35),
            ...
            # --- Boosts ---
            (try_begin),
              (eq, ":skl", skl_leadership), (val_add, ":priority", 20),
            (else_try),
              (eq, ":skl", skl_weapon_master), (val_add, ":priority", 15),
            (else_try),
              (is_between, ":skl", skl_persuasion, skl_wound_treatment + 1), (val_add, ":priority", 10),
            (else_try),
              (is_between, ":skl", skl_spotting, skl_tracking + 1), (val_add, ":priority", 10),
            (else_try),
              (is_between, ":skl", skl_riding, skl_ironflesh + 1), (val_add, ":priority", 10),
            (else_try),
              (lt, ":l_val", 4), (eq, ":skl", skl_riding), (val_add, ":priority", 20),
            (try_end),

            # --- Select best ---
            (gt, ":priority", ":max_pri"),
            (assign, ":max_pri", ":priority"),
            (assign, ":best_skill_idx", ":i"),
          (try_end),
        (try_end),
        ...
        (else_try), 
          (assign, ":points_remaining", 0), # No valid skills to increase, stop distributing
        (try_end),
      (try_end),
    ...
    (assign, reg50, ":candidate_idx"),
    (assign, reg10, ":v_str"), (assign, reg11, ":v_agi"), (assign, reg12, ":v_int"), (assign, reg13, ":v_cha"),
    
    # Skills mapped to reg14-reg38 (Unrolled for stability)
    ...
    (troop_get_slot, reg22, "trp_temp_array_b", 48), # Horse Archery
    (troop_get_slot, reg23, "trp_temp_array_b", 49), # Looting 
    (troop_get_slot, reg24, "trp_temp_array_b", 50), # Foraging
    (troop_get_slot, reg25, "trp_temp_array_b", 51), # Trainer
    (troop_get_slot, reg26, "trp_temp_array_b", 52), # Tracking
    (troop_get_slot, reg27, "trp_temp_array_b", 53), # Tactics
    (troop_get_slot, reg28, "trp_temp_array_b", 54), # Pathfinding
    (troop_get_slot, reg29, "trp_temp_array_b", 55), # Spotting
    (troop_get_slot, reg30, "trp_temp_array_b", 56), # Inventory Mgmt
    (troop_get_slot, reg31, "trp_temp_array_b", 57), # Wound Treatment
    (troop_get_slot, reg32, "trp_temp_array_b", 58), # Surgery
    (troop_get_slot, reg33, "trp_temp_array_b", 59), # First Aid
    (troop_get_slot, reg34, "trp_temp_array_b", 60), # Engineer
    (troop_get_slot, reg35, "trp_temp_array_b", 61), # Persuasion
    (troop_get_slot, reg36, "trp_temp_array_b", 62), # Prisoner Mgmt
    (troop_get_slot, reg37, "trp_temp_array_b", 63), # Leadership
    (troop_get_slot, reg38, "trp_temp_array_b", 64), # Trade
  ]),
  ...
  # Stores persistent troop-stack development in compact party-slot blocks. This
  # emulates stack slots for native Warband headers that do not expose them.
  ("stack_econ_get_party_slot",
   [
     (store_script_param, ":stack_no", 1),
     (store_script_param, ":field_no", 2),
     (store_mul, reg0, ":stack_no", slot_party_stack_econ_stride),
     (val_add, reg0, slot_party_stack_econ_base),
     (val_add, reg0, ":field_no"),
   ]),

  ("stack_econ_store_troop_base_tier",
   [
     (store_script_param, ":troop_no", 1),
     (store_character_level, ":level", ":troop_no"),
     (store_div, reg0, ":level", 6),
     (val_add, reg0, 1),
     (val_min, reg0, 7),
     (val_max, reg0, 1),
   ]),

  ("stack_econ_find_stack_by_troop",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":troop_no", 2),
     (assign, reg0, -1),
     ...
     (try_for_range, ":stack_no", 0, ":num_stacks"),
       ...
       (assign, reg0, ":stack_no"),
       (assign, ":num_stacks", 0),
     (try_end),
   ]),

  ("stack_econ_set_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":field_no", 3),
     (store_script_param, ":value", 4),
     (try_begin),
       (ge, ":stack_no", 0),
       (lt, ":stack_no", slot_party_stack_econ_max_stacks),
       (call_script, "script_stack_econ_get_party_slot", ":stack_no", ":field_no"),
       (party_set_slot, ":party_no", reg0, ":value"),
     (try_end),
   ]),

  ("stack_econ_get_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":field_no", 3),
     ...
     (try_begin),
       ...
       (lt, ":stack_no", slot_party_stack_econ_max_stacks),
       (call_script, "script_stack_econ_get_party_slot", ":stack_no", ":field_no"),
       (party_get_slot, reg1, ":party_no", reg0),
     (try_end),
   ]),

  ("stack_econ_clear_stack_record",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (try_begin),
       (ge, ":stack_no", 0),
       (lt, ":stack_no", slot_party_stack_econ_max_stacks),
       (try_for_range, ":field_no", 0, slot_party_stack_econ_stride),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", 0),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_find_record_by_troop",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":troop_no", 2),
     (store_script_param, ":ignore_stack", 3),
     (assign, reg0, -1),
     (try_for_range, ":record_stack", 0, slot_party_stack_econ_max_stacks),
       (neq, ":record_stack", ":ignore_stack"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":record_stack", stack_econ_field_initialized),
       (eq, reg1, 1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":record_stack", stack_econ_field_troop),
       (eq, reg1, ":troop_no"),
       (assign, reg0, ":record_stack"),
       (assign, ":record_stack", slot_party_stack_econ_max_stacks),
     (try_end),
   ]),

  ("stack_econ_move_stack_record",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":source_stack", 2),
     (store_script_param, ":dest_stack", 3),
     (try_begin),
       (ge, ":source_stack", 0),
       (ge, ":dest_stack", 0),
       (neq, ":source_stack", ":dest_stack"),
       (lt, ":source_stack", slot_party_stack_econ_max_stacks),
       (lt, ":dest_stack", slot_party_stack_econ_max_stacks),
       (try_for_range, ":field_no", 0, stack_econ_field_loot_value + 1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":field_no"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", ":field_no", reg1),
       (try_end),
       (call_script, "script_stack_econ_clear_stack_record", ":party_no", ":source_stack"),
     (try_end),
   ]),

  ("stack_econ_reconcile_party_records",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       ...
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         ...
         (gt, ":troop_no", 0),
         (neg|troop_is_hero, ":troop_no"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_initialized),
         (assign, ":initialized", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_troop),
         (assign, ":stored_troop", reg1),
         (try_begin),
           (this_or_next|neq, ":initialized", 1),
           (neq, ":stored_troop", ":troop_no"),
           (call_script, "script_stack_econ_find_record_by_troop", ":party_no", ":troop_no", ":stack_no"),
           (assign, ":record_stack", reg0),
           (ge, ":record_stack", 0),
           (call_script, "script_stack_econ_move_stack_record", ":party_no", ":record_stack", ":stack_no"),
         (try_end),
       (try_end),
       (try_for_range, ":stale_stack", ":num_stacks", slot_party_stack_econ_max_stacks),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stale_stack", stack_econ_field_initialized),
         (eq, reg1, 1),
         (call_script, "script_stack_econ_clear_stack_record", ":party_no", ":stale_stack"),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_get_count_field",
   [
     (store_script_param, ":tier_field", 1),
     (assign, reg0, -1),
     (try_begin),
       (eq, ":tier_field", stack_econ_field_armor_tier),
       (assign, reg0, stack_econ_field_armor_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_helmet_tier),
       (assign, reg0, stack_econ_field_helmet_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_boots_tier),
       (assign, reg0, stack_econ_field_boots_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_gauntlets_tier),
       (assign, reg0, stack_econ_field_gauntlets_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_horse_tier),
       (assign, reg0, stack_econ_field_horse_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_weapon_1_tier),
       (assign, reg0, stack_econ_field_weapon_1_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_weapon_2_tier),
       (assign, reg0, stack_econ_field_weapon_2_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_weapon_3_tier),
       (assign, reg0, stack_econ_field_weapon_3_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_weapon_4_tier),
       (assign, reg0, stack_econ_field_weapon_4_count),
     (else_try),
       (eq, ":tier_field", stack_econ_field_shield_tier),
       (assign, reg0, stack_econ_field_shield_count),
     (try_end),
   ]),

  ("stack_econ_get_gear_kind_for_field",
   [
     (store_script_param, ":tier_field", 1),
     (assign, reg0, -1),
     (try_begin),
       (eq, ":tier_field", stack_econ_field_armor_tier),
       (assign, reg0, stack_econ_gear_armor),
     (else_try),
       (eq, ":tier_field", stack_econ_field_helmet_tier),
       (assign, reg0, stack_econ_gear_helmet),
     (else_try),
       (eq, ":tier_field", stack_econ_field_boots_tier),
       (assign, reg0, stack_econ_gear_boots),
     (else_try),
       (eq, ":tier_field", stack_econ_field_gauntlets_tier),
       (assign, reg0, stack_econ_gear_gauntlets),
     (else_try),
       (eq, ":tier_field", stack_econ_field_horse_tier),
       (assign, reg0, stack_econ_gear_horse),
     (else_try),
       (eq, ":tier_field", stack_econ_field_weapon_1_tier),
       (assign, reg0, stack_econ_gear_weapon),
     (else_try),
       (eq, ":tier_field", stack_econ_field_weapon_2_tier),
       (assign, reg0, stack_econ_gear_ranged),
     (else_try),
       (this_or_next|eq, ":tier_field", stack_econ_field_weapon_3_tier),
       (eq, ":tier_field", stack_econ_field_weapon_4_tier),
       (assign, reg0, stack_econ_gear_weapon),
     (else_try),
       (eq, ":tier_field", stack_econ_field_shield_tier),
       (assign, reg0, stack_econ_gear_shield),
     (try_end),
   ]),

  ("stack_econ_get_item_upgrade_cost",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":field_no", 3),
     (store_script_param, ":desired_tier", 4),
     (store_script_param, ":fallback_base_cost", 5),
     (store_mul, ":cost", ":fallback_base_cost", ":desired_tier"),
     (try_begin),
       (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
       (gt, ":troop_no", 0),
       (call_script, "script_stack_econ_get_gear_kind_for_field", ":field_no"),
       (assign, ":gear_kind", reg0),
       (ge, ":gear_kind", 0),
       (try_begin),
         (eq, ":field_no", stack_econ_field_weapon_1_tier),
         (troop_is_guarantee_ranged, ":troop_no"),
         (assign, ":gear_kind", stack_econ_gear_ranged),
       (else_try),
         (eq, ":field_no", stack_econ_field_weapon_2_tier),
         (troop_is_guarantee_ranged, ":troop_no"),
         (assign, ":gear_kind", stack_econ_gear_ammo),
       (try_end),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_base_gear_troop),
       (assign, ":gear_source_troop", reg1),
       (try_begin),
         (le, ":gear_source_troop", 0),
         (assign, ":gear_source_troop", ":troop_no"),
       (try_end),
       (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", ":gear_kind", ":desired_tier", ":gear_source_troop"),
       (assign, ":item_no", reg0),
       (ge, ":item_no", 0),
       (store_item_value, ":item_value", ":item_no"),
       (gt, ":item_value", 0),
       (assign, ":cost", ":item_value"),
     (try_end),
     (val_max, ":cost", 1),
     (assign, reg0, ":cost"),
   ]),

  ("stack_econ_store_purchase_debug_item_name",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":field_no", 3),
     (store_script_param, ":desired_tier", 4),
     (str_store_string, s4, "@equipment"),
     (try_begin),
       (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
       (gt, ":troop_no", 0),
       (call_script, "script_stack_econ_get_gear_kind_for_field", ":field_no"),
       ...
       (try_begin),
         (ge, ":item_no", 0),
         (str_store_item_name, s4, ":item_no"),
       (else_try),
         (eq, ":field_no", stack_econ_field_armor_tier),
         (str_store_string, s4, "@armor"),
       (else_try),
         (eq, ":field_no", stack_econ_field_helmet_tier),
         (str_store_string, s4, "@helmet"),
       (else_try),
         (eq, ":field_no", stack_econ_field_boots_tier),
         (str_store_string, s4, "@boots"),
       (else_try),
         (eq, ":field_no", stack_econ_field_gauntlets_tier),
         (str_store_string, s4, "@gauntlets"),
       (else_try),
         (eq, ":field_no", stack_econ_field_horse_tier),
         (str_store_string, s4, "@horse"),
       (else_try),
         (eq, ":field_no", stack_econ_field_shield_tier),
         (str_store_string, s4, "@shield"),
       (else_try),
         (str_store_string, s4, "@weapon"),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_get_item_tier_for_field",
   [
     (store_script_param, ":item_no", 1),
     (store_script_param, ":field_no", 2),
     (assign, ":base_cost", stack_econ_cost_weapon),
     (try_begin),
       (eq, ":field_no", stack_econ_field_armor_tier),
       (assign, ":base_cost", stack_econ_cost_armor),
     (else_try),
       (eq, ":field_no", stack_econ_field_helmet_tier),
       (assign, ":base_cost", stack_econ_cost_helmet),
     (else_try),
       (eq, ":field_no", stack_econ_field_boots_tier),
       (assign, ":base_cost", stack_econ_cost_boots),
     (else_try),
       (eq, ":field_no", stack_econ_field_gauntlets_tier),
       (assign, ":base_cost", stack_econ_cost_gauntlets),
     (else_try),
       (eq, ":field_no", stack_econ_field_horse_tier),
       (assign, ":base_cost", stack_econ_cost_horse),
     (else_try),
       (eq, ":field_no", stack_econ_field_weapon_2_tier),
       (assign, ":base_cost", stack_econ_cost_ammo),
     (else_try),
       (eq, ":field_no", stack_econ_field_shield_tier),
       (assign, ":base_cost", stack_econ_cost_shield),
     (try_end),
     (val_max, ":base_cost", 1),
     (store_item_value, ":item_value", ":item_no"),
     (store_mul, ":value_tier", ":item_value", 2),
     (val_add, ":value_tier", ":base_cost"),
     (store_mul, ":base_cost_x2", ":base_cost", 2),
     (val_div, ":value_tier", ":base_cost_x2"),
     (val_max, ":value_tier", 1),
     (val_min, ":value_tier", 7),

     # Difficulty is useful, but value is the better cross-category signal.
     # Let difficulty raise the tier by at most one so cheap high-requirement gear is not overvalued.
     (item_get_slot, ":item_difficulty", ":item_no", slot_item_difficulty),
     (assign, ":difficulty_tier", 1),
     (try_begin), (ge, ":item_difficulty", 13), (assign, ":difficulty_tier", 7),
     (else_try), (ge, ":item_difficulty", 11), (assign, ":difficulty_tier", 6),
     (else_try), (ge, ":item_difficulty", 9),  (assign, ":difficulty_tier", 5),
     (else_try), (ge, ":item_difficulty", 7),  (assign, ":difficulty_tier", 4),
     (else_try), (ge, ":item_difficulty", 4),  (assign, ":difficulty_tier", 3),
     (else_try), (ge, ":item_difficulty", 1),  (assign, ":difficulty_tier", 2),
     (try_end),
     (store_add, ":difficulty_cap", ":value_tier", 1),
     (val_min, ":difficulty_tier", ":difficulty_cap"),
     (assign, ":item_tier", ":value_tier"),
     (val_max, ":item_tier", ":difficulty_tier"),
     (val_max, ":item_tier", 1),
     (val_min, ":item_tier", 7),
     (assign, reg0, ":item_tier"),
   ]),

  ("stack_econ_add_loot_value",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":loot_value", 2),
     (try_begin),
       (party_is_active, ":party_no"),
       (gt, ":loot_value", 0),
       (assign, ":best_stack", -1),
       ...
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         (party_stack_get_size, ":stack_size", ":party_no", ":stack_no"),
         (gt, ":stack_size", ":best_size"),
         (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
         (gt, ":troop_no", 0),
         (neg|troop_is_hero, ":troop_no"),
         (assign, ":best_size", ":stack_size"),
         (assign, ":best_stack", ":stack_no"),
       (try_end),
       (ge, ":best_stack", 0),
       (call_script, "script_stack_econ_initialize_stack", ":party_no", ":best_stack"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":best_stack", stack_econ_field_loot_value),
       (assign, ":cur_loot_value", reg1),
       (val_add, ":cur_loot_value", ":loot_value"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", stack_econ_field_loot_value, ":cur_loot_value"),
     (try_end),
   ]),

  ("stack_econ_sell_stack_loot",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (try_begin),
       ...
       (party_stack_get_size, ":stack_size", ":party_no", ":stack_no"),
       (gt, ":stack_size", 0),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_loot_value),
       (assign, ":loot_value", reg1),
       (gt, ":loot_value", 0),
       (store_mul, ":sale_value", ":loot_value", 60),
       (val_div, ":sale_value", 100),
       (val_max, ":sale_value", 1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gold),
       (assign, ":gold", reg1),
       (val_add, ":gold", ":sale_value"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, ":gold"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_loot_value, 0),
     (try_end),
   ]),

  ("initialize_improvised_cavalry_slots",
   [
     (try_for_range, ":troop_no", regular_troops_begin, regular_troops_end),
       (troop_set_slot, ":troop_no", slot_troop_improvised_cavalry_variant, -1),
       (troop_set_slot, ":troop_no", slot_troop_improvised_cavalry_original, -1),
     (try_end),
     (try_for_range, ":troop_no", improvised_cavalry_begin, improvised_cavalry_end),
       (troop_set_slot, ":troop_no", slot_troop_improvised_cavalry_variant, -1),
       (troop_set_slot, ":troop_no", slot_troop_improvised_cavalry_original, -1),
     (try_end),
   ] + improvised_cavalry_slot_initializers),

  ("improvised_cavalry_get_mounted_troop",
   [
     (store_script_param, ":original_troop", 1),
     (troop_get_slot, reg0, ":original_troop", slot_troop_improvised_cavalry_variant),
     (try_begin),
       (le, reg0, 0),
  ...
  ("improvised_cavalry_get_original_troop",
   [
     (store_script_param, ":mounted_troop", 1),
     (troop_get_slot, reg0, ":mounted_troop", slot_troop_improvised_cavalry_original),
     (try_begin),
       (le, reg0, 0),
       (call_script, "script_initialize_improvised_cavalry_slots"),
       (troop_get_slot, reg0, ":mounted_troop", slot_troop_improvised_cavalry_original),
  ...
  ("improvised_cavalry_is_eligible_original_troop",
   [
     (store_script_param, ":original_troop", 1),
     (assign, reg0, 0),
     (try_begin),
       (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
       (ge, reg0, 0),
       (store_skill_level, ":riding", skl_riding, ":original_troop"),
       (ge, ":riding", 1),
       (neg|troop_is_guarantee_horse, ":original_troop"),
       (neg|troop_is_hero, ":original_troop"),
       (assign, reg0, 1),
     (try_end),
   ]),

  ("horse_assignment_set_battle_horse_from_record",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":mounted_troop", 2),
     (store_script_param, ":record_no", 3),
     (assign, ":success", 0),
     (try_begin),
       (party_is_active, ":party_no"),
       (is_between, ":mounted_troop", improvised_cavalry_begin, improvised_cavalry_end),
       (ge, ":record_no", 0),
       (lt, ":record_no", slot_party_horse_assignment_max),
       (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
       (gt, reg1, 0),
       (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
       (eq, reg1, ":mounted_troop"),
       (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_item),
       (assign, ":horse_item", reg1),
       (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_imod),
       (assign, ":horse_imod", reg1),
       (ge, ":horse_item", 0),
       (troop_set_inventory_slot, ":mounted_troop", ek_horse, ":horse_item"),
       (troop_set_inventory_slot_modifier, ":mounted_troop", ek_horse, ":horse_imod"),
       (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_record, ":record_no"),
       (assign, ":success", 1),
     (try_end),
     (assign, reg0, ":success"),
   ]),

  ("horse_assignment_restore_battle_horses",
   [
     (try_for_range, ":mounted_troop", improvised_cavalry_begin, improvised_cavalry_end),
       (troop_slot_eq, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_active, 1),
       (troop_get_slot, ":original_horse", ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_item),
       (troop_get_slot, ":original_imod", ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_imod),
       (troop_set_inventory_slot, ":mounted_troop", ek_horse, ":original_horse"),
       (troop_set_inventory_slot_modifier, ":mounted_troop", ek_horse, ":original_imod"),
       (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_active, 0),
       (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_item, 0),
       (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_imod, 0),
       (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_record, 0),
     (try_end),
   ]),

  ("horse_assignment_prepare_battle_horses",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       (party_is_active, ":party_no"),
       (call_script, "script_horse_assignment_restore_battle_horses"),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
         (gt, reg1, 0),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         (assign, ":mounted_troop", reg1),
         (is_between, ":mounted_troop", improvised_cavalry_begin, improvised_cavalry_end),
         (troop_slot_eq, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_active, 0),
         (troop_get_inventory_slot, ":original_horse", ":mounted_troop", ek_horse),
         (troop_get_inventory_slot_modifier, ":original_imod", ":mounted_troop", ek_horse),
         (call_script, "script_horse_assignment_set_battle_horse_from_record", ":party_no", ":mounted_troop", ":record_no"),
         (eq, reg0, 1),
         (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_active, 1),
         (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_item, ":original_horse"),
         (troop_set_slot, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_imod, ":original_imod"),
       (try_end),
     (try_end),
   ]),

  ("horse_assignment_advance_battle_horse_for_spawn",
   [
     (store_script_param, ":agent_no", 1),
     (try_begin),
       (ge, ":agent_no", 0),
       ...
       (agent_get_party_id, ":party_no", ":agent_no"),
       (eq, ":party_no", "p_main_party"),
       (agent_get_troop_id, ":mounted_troop", ":agent_no"),
       (is_between, ":mounted_troop", improvised_cavalry_begin, improvised_cavalry_end),
       (troop_slot_eq, ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_active, 1),
       (troop_get_slot, ":current_record", ":mounted_troop", slot_troop_improvised_cavalry_battle_horse_record),
       (assign, ":next_record", -1),
       (assign, ":first_record", -1),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
         (gt, reg1, 0),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         ...
         (try_begin),
           (lt, ":first_record", 0),
           (assign, ":first_record", ":record_no"),
         (try_end),
         (gt, ":record_no", ":current_record"),
         (lt, ":next_record", 0),
         (assign, ":next_record", ":record_no"),
       (try_end),
       (try_begin),
         (lt, ":next_record", 0),
         (assign, ":next_record", ":first_record"),
       (try_end),
       (ge, ":next_record", 0),
       (call_script, "script_horse_assignment_set_battle_horse_from_record", ":party_no", ":mounted_troop", ":next_record"),
     (try_end),
   ]),

  ("horse_assignment_get_party_slot",
   [
     (store_script_param, ":record_no", 1),
     (store_script_param, ":field_no", 2),
     (store_mul, reg0, ":record_no", slot_party_horse_assignment_stride),
     (val_add, reg0, slot_party_horse_assignment_base),
     (val_add, reg0, ":field_no"),
   ]),

  ("horse_assignment_set_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":record_no", 2),
     (store_script_param, ":field_no", 3),
     (store_script_param, ":value", 4),
     (try_begin),
       (ge, ":record_no", 0),
       (lt, ":record_no", slot_party_horse_assignment_max),
       (call_script, "script_horse_assignment_get_party_slot", ":record_no", ":field_no"),
       (party_set_slot, ":party_no", reg0, ":value"),
     (try_end),
   ]),

  ("horse_assignment_get_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":record_no", 2),
     (store_script_param, ":field_no", 3),
  ...
  ("horse_assignment_clear_record",
   [
     ...
     (try_begin),
       (ge, ":record_no", 0),
       (lt, ":record_no", slot_party_horse_assignment_max),
       (try_for_range, ":field_no", 0, slot_party_horse_assignment_stride),
         (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", ":field_no", 0),
       (try_end),
     (try_end),
   ]),

  ("horse_assignment_add_record",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":mounted_troop", 3),
     (store_script_param, ":horse_item", 4),
     (store_script_param, ":horse_imod", 5),
     (assign, ":found_record", -1),
     (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
       (eq, ":found_record", -1),
       (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
       (eq, reg1, 0),
       (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_active, 1),
       (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_original_troop, ":original_troop"),
       (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop, ":mounted_troop"),
       (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_item, ":horse_item"),
       (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_imod, ":horse_imod"),
       (assign, ":found_record", ":record_no"),
     (try_end),
     (assign, reg0, ":found_record"),
   ]),

  ("horse_assignment_convert_stack",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":from_troop", 2),
     (store_script_param, ":to_troop", 3),
     (store_script_param, ":convert_count", 4),
     (assign, ":converted_count", 0),
     (try_begin),
       (gt, ":convert_count", 0),
       (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":from_troop"),
       (assign, ":from_stack", reg0),
       (ge, ":from_stack", 0),
       (call_script, "script_stack_econ_initialize_stack", ":party_no", ":from_stack"),
       (party_stack_get_size, ":from_size", ":party_no", ":from_stack"),
       (party_stack_get_num_wounded, ":from_wounded", ":party_no", ":from_stack"),
       (gt, ":from_size", 0),
       (val_min, ":convert_count", ":from_size"),
       (assign, ":was_full_stack", 0),
       (try_begin),
         (ge, ":convert_count", ":from_size"),
         (assign, ":was_full_stack", 1),
       (try_end),
       (assign, ":wounded_to_convert", ":from_wounded"),
       (val_min, ":wounded_to_convert", ":convert_count"),
       (party_count_members_of_type, ":to_count_before", ":party_no", ":to_troop"),
       (party_remove_members, ":party_no", ":from_troop", ":convert_count"),
       (party_add_members, ":party_no", ":to_troop", ":convert_count"),
       (party_count_members_of_type, ":to_count_after", ":party_no", ":to_troop"),
       (store_sub, ":converted_count", ":to_count_after", ":to_count_before"),
       (val_max, ":converted_count", 0),
       (try_begin),
         (gt, ":wounded_to_convert", 0),
         (party_wound_members, ":party_no", ":to_troop", ":wounded_to_convert"),
       (try_end),
       (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":to_troop"),
       (assign, ":to_stack", reg0),
       (try_begin),
         (ge, ":to_stack", 0),
         (try_begin),
           (eq, ":was_full_stack", 1),
           (try_for_range, ":field_no", 0, stack_econ_field_loot_value + 1),
             (call_script, "script_stack_econ_get_field", ":party_no", ":from_stack", ":field_no"),
             (call_script, "script_stack_econ_set_field", ":party_no", ":to_stack", ":field_no", reg1),
           (try_end),
           (call_script, "script_stack_econ_set_field", ":party_no", ":to_stack", stack_econ_field_troop, ":to_troop"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":to_stack", stack_econ_field_last_size, ":convert_count"),
         (else_try),
           (call_script, "script_stack_econ_initialize_stack", ":party_no", ":to_stack"),
           (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_base_gear_troop + 1),
             (call_script, "script_stack_econ_get_field", ":party_no", ":from_stack", ":field_no"),
             (call_script, "script_stack_econ_set_field", ":party_no", ":to_stack", ":field_no", reg1),
           (try_end),
           (call_script, "script_stack_econ_set_field", ":party_no", ":to_stack", stack_econ_field_troop, ":to_troop"),
           (party_stack_get_size, ":to_size", ":party_no", ":to_stack"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":to_stack", stack_econ_field_last_size, ":to_size"),
         (try_end),
       (try_end),
     (try_end),
     (assign, reg0, ":converted_count"),
   ]),

  ("horse_assignment_count_records_for_troop",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     ...
     (try_begin),
       (party_is_active, ":party_no"),
       (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
       (assign, ":mounted_troop", reg0),
       (ge, ":mounted_troop", 0),
       (party_count_members_of_type, ":mounted_count", ":party_no", ":mounted_troop"),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
         (gt, reg1, 0),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         (eq, reg1, ":mounted_troop"),
         (lt, ":record_count", ":mounted_count"),
         (val_add, ":record_count", 1),
       (try_end),
     (try_end),
     (assign, reg0, ":record_count"),
   ]),

  ("horse_assignment_is_inventory_horse_reserved",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":slot_no", 3),
     ...
     (try_begin),
       ...
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         ...
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_imod),
         (eq, reg1, ":horse_imod"),
         (val_add, ":pending_count", 1),
       (try_end),
       (gt, ":pending_count", 0),
       (assign, ":previous_matching_slots", 0),
       (try_for_range, ":scan_slot", 0, ":slot_no"),
         (troop_get_inventory_slot, ":scan_item", "trp_player", ":scan_slot"),
         (eq, ":scan_item", ":horse_item"),
         (troop_get_inventory_slot_modifier, ":scan_imod", "trp_player", ":scan_slot"),
         (eq, ":scan_imod", ":horse_imod"),
         (val_add, ":previous_matching_slots", 1),
       (try_end),
       (lt, ":previous_matching_slots", ":pending_count"),
       (assign, ":is_reserved", 1),
     (try_end),
     (assign, reg0, ":is_reserved"),
   ]),

  ("horse_assignment_format_horse_to_s1",
   [
     (store_script_param, ":horse_item", 1),
     (str_store_item_name, s1, ":horse_item"),
     (item_get_slot, reg3, ":horse_item", slot_item_horse_armor),
     (item_get_slot, reg4, ":horse_item", slot_item_horse_speed),
     (item_get_slot, reg5, ":horse_item", slot_item_horse_maneuver),
     (item_get_slot, reg6, ":horse_item", slot_item_difficulty),
     (try_begin),
       (le, reg5, 0),
       (item_get_slot, reg5, ":horse_item", slot_item_speed),
     (try_end),
     (str_store_string, s1, "@{s1} (arm: {reg3}, spd: {reg4}, man: {reg5}, riding: {reg6})"),
   ]),

  ("horse_assignment_find_nth_usable_inventory_horse",
   [
     (store_script_param, ":original_troop", 1),
     (store_script_param, ":target_index", 2),
     (assign, ":found_item", -1),
     (assign, ":found_imod", -1),
     (assign, ":found_slot", -1),
     (try_begin),
       ...
       (try_for_range, ":slot_no", 0, ":inv_cap"),
         ...
         (item_get_slot, ":riding_req", ":item_no", slot_item_difficulty),
         (le, ":riding_req", ":riding"),
         (troop_get_inventory_slot_modifier, ":imod", "trp_player", ":slot_no"),
         (call_script, "script_horse_assignment_is_inventory_horse_reserved", "p_main_party", ":original_troop", ":slot_no", ":item_no", ":imod"),
         (eq, reg0, 0),
         (try_begin),
           (eq, ":usable_index", ":target_index"),
           (assign, ":found_item", ":item_no"),
           (assign, ":found_imod", ":imod"),
           (assign, ":found_slot", ":slot_no"),
           (call_script, "script_horse_assignment_format_horse_to_s1", ":item_no"),
         (try_end),
         (val_add, ":usable_index", 1),
       (try_end),
     (try_end),
     (assign, reg0, ":found_item"),
     (assign, reg1, ":found_imod"),
     (assign, reg2, ":found_slot"),
   ]),

  ("horse_assignment_count_usable_inventory_horses",
   [
     (store_script_param, ":original_troop", 1),
     ...
     (try_begin),
       ...
       (try_for_range, ":slot_no", 0, ":inv_cap"),
         ...
         (call_script, "script_horse_assignment_is_inventory_horse_reserved", "p_main_party", ":original_troop", ":slot_no", ":item_no", ":imod"),
         (eq, reg0, 0),
         (val_add, ":usable_count", 1),
       (try_end),
     (try_end),
     (assign, reg0, ":usable_count"),
   ]),

  ("horse_assignment_find_nth_assigned_horse",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":target_index", 3),
     (assign, ":found_record", -1),
     (assign, ":found_item", -1),
     (assign, ":found_imod", -1),
     (try_begin),
       ...
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         ...
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         (eq, reg1, ":mounted_troop"),
         (lt, ":assigned_index", ":mounted_count"),
         (try_begin),
           (eq, ":assigned_index", ":target_index"),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_item),
           (assign, ":horse_item", reg1),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_imod),
           (assign, ":horse_imod", reg1),
           (assign, ":found_record", ":record_no"),
           (assign, ":found_item", ":horse_item"),
           (assign, ":found_imod", ":horse_imod"),
           (call_script, "script_horse_assignment_format_horse_to_s1", ":horse_item"),
         (try_end),
         (val_add, ":assigned_index", 1),
       (try_end),
     (try_end),
     (assign, reg0, ":found_record"),
     (assign, reg1, ":found_item"),
     (assign, reg2, ":found_imod"),
   ]),

  ("horse_assignment_find_management_option",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":option_index", 3),
     (assign, ":result_no", -1),
     (assign, ":result_item", -1),
     (assign, ":result_imod", -1),
     (assign, ":result_mode", -1),
     (str_clear, s1),
     (str_clear, s11),
     (try_begin),
       (party_is_active, ":party_no"),
       (ge, ":original_troop", 0),
       (try_begin),
         (eq, "$g_horse_manage_mounted_mode", 1),
         (call_script, "script_horse_assignment_find_nth_assigned_horse", ":party_no", ":original_troop", ":option_index"),
         (ge, reg0, 0),
         (assign, ":result_no", reg0),
         (assign, ":result_item", reg1),
         (assign, ":result_imod", reg2),
         (assign, ":result_mode", 1),
         (str_store_string, s11, "@Take"),
       (else_try),
         (neq, "$g_horse_manage_mounted_mode", 1),
         (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
         (assign, ":mounted_troop", reg0),
         (ge, ":mounted_troop", 0),
         (party_count_members_of_type, ":foot_count", ":party_no", ":original_troop"),
         (gt, ":foot_count", 0),
         (call_script, "script_horse_assignment_find_nth_usable_inventory_horse", ":original_troop", ":option_index"),
         (ge, reg0, 0),
         (assign, ":result_no", reg0),
         (assign, ":result_item", reg1),
         (assign, ":result_imod", reg2),
         (assign, ":result_mode", 0),
         (str_store_string, s11, "@Give"),
       (try_end),
     (try_end),
     (assign, reg0, ":result_no"),
     (assign, reg1, ":result_item"),
     (assign, reg2, ":result_imod"),
     (assign, reg6, ":result_mode"),
   ]),

  ("horse_assignment_apply_management_option",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":option_index", 3),
     ...
     (try_begin),
       (try_begin),
         (eq, "$g_horse_manage_mounted_mode", 1),
         (call_script, "script_horse_assignment_take_assigned_horse", ":party_no", ":original_troop", ":option_index"),
       (else_try),
         (call_script, "script_horse_assignment_create_from_inventory_horse", ":party_no", ":original_troop", ":option_index"),
       (try_end),
     (try_end),
   ]),

  ("horse_assignment_create_from_inventory_slot",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":horse_slot", 3),
     (assign, reg0, 0),
     (str_store_string, s2, "@No suitable horse was found."),
     (try_begin),
       (party_is_active, ":party_no"),
       (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
       (assign, ":mounted_troop", reg0),
       ...
       (ge, ":horse_slot", 0),
       (troop_get_inventory_capacity, ":inv_cap", "trp_player"),
       (lt, ":horse_slot", ":inv_cap"),
       (troop_get_inventory_slot, ":horse_item", "trp_player", ":horse_slot"),
       (ge, ":horse_item", 0),
       (item_get_type, ":item_type", ":horse_item"),
       (eq, ":item_type", itp_type_horse),
       (store_skill_level, ":riding", skl_riding, ":original_troop"),
       (item_get_slot, ":riding_req", ":horse_item", slot_item_difficulty),
       (le, ":riding_req", ":riding"),
       (troop_get_inventory_slot_modifier, ":horse_imod", "trp_player", ":horse_slot"),
      (call_script, "script_horse_assignment_is_inventory_horse_reserved", ":party_no", ":original_troop", ":horse_slot", ":horse_item", ":horse_imod"),
      (eq, reg0, 0),
      (party_count_members_of_type, ":original_count_before", ":party_no", ":original_troop"),
      (gt, ":original_count_before", 0),
      (call_script, "script_horse_assignment_add_record", ":party_no", ":original_troop", ":mounted_troop", ":horse_item", ":horse_imod"),
      (assign, ":record_no", reg0),
      (ge, ":record_no", 0),
      (assign, ":assignment_success", 0),
      (try_begin),
        (call_script, "script_horse_assignment_convert_stack", ":party_no", ":original_troop", ":mounted_troop", 1),
        (gt, reg0, 0),
        (assign, ":assignment_success", 1),
      (try_end),
      (try_begin),
        (eq, ":assignment_success", 1),
        (troop_set_inventory_slot, "trp_player", ":horse_slot", -1),
        (call_script, "script_horse_assignment_format_horse_to_s1", ":horse_item"),
        (str_store_string, s2, "@Assigned {s1}."),
        (assign, reg0, 1),
      (else_try),
        (call_script, "script_horse_assignment_clear_record", ":party_no", ":record_no"),
        (str_store_string, s2, "@I could not create a mounted unit. The horse was left in your inventory."),
      (try_end),
     (else_try),
      (str_store_string, s2, "@No eligible foot troop is available."),
     (try_end),
   ]),

  ("horse_assignment_create_from_inventory_horse",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":target_index", 3),
     ...
     (try_begin),
       ...
       (assign, ":mounted_troop", reg0),
       (ge, ":mounted_troop", 0),
       (call_script, "script_horse_assignment_find_nth_usable_inventory_horse", ":original_troop", ":target_index"),
       (assign, ":horse_item", reg0),
       (assign, ":horse_imod", reg1),
       (assign, ":horse_slot", reg2),
       (ge, ":horse_item", 0),
       (ge, ":horse_slot", 0),
       (party_count_members_of_type, ":original_count_before", ":party_no", ":original_troop"),
       (gt, ":original_count_before", 0),
      ...
      (try_begin),
        (eq, ":assignment_success", 1),
        (troop_remove_item, "trp_player", ":horse_item"),
        (call_script, "script_horse_assignment_format_horse_to_s1", ":horse_item"),
        (str_store_string, s2, "@Assigned {s1}."),
        (assign, reg0, 1),
      (else_try),
  ...
  ("horse_assignment_take_assigned_horse",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (store_script_param, ":target_index", 3),
     (assign, reg0, 0),
     (str_store_string, s2, "@No assigned horse was found."),
     (try_begin),
       (call_script, "script_horse_assignment_find_nth_assigned_horse", ":party_no", ":original_troop", ":target_index"),
      (assign, ":record_no", reg0),
      (assign, ":horse_item", reg1),
      (assign, ":horse_imod", reg2),
      (ge, ":record_no", 0),
      (ge, ":horse_item", 0),
      (str_store_string, s2, "@Your inventory is full. I cannot return the horse until you make room."),
      (store_free_inventory_capacity, ":inventory_space", "trp_player"),
      (gt, ":inventory_space", 0),
      (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
      (try_begin),
        (gt, reg1, 0),
        (troop_add_item, "trp_player", ":horse_item", ":horse_imod"),
      (try_end),
      (call_script, "script_horse_assignment_clear_record", ":party_no", ":record_no"),
      (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
      (assign, ":mounted_troop", reg0),
      (try_begin),
        (ge, ":mounted_troop", 0),
        (call_script, "script_horse_assignment_convert_stack", ":party_no", ":mounted_troop", ":original_troop", 1),
      (try_end),
      (call_script, "script_horse_assignment_format_horse_to_s1", ":horse_item"),
      (str_store_string, s2, "@Took back {s1}."),
      (assign, reg0, 1),
     (try_end),
   ]),

  ("horse_assignment_store_management_status",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (assign, reg0, 0),
     ...
     (try_begin),
       ...
       (party_count_members_of_type, ":mounted_count", ":party_no", ":mounted_troop"),
       (party_count_members_of_type, ":foot_count", ":party_no", ":original_troop"),
       (store_add, ":max_assignable", ":mounted_count", ":foot_count"),
       (call_script, "script_horse_assignment_count_records_for_troop", ":party_no", ":original_troop"),
       (assign, ":assigned_count", reg0),
       (val_max, ":assigned_count", ":mounted_count"),
       (call_script, "script_horse_assignment_count_usable_inventory_horses", ":original_troop"),
      (assign, ":available_horses", reg0),
      (store_sub, ":missing_horses", ":mounted_count", ":assigned_count"),
      (val_max, ":missing_horses", 0),
      (assign, ":created_count", ":foot_count"),
      (val_min, ":created_count", ":available_horses"),
      (val_max, ":created_count", 0),
       (assign, reg0, ":mounted_count"),
       (assign, reg1, ":assigned_count"),
       (assign, reg2, ":missing_horses"),
       (assign, reg3, ":created_count"),
       (assign, reg4, ":foot_count"),
       (assign, reg5, ":available_horses"),
       (assign, reg7, ":max_assignable"),
       (try_begin),
         (gt, reg2, 0),
         (str_store_string, s2, "@We have {reg0} improvised cavalry, {reg4} foot troop(s), and {reg1}/{reg7} assigned horse(s). {reg5} suitable horse(s) remain. {reg3} more cavalry can be created. If you stop now, {reg2} mounted unit(s) will be set back to infantry."),
       (else_try),
         (str_store_string, s2, "@We have {reg0} improvised cavalry, {reg4} foot troop(s), and {reg1}/{reg7} assigned horse(s). {reg5} suitable horse(s) remain. {reg3} more cavalry can be created."),
       (try_end),
     (else_try),
       (str_store_string, s2, "@No improvised cavalry can be managed here."),
     (try_end),
   ]),

  ("horse_assignment_finalize_management",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (assign, reg0, 0),
     (str_store_string, s2, "@Very well."),
     (try_begin),
       (party_is_active, ":party_no"),
       (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
       (assign, ":mounted_troop", reg0),
       ...
       (assign, ":assigned_count", reg0),
       (val_max, ":assigned_count", ":mounted_count"),
       (store_sub, ":return_to_infantry", ":mounted_count", ":assigned_count"),
       (val_max, ":return_to_infantry", 0),
       (try_begin),
         (gt, ":return_to_infantry", 0),
         (call_script, "script_horse_assignment_convert_stack", ":party_no", ":mounted_troop", ":original_troop", ":return_to_infantry"),
         (assign, reg0, ":return_to_infantry"),
         (str_store_string, s2, "@{reg0} mounted unit(s) were set back to infantry."),
       (try_end),
     (try_end),
   ]),

  ("horse_assignment_prepare_management",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (try_begin),
       ...
       (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
       (assign, ":mounted_troop", reg0),
       (assign, ":returned_count", 0),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
         (eq, reg1, 1),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_original_troop),
         (eq, reg1, ":original_troop"),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_item),
         (assign, ":horse_item", reg1),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_imod),
         (assign, ":horse_imod", reg1),
         (troop_add_item, "trp_temp_troop", ":horse_item", ":horse_imod"),
         (call_script, "script_horse_assignment_clear_record", ":party_no", ":record_no"),
         (val_add, ":returned_count", 1),
       (try_end),
       (try_begin),
         (gt, ":returned_count", 0),
         (call_script, "script_horse_assignment_convert_stack", ":party_no", ":mounted_troop", ":original_troop", ":returned_count"),
       (try_end),
       (assign, "$g_horse_manage_count", ":returned_count"),
       (assign, reg0, ":returned_count"),
     (try_end),
   ]),

  ("horse_assignment_confirm_management",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":original_troop", 2),
     (assign, ":assigned_count", 0),
     (assign, ":rejected_count", 0),
     (assign, ":created_count", 0),
     (assign, reg0, 0),
     (assign, reg1, 0),
     (try_begin),
       (party_is_active, ":party_no"),
       ...
       (assign, ":mounted_troop", reg0),
       (ge, ":mounted_troop", 0),
       (party_count_members_of_type, ":mounted_count_before", ":party_no", ":mounted_troop"),
       (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":original_troop"),
       (assign, ":original_stack", reg0),
       (assign, ":available_count", 0),
       (try_begin),
         (ge, ":original_stack", 0),
         (party_stack_get_size, ":available_count", ":party_no", ":original_stack"),
       (try_end),
       (store_skill_level, ":riding", skl_riding, ":original_troop"),
       (troop_get_inventory_capacity, ":inv_cap", "trp_temp_troop"),
       (try_for_range, ":slot_no", 0, ":inv_cap"),
         (troop_get_inventory_slot, ":item_no", "trp_temp_troop", ":slot_no"),
         (ge, ":item_no", 0),
         (troop_get_inventory_slot_modifier, ":imod", "trp_temp_troop", ":slot_no"),
         (assign, ":valid_horse", 0),
         (item_get_type, ":item_type", ":item_no"),
         (try_begin),
           (eq, ":item_type", itp_type_horse),
           (item_get_slot, ":riding_req", ":item_no", slot_item_difficulty),
           (le, ":riding_req", ":riding"),
           (lt, ":assigned_count", ":available_count"),
           (assign, ":valid_horse", 1),
         (try_end),
         (try_begin),
           (eq, ":valid_horse", 1),
           (call_script, "script_horse_assignment_add_record", ":party_no", ":original_troop", ":mounted_troop", ":item_no", ":imod"),
           (ge, reg0, 0),
           (val_add, ":assigned_count", 1),
         (else_try),
           (troop_add_item, "trp_player", ":item_no", ":imod"),
           (val_add, ":rejected_count", 1),
         (try_end),
         (troop_set_inventory_slot, "trp_temp_troop", ":slot_no", -1),
       (try_end),
       (try_begin),
         (gt, ":assigned_count", 0),
         (call_script, "script_horse_assignment_convert_stack", ":party_no", ":original_troop", ":mounted_troop", ":assigned_count"),
       (try_end),
       (party_count_members_of_type, ":mounted_count_after", ":party_no", ":mounted_troop"),
       (store_sub, ":created_count", ":mounted_count_after", ":mounted_count_before"),
       (val_max, ":created_count", 0),
       (try_begin),
         (lt, ":created_count", ":assigned_count"),
         (store_sub, ":returned_assigned_count", ":assigned_count", ":created_count"),
         (val_add, ":rejected_count", ":returned_assigned_count"),
         (assign, ":remaining_return_count", ":returned_assigned_count"),
         (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
           (gt, ":remaining_return_count", 0),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
           (eq, reg1, 1),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_original_troop),
           (eq, reg1, ":original_troop"),
           ...
           (troop_add_item, "trp_player", ":horse_item", ":horse_imod"),
           (call_script, "script_horse_assignment_clear_record", ":party_no", ":record_no"),
           (val_sub, ":remaining_return_count", 1),
         (try_end),
       (try_end),
     (try_end),
     (assign, reg0, ":created_count"),
     (assign, reg1, ":rejected_count"),
     (call_script, "script_improvised_cavalry_get_mounted_troop", ":original_troop"),
     (try_begin),
       (ge, reg0, 0),
       (str_store_troop_name_plural, s1, reg0),
     (else_try),
       (str_store_troop_name_plural, s1, ":original_troop"),
     (try_end),
     (assign, reg0, ":created_count"),
   ]),

  ("horse_assignment_cancel_management",
   [
     (try_begin),
       (troop_get_inventory_capacity, ":inv_cap", "trp_temp_troop"),
       (try_for_range, ":slot_no", 0, ":inv_cap"),
  ...
  ("horse_assignment_release_records_for_upgrade",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":mounted_troop", 2),
     (store_script_param, ":release_count", 3),
     (assign, ":released_count", 0),
     (try_begin),
       (party_is_active, ":party_no"),
       (eq, ":party_no", "p_main_party"),
       (gt, ":release_count", 0),
       (call_script, "script_improvised_cavalry_get_original_troop", ":mounted_troop"),
       (ge, reg0, 0),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         (lt, ":released_count", ":release_count"),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
         (gt, reg1, 0),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         (eq, reg1, ":mounted_troop"),
         ...
         (troop_add_item, "trp_player", ":horse_item", ":horse_imod"),
         (call_script, "script_horse_assignment_clear_record", ":party_no", ":record_no"),
         (val_add, ":released_count", 1),
       (try_end),
     (try_end),
     (assign, reg0, ":released_count"),
   ]),

  ("horse_assignment_transfer_records_for_upgrade",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":source_mounted_troop", 2),
     (store_script_param, ":upgrade_troop", 3),
     (store_script_param, ":transfer_count", 4),
     (assign, ":handled_count", 0),
     (try_begin),
       (party_is_active, ":party_no"),
       (gt, ":transfer_count", 0),
       (call_script, "script_improvised_cavalry_get_original_troop", ":source_mounted_troop"),
       (assign, ":source_original_troop", reg0),
       (ge, ":source_original_troop", 0),
       (call_script, "script_improvised_cavalry_get_original_troop", ":upgrade_troop"),
       (assign, ":upgrade_original_troop", reg0),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         (lt, ":handled_count", ":transfer_count"),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_active),
         (gt, reg1, 0),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         (eq, reg1, ":source_mounted_troop"),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_item),
         (assign, ":horse_item", reg1),
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_imod),
         (assign, ":horse_imod", reg1),
         (ge, ":horse_item", 0),
         (assign, ":horse_transferred", 0),
         (try_begin),
           (ge, ":upgrade_original_troop", 0),
           (store_skill_level, ":riding", skl_riding, ":upgrade_original_troop"),
           (item_get_slot, ":riding_req", ":horse_item", slot_item_difficulty),
           (le, ":riding_req", ":riding"),
           (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_original_troop, ":upgrade_original_troop"),
           (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop, ":upgrade_troop"),
           (assign, ":horse_transferred", 1),
         (else_try),
           (troop_is_guarantee_horse, ":upgrade_troop"),
           (store_skill_level, ":riding", skl_riding, ":upgrade_troop"),
           (item_get_slot, ":riding_req", ":horse_item", slot_item_difficulty),
           (le, ":riding_req", ":riding"),
           (call_script, "script_horse_assignment_clear_record", ":party_no", ":record_no"),
           (assign, ":horse_transferred", 1),
         ...
         (else_try),
           ...
           (assign, ":horse_transferred", 1),
         (try_end),
         (eq, ":horse_transferred", 1),
         (val_add, ":handled_count", 1),
       (try_end),
     (try_end),
     (assign, reg0, ":handled_count"),
   ]),

  ("horse_assignment_reconcile_party",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       (party_is_active, ":party_no"),
       (try_for_range, ":record_no", 0, slot_party_horse_assignment_max),
         ...
         (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop),
         (assign, ":mounted_troop", reg1),
         (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":mounted_troop"),
         (assign, ":mounted_stack", reg0),
         (assign, ":mounted_count", 0),
         (try_begin),
           (ge, ":mounted_stack", 0),
           (party_stack_get_size, ":mounted_count", ":party_no", ":mounted_stack"),
         (try_end),
         (assign, ":record_index", 0),
         (try_for_range, ":scan_record", 0, ":record_no"),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":scan_record", horse_assignment_field_active),
           (eq, reg1, 1),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":scan_record", horse_assignment_field_mounted_troop),
           (eq, reg1, ":mounted_troop"),
           (val_add, ":record_index", 1),
         (try_end),
         (try_begin),
           (ge, ":record_index", ":mounted_count"),
           (assign, ":clear_record", 1),
           (assign, ":horse_handled_by_upgrade", 0),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_item),
           (assign, ":horse_item", reg1),
           (call_script, "script_horse_assignment_get_field", ":party_no", ":record_no", horse_assignment_field_imod),
           (assign, ":horse_imod", reg1),
           (try_for_range, ":upgrade_path", 0, 2),
             (ge, ":horse_item", 0),
             (eq, ":horse_handled_by_upgrade", 0),
             (troop_get_upgrade_troop, ":upgrade_troop", ":mounted_troop", ":upgrade_path"),
             (gt, ":upgrade_troop", 0),
             (party_count_members_of_type, ":upgrade_count", ":party_no", ":upgrade_troop"),
             (gt, ":upgrade_count", 0),
             (assign, ":upgrade_record_count", 0),
             (try_for_range, ":scan_record", 0, slot_party_horse_assignment_max),
               (call_script, "script_horse_assignment_get_field", ":party_no", ":scan_record", horse_assignment_field_active),
               (gt, reg1, 0),
               (call_script, "script_horse_assignment_get_field", ":party_no", ":scan_record", horse_assignment_field_mounted_troop),
               (eq, reg1, ":upgrade_troop"),
               (val_add, ":upgrade_record_count", 1),
             (try_end),
             (lt, ":upgrade_record_count", ":upgrade_count"),
             (assign, ":upgrade_accepts_horse", 0),
             (call_script, "script_improvised_cavalry_get_original_troop", ":upgrade_troop"),
             (assign, ":upgrade_original_troop", reg0),
             (try_begin),
               (ge, ":upgrade_original_troop", 0),
               ...
               (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_original_troop, ":upgrade_original_troop"),
               (call_script, "script_horse_assignment_set_field", ":party_no", ":record_no", horse_assignment_field_mounted_troop, ":upgrade_troop"),
               (assign, ":clear_record", 0),
               (assign, ":upgrade_accepts_horse", 1),
             (else_try),
               (troop_is_guarantee_horse, ":upgrade_troop"),
               (store_skill_level, ":riding", skl_riding, ":upgrade_troop"),
               (item_get_slot, ":riding_req", ":horse_item", slot_item_difficulty),
               ...
               (assign, ":upgrade_accepts_horse", 1),
             (try_end),
             (eq, ":upgrade_accepts_horse", 1),
             (assign, ":horse_handled_by_upgrade", 1),
           (try_end),
           (try_begin),
             (eq, ":horse_handled_by_upgrade", 0),
             (eq, ":party_no", "p_main_party"),
  ...
  ("troop_get_template_horse_value",
   [
     (store_script_param, ":troop_no", 1),
     (assign, ":horse_value", 0),
     (try_begin),
       (gt, ":troop_no", 0),
       ...
       (try_for_range, ":inv_slot", 0, ":capacity"),
         ...
         (store_item_value, ":item_value", ":item_no"),
         (try_begin),
           (this_or_next|eq, ":horse_value", 0),
           (lt, ":item_value", ":horse_value"),
           (assign, ":horse_value", ":item_value"),
         (try_end),
       (try_end),
     (try_end),
     (assign, reg0, ":horse_value"),
   ]),

  ("troop_get_upgrade_horse_cost_delta",
   [
     (store_script_param, ":source_troop", 1),
     (assign, ":best_delta", 0),
     (call_script, "script_troop_get_template_horse_value", ":source_troop"),
     (assign, ":source_horse_value", reg0),
     (try_for_range, ":upgrade_path", 0, 2),
       (troop_get_upgrade_troop, ":upgrade_troop", ":source_troop", ":upgrade_path"),
       (gt, ":upgrade_troop", 0),
       (call_script, "script_troop_get_template_horse_value", ":upgrade_troop"),
       (assign, ":upgrade_horse_value", reg0),
       (store_sub, ":delta", ":upgrade_horse_value", ":source_horse_value"),
       (gt, ":delta", 0),
       (try_begin),
         (this_or_next|eq, ":best_delta", 0),
         (lt, ":delta", ":best_delta"),
         (assign, ":best_delta", ":delta"),
       (try_end),
     (try_end),
     (assign, reg0, ":best_delta"),
   ]),

  ("stack_econ_get_agent_tier_for_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":tier_field", 3),
     (store_script_param, ":base_tier", 4),
     (store_script_param, ":spawn_index", 5),
     (assign, ":result_tier", ":base_tier"),
     (try_begin),
       (call_script, "script_stack_econ_get_count_field", ":tier_field"),
       (assign, ":high_field", reg0),
       (ge, ":high_field", 0),
       (party_stack_get_size, ":stack_size", ":party_no", ":stack_no"),
       (val_max, ":stack_size", 1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":tier_field"),
       (assign, ":low_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":high_field"),
       (assign, ":high_count", reg1),
       (val_max, ":low_count", 0),
       (val_max, ":high_count", 0),
       (val_min, ":low_count", ":stack_size"),
       (store_sub, ":max_high", ":stack_size", ":low_count"),
       (val_min, ":high_count", ":max_high"),
       (try_begin),
         (lt, ":spawn_index", ":low_count"),
         (store_sub, ":result_tier", ":base_tier", 1),
         (val_max, ":result_tier", 1),
       (else_try),
         (store_sub, ":high_begin", ":stack_size", ":high_count"),
         (ge, ":spawn_index", ":high_begin"),
         (store_add, ":result_tier", ":base_tier", 1),
         (val_min, ":result_tier", 7),
       (try_end),
     (try_end),
     (assign, reg0, ":result_tier"),
   ]),

  ("stack_econ_initialize_stack",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (try_begin),
       ...
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_troop),
       (assign, ":stored_troop", reg1),
       (assign, ":handled_upgrade_result", 0),
       ...
       (try_begin),
         ...
         (gt, ":stored_troop", 0),
         (try_for_range, ":upgrade_path", 0, 2),
           (eq, ":handled_upgrade_result", 0),
           (troop_get_upgrade_troop, ":upgrade_troop", ":stored_troop", ":upgrade_path"),
           (eq, ":upgrade_troop", ":troop_no"),
          (call_script, "script_horse_assignment_transfer_records_for_upgrade", ":party_no", ":stored_troop", ":troop_no", ":stack_size"),
           (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_base_gear_tier),
           (assign, ":base_gear_tier", reg1),
           (try_begin),
             (le, ":base_gear_tier", 0),
             (call_script, "script_stack_econ_store_troop_base_tier", ":stored_troop"),
             (assign, ":base_gear_tier", reg0),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_tier, ":base_gear_tier"),
           (try_end),
           (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_base_gear_troop),
           (try_begin),
             (le, reg1, 0),
             (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_troop, ":stored_troop"),
           (try_end),
           (val_add, ":base_gear_tier", 1),
           (val_min, ":base_gear_tier", 7),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_tier, ":base_gear_tier"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_troop, ":troop_no"),
           (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
             (call_script, "script_stack_econ_get_count_field", ":field_no"),
             (assign, ":high_field", reg0),
             (ge, ":high_field", 0),
             (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":field_no"),
             (assign, ":old_low", reg1),
             (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":high_field"),
             (assign, ":old_high", reg1),
             (val_max, ":old_low", 0),
             (val_max, ":old_high", 0),
             (val_min, ":old_low", ":stack_size"),
             (store_sub, ":max_old_high", ":stack_size", ":old_low"),
             (val_min, ":old_high", ":max_old_high"),
             (store_sub, ":old_mid", ":stack_size", ":old_low"),
             (val_sub, ":old_mid", ":old_high"),
             (val_max, ":old_mid", 0),
             (store_add, ":new_low", ":old_mid", ":old_low"),
             (val_min, ":new_low", ":stack_size"),
             (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", ":new_low"),
             (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":high_field", 0),
           (try_end),
           (assign, ":handled_upgrade_result", 1),
         (try_end),
       (try_end),
       ...
       (try_begin),
         ...
         (party_get_num_companion_stacks, ":num_stacks", ":party_no"),
         (val_min, ":num_stacks", slot_party_stack_econ_max_stacks),
         (try_for_range, ":source_stack", 0, ":num_stacks"),
           (eq, ":handled_upgrade_result", 0),
           (neq, ":source_stack", ":stack_no"),
           (party_stack_get_troop_id, ":source_troop", ":party_no", ":source_stack"),
           (gt, ":source_troop", 0),
           (neg|troop_is_hero, ":source_troop"),
           (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_initialized),
           (eq, reg1, 1),
           (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_last_size),
           (assign, ":source_last_size", reg1),
           (party_stack_get_size, ":source_size", ":party_no", ":source_stack"),
           (gt, ":source_last_size", ":source_size"),
           (store_sub, ":lost_count", ":source_last_size", ":source_size"),
           (try_for_range, ":upgrade_path", 0, 2),
             (eq, ":handled_upgrade_result", 0),
             (troop_get_upgrade_troop, ":upgrade_troop", ":source_troop", ":upgrade_path"),
             (eq, ":upgrade_troop", ":troop_no"),
             (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_last_size),
             (assign, ":dest_last_size", reg1),
             (gt, ":stack_size", ":dest_last_size"),
             (store_sub, ":gained_count", ":stack_size", ":dest_last_size"),
             (val_min, ":gained_count", ":lost_count"),
             (gt, ":gained_count", 0),
             (call_script, "script_stack_econ_transfer_on_upgrade", ":party_no", ":source_troop", ":troop_no", ":gained_count"),
             (assign, ":handled_upgrade_result", 1),
           (try_end),
         (try_end),
       (try_end),
       ...
       (try_begin),
         ...
         (this_or_next|neq, ":initialized", 1),
         (neq, ":stored_troop", ":troop_no"),
         (call_script, "script_stack_econ_store_troop_base_tier", ":troop_no"),
         (assign, ":base_tier", reg0),

         (store_mul, ":gold", ":base_tier", ":stack_size"),
         (val_mul, ":gold", 12),
         (try_begin),
         ...
         (store_mul, ":seed", ":party_no", 41),
         (store_mul, ":seed_add", ":stack_no", 101),
         (val_add, ":seed", ":seed_add"),
         (val_add, ":seed", ":troop_no"),

         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_initialized, 1),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_troop, ":troop_no"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, ":gold"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_troop, ":troop_no"),
         (try_for_range, ":low_field", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":low_field", 0),
         (try_end),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_shield_tier, 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_loot_value, 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_quality_seed, ":seed"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_spawn_index, 0),
         (try_for_range, ":high_field", stack_econ_field_armor_count, stack_econ_field_weapon_4_count + 1),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":high_field", 0),
         (try_end),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_shield_count, 0),
       (try_end),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_last_size, ":stack_size"),
     (try_end),
   ]),

  ("stack_econ_initialize_empty_stack",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (try_begin),
       ...
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_initialized, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_troop, ":troop_no"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, 0),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_base_gear_troop, 0),
       (try_for_range, ":low_field", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":low_field", 0),
       (try_end),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_shield_tier, 0),
       ...
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_quality_seed, ":seed"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_spawn_index, 0),
       (try_for_range, ":count_field", stack_econ_field_armor_count, stack_econ_field_weapon_4_count + 1),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":count_field", 0),
       (try_end),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_shield_count, 0),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_last_size, ":stack_size"),
     (try_end),
  ...
  ("stack_econ_try_upgrade_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":field_no", 3),
     (store_script_param, ":target_tier", 4),
     (store_script_param, ":base_cost", 5),
     ...
     (try_begin),
       ...
       (store_sub, ":max_high", ":stack_size", ":low_count"),
       (val_min, ":high_count", ":max_high"),
       (this_or_next|gt, ":low_count", 0),
       (lt, ":high_count", ":stack_size"),
       ...
       (try_begin),
         (gt, ":low_count", 0),
         (assign, ":buy_tier", ":base_tier"),
       (else_try),
         (store_add, ":buy_tier", ":base_tier", 1),
         (val_min, ":buy_tier", ":target_tier"),
       (try_end),

       (call_script, "script_stack_econ_get_item_upgrade_cost", ":party_no", ":stack_no", ":field_no", ":buy_tier", ":base_cost"),
       (assign, ":cost", reg0),
       (ge, ":gold", ":cost"),
       (val_sub, ":gold", ":cost"),
       (try_begin),
         ...
         (val_sub, ":low_count", 1),
       (else_try),
         (val_add, ":high_count", 1),
       (try_end),
       (store_sub, ":max_high", ":stack_size", ":low_count"),
       (val_min, ":high_count", ":max_high"),

	       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", ":low_count"),
	       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":high_field", ":high_count"),
	       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, ":gold"),
	       (try_begin),
	         (eq, stack_econ_debug_messages, 1),
	         (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
	         (str_store_troop_name_plural, s1, ":troop_no"),
	         (call_script, "script_stack_econ_store_purchase_debug_item_name", ":party_no", ":stack_no", ":field_no", ":buy_tier"),
	         (assign, reg0, ":buy_tier"),
	         (assign, reg1, ":cost"),
	         (assign, reg2, ":gold"),
	         (display_message, "@Stack economy debug: {s1} bought {s4} (tier {reg0}) for {reg1} denars; funds left {reg2}.", 0xFF99DDFF),
	       (try_end),
	     (try_end),
	   ]),

  ("stack_econ_ensure_required_field",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":field_no", 3),
     (store_script_param, ":min_tier", 4),
     (store_script_param, ":base_cost", 5),
     ...
     (try_begin),
       ...
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gold),
       (assign, ":gold", reg1),
	       (call_script, "script_stack_econ_get_item_upgrade_cost", ":party_no", ":stack_no", ":field_no", ":min_tier", ":base_cost"),
	       (assign, ":cost", reg0),
	       (val_mul, ":cost", ":low_count"),
	       (val_sub, ":gold", ":cost"),
	       (val_max, ":gold", 0),
	       ...
	       (try_begin),
	         ...
	         (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
	         (str_store_troop_name_plural, s1, ":troop_no"),
	         (call_script, "script_stack_econ_store_purchase_debug_item_name", ":party_no", ":stack_no", ":field_no", ":min_tier"),
	         (assign, reg0, ":min_tier"),
	         (assign, reg1, ":cost"),
	         (assign, reg2, ":gold"),
	         (assign, reg3, ":low_count"),
	         (display_message, "@Stack economy debug: {s1} bought {reg3}x {s4} (tier {reg0}) for {reg1} denars; funds left {reg2}.", 0xFF99DDFF),
	       (try_end),
	     (try_end),
	   ]),

  ("stack_econ_cheat_equip_stack_for_next_upgrade",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":equip_count", 3),
     (try_begin),
       (party_is_active, ":party_no"),
       (ge, ":stack_no", 0),
       (lt, ":stack_no", slot_party_stack_econ_max_stacks),
       ...
       (gt, ":stack_size", 0),
       (gt, ":equip_count", 0),
       (val_min, ":equip_count", ":stack_size"),
       (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
       (gt, ":troop_no", 0),
       (neg|troop_is_hero, ":troop_no"),

       (call_script, "script_stack_econ_initialize_stack", ":party_no", ":stack_no"),
       (call_script, "script_stack_econ_store_troop_base_tier", ":troop_no"),
       (assign, ":base_tier", reg0),
       (store_add, ":target_tier", ":base_tier", 1),
       (try_for_range, ":upgrade_path", 0, 2),
         (troop_get_upgrade_troop, ":upgrade_troop", ":troop_no", ":upgrade_path"),
         (gt, ":upgrade_troop", 0),
         (call_script, "script_stack_econ_store_troop_base_tier", ":upgrade_troop"),
         (val_max, ":target_tier", reg0),
       (try_end),
       (val_min, ":target_tier", 7),
       (val_max, ":target_tier", 1),

       (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         (neq, ":field_no", stack_econ_field_horse_tier),
         (call_script, "script_stack_econ_get_count_field", ":field_no"),
         (assign, ":high_field", reg0),
         (ge, ":high_field", 0),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":field_no"),
         ...
         (store_sub, ":max_high", ":stack_size", ":low_count"),
         (val_min, ":high_count", ":max_high"),
         (val_add, ":high_count", ":equip_count"),
         (try_begin),
           (store_add, ":total_marked", ":low_count", ":high_count"),
           (gt, ":total_marked", ":stack_size"),
           (store_sub, ":over_count", ":total_marked", ":stack_size"),
           (val_sub, ":low_count", ":over_count"),
           (val_max, ":low_count", 0),
         (try_end),
         (val_min, ":high_count", ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", ":low_count"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":high_field", ":high_count"),
       (try_end),
       (try_begin),
         (call_script, "script_stack_econ_troop_uses_stack_horse", ":troop_no"),
         (eq, reg0, 1),
         (assign, ":field_no", stack_econ_field_horse_tier),
         (assign, ":high_field", stack_econ_field_horse_count),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":field_no"),
         (assign, ":low_count", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":high_field"),
         (assign, ":high_count", reg1),
       ...
       (assign, reg0, ":stack_no"),
       (assign, reg1, ":target_tier"),
       (assign, reg2, ":equip_count"),
       (display_message, "@CHEAT: Stack {reg0} received next-upgrade tier {reg1} gear for {reg2} soldiers.", 0xFF66CCFF),
     (try_end),
   ]),

  ("stack_econ_stack_ready_for_upgrade",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (call_script, "script_stack_econ_stack_count_ready_for_upgrade", ":party_no", ":stack_no", 1),
   ]),

  ("stack_econ_stack_count_ready_for_upgrade",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (store_script_param, ":upgrade_count", 3),
     (assign, reg0, 0),
     (try_begin),
       (party_is_active, ":party_no"),
       (ge, ":stack_no", 0),
       ...
       (gt, ":troop_no", 0),
       (gt, ":upgrade_count", 0),
       (val_min, ":upgrade_count", ":stack_size"),
       (store_sub, ":selected_start", ":stack_size", ":upgrade_count"),
       (assign, ":ready", 1),
       (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         (eq, ":ready", 1),
         (neq, ":field_no", stack_econ_field_horse_tier),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":field_no"),
         (gt, reg1, ":selected_start"),
         (assign, ":ready", 0),
       (try_end),
       (try_begin),
         (eq, ":ready", 1),
         (call_script, "script_stack_econ_troop_uses_stack_horse", ":troop_no"),
         (eq, reg0, 1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_horse_tier),
         (gt, reg1, ":selected_start"),
         (assign, ":ready", 0),
       (try_end),
       (assign, reg0, ":ready"),
  ...
  ("stack_econ_debug_report_stack",
   [
     ...
     (try_begin),
       ...
       (call_script, "script_stack_econ_process_party", ":party_no"),
       (call_script, "script_stack_econ_initialize_stack", ":party_no", ":stack_no"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gold),
       (assign, ":gold", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_loot_value),
       ...
       (call_script, "script_stack_econ_store_troop_base_tier", ":troop_no"),
       (assign, ":base_tier", reg0),
       (store_sub, ":low_tier", ":base_tier", 1),
       (val_max, ":low_tier", 1),
       (store_add, ":high_tier", ":base_tier", 1),
       (val_min, ":high_tier", 7),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_armor_tier),
       (assign, ":armor_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_helmet_tier),
       (assign, ":helmet_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_boots_tier),
       (assign, ":boots_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_tier),
       (assign, ":gauntlets_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier),
       (assign, ":weapon_1_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier),
       (assign, ":weapon_2_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_3_tier),
       (assign, ":weapon_3_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_4_tier),
       (assign, ":weapon_4_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_armor_count),
       (assign, ":armor_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_helmet_count),
       (assign, ":helmet_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_boots_count),
       (assign, ":boots_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_count),
       (assign, ":gauntlets_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_count),
       (assign, ":weapon_1_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_count),
       (assign, ":weapon_2_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_3_count),
       (assign, ":weapon_3_count", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_4_count),
       (assign, ":weapon_4_count", reg1),

       (str_store_troop_name_plural, s1, ":troop_no"),
       (assign, reg0, ":stack_no"),
       (assign, reg1, ":stack_size"),
       (assign, reg2, ":gold"),
       (assign, reg3, ":loot_value"),
       (assign, reg4, ":base_tier"),
       (assign, reg5, ":low_tier"),
       (assign, reg6, ":high_tier"),
       (store_sub, ":armor_mid", ":stack_size", ":armor_low"), (val_sub, ":armor_mid", ":armor_count"),
       (store_sub, ":helmet_mid", ":stack_size", ":helmet_low"), (val_sub, ":helmet_mid", ":helmet_count"),
       (store_sub, ":boots_mid", ":stack_size", ":boots_low"), (val_sub, ":boots_mid", ":boots_count"),
       (store_sub, ":gauntlets_mid", ":stack_size", ":gauntlets_low"), (val_sub, ":gauntlets_mid", ":gauntlets_count"),
       (store_sub, ":weapon_1_mid", ":stack_size", ":weapon_1_low"), (val_sub, ":weapon_1_mid", ":weapon_1_count"),
       (store_sub, ":weapon_2_mid", ":stack_size", ":weapon_2_low"), (val_sub, ":weapon_2_mid", ":weapon_2_count"),
       (store_sub, ":weapon_3_mid", ":stack_size", ":weapon_3_low"), (val_sub, ":weapon_3_mid", ":weapon_3_count"),
       (store_sub, ":weapon_4_mid", ":stack_size", ":weapon_4_low"), (val_sub, ":weapon_4_mid", ":weapon_4_count"),
       (assign, ":armor_high", ":armor_count"),
       (val_min, ":armor_high", ":helmet_count"),
       (val_min, ":armor_high", ":boots_count"),
       (assign, ":armor_low_total", ":armor_low"),
       (val_max, ":armor_low_total", ":helmet_low"),
       (val_max, ":armor_low_total", ":boots_low"),
       (store_sub, ":armor_average", ":stack_size", ":armor_high"),
       (val_sub, ":armor_average", ":armor_low_total"),
       (val_max, ":armor_average", 0),
       (store_sub, ":weapon_average", ":stack_size", ":weapon_1_count"),
       (val_sub, ":weapon_average", ":weapon_1_low"),
       (val_max, ":weapon_average", 0),
       (str_store_string, s3, "@moderate"),
       (try_begin),
         (gt, ":armor_low_total", ":armor_high"),
         (str_store_string, s3, "@poorly"),
       (else_try),
         (store_mul, ":well_equipped_threshold", ":stack_size", 2),
         (val_div, ":well_equipped_threshold", 3),
         (ge, ":armor_high", ":well_equipped_threshold"),
         (str_store_string, s3, "@well"),
       (try_end),
       (assign, reg0, ":stack_size"),
       (assign, reg1, ":gold"),
       (assign, reg2, ":loot_value"),
       (str_store_string, s2, "@For {reg0} men, we have {reg1} denars set aside for equipment{reg2? and loot worth about {reg2}:.} The company is mostly {s3} equipped."),
       (str_clear, s4),
       (assign, ":armor_parts", 0),
       (try_begin),
         (gt, ":armor_high", 0),
         (assign, reg0, ":armor_high"),
         (try_begin),
           (eq, ":armor_parts", 0),
           (str_store_string, s4, "@For armor, {reg0} men have proper gear"),
         (else_try),
           (str_store_string, s4, "@{s4}, {reg0} have proper gear"),
         (try_end),
         (val_add, ":armor_parts", 1),
       (try_end),
       (try_begin),
         (gt, ":armor_average", 0),
         (assign, reg0, ":armor_average"),
         (try_begin),
           (eq, ":armor_parts", 0),
           (str_store_string, s4, "@For armor, {reg0} men have a mixed kit"),
         (else_try),
           (str_store_string, s4, "@{s4}, {reg0} have a mixed kit"),
         (try_end),
         (val_add, ":armor_parts", 1),
       (try_end),
       (try_begin),
         (gt, ":armor_low_total", 0),
         (assign, reg0, ":armor_low_total"),
         (try_begin),
           (eq, ":armor_parts", 0),
           (str_store_string, s4, "@For armor, {reg0} men are still making do with poor gear"),
         (else_try),
           (str_store_string, s4, "@{s4},^{reg0} are still making do with poor gear"),
         (try_end),
         (val_add, ":armor_parts", 1),
       (try_end),
       (try_begin),
       ...
       (try_end),
       (str_clear, s4),
       (assign, ":weapon_parts", 0),
       (try_begin),
         (gt, ":weapon_1_count", 0),
         (assign, reg0, ":weapon_1_count"),
         (try_begin),
           (eq, ":weapon_parts", 0),
           (str_store_string, s4, "@As for weapons, {reg0} men carry good arms"),
         (else_try),
           (str_store_string, s4, "@{s4}, {reg0} carry good arms"),
         (try_end),
         (val_add, ":weapon_parts", 1),
       (try_end),
       (try_begin),
         (gt, ":weapon_average", 0),
         (assign, reg0, ":weapon_average"),
         (try_begin),
           (eq, ":weapon_parts", 0),
           (str_store_string, s4, "@As for weapons, {reg0} men have serviceable mixed weapons"),
         (else_try),
           (str_store_string, s4, "@{s4}, {reg0} have serviceable mixed weapons"),
         (try_end),
         (val_add, ":weapon_parts", 1),
       (try_end),
       (try_begin),
         (gt, ":weapon_1_low", 0),
         (assign, reg0, ":weapon_1_low"),
         (try_begin),
           (eq, ":weapon_parts", 0),
           (str_store_string, s4, "@As for weapons, {reg0} men still need better weapons"),
         (else_try),
           (str_store_string, s4, "@{s4}, {reg0} still need better weapons"),
         (try_end),
         (val_add, ":weapon_parts", 1),
       (try_end),
       (try_begin),
  ...
  ("stack_econ_refresh_visible_troop_agents",
   [
     (store_script_param, ":troop_no", 1),
     (assign, ":refreshed", 0),
     (try_begin),
       ...
       (try_for_agents, ":agent_no"),
         ...
         (eq, ":agent_troop", ":troop_no"),
         (agent_set_slot, ":agent_no", slot_agent_stack_econ_applied, 0),
         (call_script, "script_stack_econ_apply_to_agent", ":agent_no"),
         (val_add, ":refreshed", 1),
       (try_end),
       (assign, reg0, ":refreshed"),
       (display_message, "@CHEAT: refreshed stack economy gear on {reg0} visible agents.", 0xFF66CCFF),
     (try_end),
   ]),

  ("stack_econ_process_stack",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (try_begin),
       ...
       # Town access makes purchasing faster.
       (party_get_attached_to, ":attached_center", ":party_no"),
       (try_begin),
         (ge, ":attached_center", 0),
         (call_script, "script_stack_econ_sell_stack_loot", ":party_no", ":stack_no"),
         (val_add, ":target_tier", 1),
         (val_min, ":target_tier", 7),
       (try_end),

       # Role-defining gear is mandatory: spend available gold, but do not block it.
       (try_begin),
         (troop_is_guarantee_ranged, ":troop_no"),
         (call_script, "script_stack_econ_ensure_required_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, 1, stack_econ_cost_ranged),
         (call_script, "script_stack_econ_ensure_required_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, 1, stack_econ_cost_ammo),
       (try_end),

       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, ":target_tier", stack_econ_cost_weapon),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_armor_tier, ":target_tier", stack_econ_cost_armor),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_helmet_tier, ":target_tier", stack_econ_cost_helmet),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_boots_tier, ":target_tier", stack_econ_cost_boots),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_tier, ":target_tier", stack_econ_cost_gauntlets),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, ":target_tier", stack_econ_cost_ammo),
       (try_begin),
         (call_script, "script_stack_econ_troop_uses_shield", ":troop_no"),
         (eq, reg0, 1),
         (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_shield_tier, ":target_tier", stack_econ_cost_shield),
       (try_end),
       (try_begin),
         (call_script, "script_stack_econ_troop_uses_stack_horse", ":troop_no"),
         (eq, reg0, 1),
         (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, ":target_tier", stack_econ_cost_horse),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_handle_stack_loss_lowest",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":stack_no", 2),
     (try_begin),
       ...
       (try_begin),
         (le, ":stack_size", 0),
         (call_script, "script_stack_econ_clear_stack_record", ":party_no", ":stack_no"),
       (else_try),
         (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_last_size),
         (assign, ":last_size", reg1),
         (store_sub, ":lost_count", ":last_size", ":stack_size"),
         (val_max, ":lost_count", 0),
         (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
           (neq, ":field_no", stack_econ_field_horse_tier),
           (call_script, "script_stack_econ_get_count_field", ":field_no"),
           (assign, ":high_field", reg0),
           ...
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":high_field", ":high_count"),
         (try_end),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_shield_tier),
         (assign, ":low_count", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_shield_count),
         (assign, ":high_count", reg1),
         (try_begin),
           (gt, ":lost_count", 0),
           (val_sub, ":low_count", ":lost_count"),
         ...
         (val_min, ":high_count", ":max_high"),
         (val_max, ":high_count", 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_shield_tier, ":low_count"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_shield_count, ":high_count"),
         (try_begin),
           (call_script, "script_stack_econ_troop_uses_stack_horse", ":troop_no"),
           (eq, reg0, 1),
           (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_horse_tier),
           (assign, ":low_count", reg1),
           (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_horse_count),
           (assign, ":high_count", reg1),
           (try_begin),
             (gt, ":lost_count", 0),
             (val_sub, ":low_count", ":lost_count"),
           ...
           (val_min, ":high_count", ":max_high"),
           (val_max, ":high_count", 0),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, ":low_count"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_count, ":high_count"),
         (try_end),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_process_party",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       (party_is_active, ":party_no"),
       (call_script, "script_stack_econ_reconcile_party_records", ":party_no"),
       (party_get_num_companion_stacks, ":num_stacks", ":party_no"),
       (val_min, ":num_stacks", slot_party_stack_econ_max_stacks),
       (try_for_range, ":source_stack", 0, ":num_stacks"),
         (party_stack_get_size, ":source_size", ":party_no", ":source_stack"),
         ...
         (try_for_range, ":upgrade_path", 0, 2),
           (troop_get_upgrade_troop, ":upgrade_troop", ":source_troop", ":upgrade_path"),
           (gt, ":upgrade_troop", 0),
           (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":upgrade_troop"),
           (assign, ":dest_stack", reg0),
           (ge, ":dest_stack", 0),
           (party_stack_get_size, ":dest_size", ":party_no", ":dest_stack"),
           (gt, ":dest_size", 0),
           (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", stack_econ_field_last_size),
           (assign, ":dest_last_size", reg1),
           (gt, ":dest_size", ":dest_last_size"),
           (store_sub, ":gained_count", ":dest_size", ":dest_last_size"),
           (val_min, ":gained_count", ":lost_count"),
           (gt, ":gained_count", 0),
           (call_script, "script_stack_econ_transfer_on_upgrade", ":party_no", ":source_troop", ":upgrade_troop", ":gained_count"),
           (val_sub, ":lost_count", ":gained_count"),
         (try_end),
         (try_begin),
           (gt, ":lost_count", 0),
           (call_script, "script_stack_econ_handle_stack_loss_lowest", ":party_no", ":source_stack"),
         (try_end),
       (try_end),
       (call_script, "script_horse_assignment_reconcile_party", ":party_no"),
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         (party_stack_get_size, ":stack_size", ":party_no", ":stack_no"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_last_size, ":stack_size"),
       (try_end),
  ...
  ("stack_econ_process_party_equipment",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       (party_is_active, ":party_no"),
       ...
       (val_min, ":num_stacks", slot_party_stack_econ_max_stacks),
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         (call_script, "script_stack_econ_process_stack", ":party_no", ":stack_no"),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_debug_report_party",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       (eq, stack_econ_debug_messages, 1),
       ...
       (assign, ":filled_stacks", 0),
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_initialized),
         (eq, reg1, 1),
         (val_add, ":filled_stacks", 1),
       (try_end),

       (str_store_party_name, s0, ":party_no"),
       (assign, reg0, ":filled_stacks"),
       (assign, reg1, ":num_stacks"),
       (display_message, "@Stack economy debug: {s0}: {reg0}/{reg1} companion stacks have economy records.", 0xFF66CCFF),
       ...
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         ...
         (assign, ":helmet_low", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier),
         (assign, ":weapon_low", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_armor_count),
         (assign, ":armor_high", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_helmet_count),
         (assign, ":helmet_high", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_count),
         (assign, ":weapon_high", reg1),

         (str_store_troop_name_plural, s1, ":troop_no"),
         (assign, reg0, ":stack_no"),
         (assign, reg1, ":stack_size"),
         (assign, reg2, ":gold"),
         (assign, reg3, ":armor_low"),
         (assign, reg4, ":armor_high"),
         (assign, reg5, ":helmet_low"),
         (assign, reg6, ":helmet_high"),
         (assign, reg7, ":weapon_low"),
         (assign, reg8, ":weapon_high"),
         (display_message, "@Stack economy debug: stack {reg0}: {reg1} {s1}; gold {reg2}; armor low/high {reg3}/{reg4}, helmet {reg5}/{reg6}, weapon {reg7}/{reg8}.", 0xFF99DDFF),
       (try_end),
     (try_end),
   ]),

    ("stack_econ_distribute_loot",
   [
     (store_script_param, ":party_no", 1),
     (try_begin),
       (party_is_active, ":party_no"),
       ...
       (assign, ":sold_count", 0),
       (str_store_string, s50, "@Troop loot distribution:"),
       ...
       (try_for_range, ":i_slot", 0, ":inv_cap"),
         ...
         (assign, ":item_was_used", 0),
         (assign, ":is_equipment", 0),
         (store_item_value, ":loot_value", ":item_id"),
         (store_mul, ":loot_value", ":loot_value", 60),
         (val_div, ":loot_value", 100),
         (val_max, ":loot_value", 1),

         (assign, ":field_no", -1),
         (assign, ":count_field", -1),
         (try_begin),
           (eq, ":item_type", itp_type_body_armor),
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_armor_tier),
           (assign, ":count_field", stack_econ_field_armor_count),
         (else_try),
           (eq, ":item_type", itp_type_head_armor),
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_helmet_tier),
           (assign, ":count_field", stack_econ_field_helmet_count),
         (else_try),
           (eq, ":item_type", itp_type_foot_armor),
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_boots_tier),
           (assign, ":count_field", stack_econ_field_boots_count),
         (else_try),
           (eq, ":item_type", itp_type_hand_armor),
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_gauntlets_tier),
           (assign, ":count_field", stack_econ_field_gauntlets_count),
         (else_try),
           ...
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_weapon_1_tier),
           (assign, ":count_field", stack_econ_field_weapon_1_count),
         (else_try),
         ...
         (else_try),
           ...
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_weapon_2_tier),
           (assign, ":count_field", stack_econ_field_weapon_2_count),
         (else_try),
           (eq, ":item_type", itp_type_shield),
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_shield_tier),
           (assign, ":count_field", stack_econ_field_shield_count),
         (else_try),
           (eq, ":item_type", itp_type_horse),
           (assign, ":is_equipment", 1),
           (assign, ":field_no", stack_econ_field_horse_tier),
           (assign, ":count_field", stack_econ_field_horse_count),
         (try_end),

         (try_begin),
           (ge, ":field_no", 0),
           (call_script, "script_stack_econ_get_item_tier_for_field", ":item_id", ":field_no"),
           (assign, ":item_tier", reg0),
           
           (assign, ":best_stack", -1),
           (assign, ":best_score", -100),
           (assign, ":best_troop_tier", 0),
           
           (party_get_num_companion_stacks, ":num_stacks", ":party_no"),
           (val_min, ":num_stacks", slot_party_stack_econ_max_stacks),
           (try_for_range, ":tier_offset", 0, 7),
             (store_sub, ":scan_tier", 7, ":tier_offset"),
             (try_for_range, ":stack_no", 0, ":num_stacks"),
               (party_stack_get_size, ":stack_size", ":party_no", ":stack_no"),
               (gt, ":stack_size", 0),
               (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
               (neg|troop_is_hero, ":troop_no"),
               (call_script, "script_stack_econ_store_troop_base_tier", ":troop_no"),
               (assign, ":troop_tier", reg0),
               (eq, ":troop_tier", ":scan_tier"),
               (assign, ":gear_eligible", 1),
               (try_begin),
                 (eq, ":field_no", stack_econ_field_shield_tier),
                 (assign, ":gear_eligible", 0),
                 (call_script, "script_stack_econ_troop_uses_shield", ":troop_no"),
                 (eq, reg0, 1),
                 (assign, ":gear_eligible", 1),
               (else_try),
               ...
               (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":field_no"),
               (assign, ":low_count", reg1),
               (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":count_field"),
               (assign, ":high_count", reg1),
               (val_max, ":low_count", 0),
               (val_max, ":high_count", 0),
               (val_min, ":low_count", ":stack_size"),
               ...
               (val_min, ":high_count", ":max_high"),
               (try_begin),
                 (eq, ":item_tier", ":troop_tier"),
                 (gt, ":low_count", 0),
                 (assign, ":score", 100),
                 (gt, ":score", ":best_score"),
                 (assign, ":best_score", ":score"),
                 (assign, ":best_stack", ":stack_no"),
                 (assign, ":best_troop_tier", ":troop_tier"),
               (else_try),
                 (store_add, ":usable_high_tier", ":troop_tier", 1),
                 (eq, ":item_tier", ":usable_high_tier"),
                 (lt, ":high_count", ":stack_size"),
                 (assign, ":score", 90),
                 (gt, ":score", ":best_score"),
                 (assign, ":best_score", ":score"),
           ...
           (try_begin),
             (ge, ":best_stack", 0),
             (call_script, "script_stack_econ_get_field", ":party_no", ":best_stack", ":field_no"),
             (assign, ":low_count", reg1),
             (call_script, "script_stack_econ_get_field", ":party_no", ":best_stack", ":count_field"),
             (assign, ":high_count", reg1),
             (party_stack_get_size, ":best_stack_size", ":party_no", ":best_stack"),
             (val_max, ":low_count", 0),
             (val_max, ":high_count", 0),
             (val_min, ":low_count", ":best_stack_size"),
             (store_sub, ":max_high", ":best_stack_size", ":low_count"),
             (val_min, ":high_count", ":max_high"),
             (assign, ":replaced_tier", 0),
             (try_begin),
               (eq, ":item_tier", ":best_troop_tier"),
               (gt, ":low_count", 0),
               (store_sub, ":replaced_tier", ":best_troop_tier", 1),
               (val_max, ":replaced_tier", 1),
               (val_sub, ":low_count", 1),
             (else_try),
               (store_add, ":usable_high_tier", ":best_troop_tier", 1),
               (eq, ":item_tier", ":usable_high_tier"),
               (lt, ":high_count", ":best_stack_size"),
               (assign, ":replaced_tier", ":best_troop_tier"),
               (val_add, ":high_count", 1),
               (try_begin),
                 (store_add, ":total_marked", ":low_count", ":high_count"),
                 (gt, ":total_marked", ":best_stack_size"),
                 (store_sub, ":over_count", ":total_marked", ":best_stack_size"),
                 (val_sub, ":low_count", ":over_count"),
                 (val_max, ":low_count", 0),
                 (store_sub, ":replaced_tier", ":best_troop_tier", 1),
                 (val_max, ":replaced_tier", 1),
             ...
             (try_begin),
               (gt, ":replaced_tier", 0),
               (assign, ":fallback_cost", stack_econ_cost_weapon),
               (try_begin),
                 (eq, ":field_no", stack_econ_field_armor_tier),
                 (assign, ":fallback_cost", stack_econ_cost_armor),
               (else_try),
                 (eq, ":field_no", stack_econ_field_helmet_tier),
                 (assign, ":fallback_cost", stack_econ_cost_helmet),
               (else_try),
                 (eq, ":field_no", stack_econ_field_boots_tier),
                 (assign, ":fallback_cost", stack_econ_cost_boots),
               (else_try),
                 (eq, ":field_no", stack_econ_field_gauntlets_tier),
                 (assign, ":fallback_cost", stack_econ_cost_gauntlets),
               (else_try),
                 (eq, ":field_no", stack_econ_field_weapon_2_tier),
                 (assign, ":fallback_cost", stack_econ_cost_ammo),
               (else_try),
                 (eq, ":field_no", stack_econ_field_shield_tier),
                 (assign, ":fallback_cost", stack_econ_cost_shield),
               (else_try),
                 (eq, ":field_no", stack_econ_field_horse_tier),
                 (assign, ":fallback_cost", stack_econ_cost_horse),
               (try_end),
               (call_script, "script_stack_econ_get_item_upgrade_cost", ":party_no", ":best_stack", ":field_no", ":replaced_tier", ":fallback_cost"),
               (assign, ":replaced_value", reg0),
               (val_mul, ":replaced_value", 60),
               (val_div, ":replaced_value", 100),
               (val_max, ":replaced_value", 1),
               (call_script, "script_stack_econ_get_field", ":party_no", ":best_stack", stack_econ_field_gold),
               (assign, ":stack_gold", reg1),
               (val_add, ":stack_gold", ":replaced_value"),
               (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", stack_econ_field_gold, ":stack_gold"),
             (try_end),
             (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", ":field_no", ":low_count"),
             (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", ":count_field", ":high_count"),
             (try_begin),
               (lt, ":report_count", 8),
               (party_stack_get_troop_id, ":best_troop", ":party_no", ":best_stack"),
               (str_store_troop_name_plural, s11, ":best_troop"),
               (str_store_item_name, s12, ":item_id"),
               (assign, reg0, ":item_tier"),
               (str_store_string, s50, "@{s50}^{s11} claimed {s12} (tier {reg0})."),
             (else_try),
               (eq, ":report_count", 8),
               (str_store_string, s50, "@{s50}^More items were claimed."),
             (try_end),
             (val_add, ":report_count", 1),
             
             (troop_set_inventory_slot, "trp_temp_troop", ":i_slot", -1),
             (assign, ":item_was_used", 1),
           (try_end),
         (try_end),
         (try_begin),
           (eq, ":item_was_used", 0),
           (eq, ":is_equipment", 1),
           (call_script, "script_stack_econ_add_loot_value", ":party_no", ":loot_value"),
       ...
       (try_begin),
         (eq, ":report_count", 0),
         (eq, ":sold_count", 0),
         (str_store_string, s50, "@Troop loot distribution:^No suitable equipment was found in the item pool."),
       (else_try),
         (gt, ":sold_count", 0),
         (assign, reg0, ":sold_count"),
         (str_store_string, s50, "@{s50}^{reg0} unclaimed equipment item(s) were converted to troop purse value."),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_transfer_on_upgrade",
   [
     (store_script_param, ":party_no", 1),
     (store_script_param, ":source_troop", 2),
     (store_script_param, ":upgrade_troop", 3),
     (store_script_param, ":upgraded_count", 4),
     (try_begin),
       (gt, ":upgraded_count", 0),
       (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":source_troop"),
       (assign, ":source_stack", reg0),
       (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":upgrade_troop"),
       (assign, ":dest_stack", reg0),
       (ge, ":source_stack", 0),
       (ge, ":dest_stack", 0),
       (call_script, "script_stack_econ_initialize_stack", ":party_no", ":source_stack"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", stack_econ_field_initialized),
       (assign, ":dest_was_initialized", reg1),
       (try_begin),
         (eq, ":dest_was_initialized", 1),
         (call_script, "script_stack_econ_initialize_stack", ":party_no", ":dest_stack"),
       (else_try),
         (call_script, "script_stack_econ_initialize_empty_stack", ":party_no", ":dest_stack"),
       (try_end),
      (call_script, "script_horse_assignment_transfer_records_for_upgrade", ":party_no", ":source_troop", ":upgrade_troop", ":upgraded_count"),

       (party_stack_get_size, ":source_size", ":party_no", ":source_stack"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_last_size),
       (assign, ":source_last_size", reg1),
       (val_max, ":source_size", ":source_last_size"),
       (val_max, ":source_size", 1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_gold),
       (assign, ":source_gold", reg1),
       (store_mul, ":transfer_gold", ":source_gold", ":upgraded_count"),
       (val_div, ":transfer_gold", ":source_size"),
       (val_min, ":transfer_gold", ":source_gold"),
       (val_sub, ":source_gold", ":transfer_gold"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":source_stack", stack_econ_field_gold, ":source_gold"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", stack_econ_field_gold),
       (assign, ":dest_gold", reg1),
       (val_add, ":dest_gold", ":transfer_gold"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", stack_econ_field_gold, ":dest_gold"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_loot_value),
       (assign, ":source_loot_value", reg1),
       (store_mul, ":transfer_loot_value", ":source_loot_value", ":upgraded_count"),
       (val_div, ":transfer_loot_value", ":source_size"),
       (val_min, ":transfer_loot_value", ":source_loot_value"),
       (val_sub, ":source_loot_value", ":transfer_loot_value"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":source_stack", stack_econ_field_loot_value, ":source_loot_value"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", stack_econ_field_loot_value),
       (assign, ":dest_loot_value", reg1),
       (val_add, ":dest_loot_value", ":transfer_loot_value"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", stack_econ_field_loot_value, ":dest_loot_value"),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_base_gear_tier),
       (assign, ":source_base_gear_tier", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", stack_econ_field_base_gear_troop),
       (assign, ":source_base_gear_troop", reg1),
       (try_begin),
         (le, ":source_base_gear_troop", 0),
         (assign, ":source_base_gear_troop", ":source_troop"),
       (try_end),
       (try_begin),
         (eq, ":dest_was_initialized", 1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", stack_econ_field_base_gear_tier),
         (assign, ":dest_base_gear_tier", reg1),
         (store_add, ":upgraded_base_gear_tier", ":source_base_gear_tier", 1),
         (val_min, ":upgraded_base_gear_tier", 7),
         (try_begin),
           (lt, ":upgraded_base_gear_tier", ":dest_base_gear_tier"),
           (assign, ":dest_base_gear_tier", ":upgraded_base_gear_tier"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", stack_econ_field_base_gear_troop, ":source_base_gear_troop"),
         (else_try),
           (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", stack_econ_field_base_gear_troop),
           (le, reg1, 0),
           (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", stack_econ_field_base_gear_troop, ":source_base_gear_troop"),
         (try_end),
       (else_try),
         (store_add, ":dest_base_gear_tier", ":source_base_gear_tier", 1),
         (val_min, ":dest_base_gear_tier", 7),
         (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", stack_econ_field_base_gear_troop, ":source_base_gear_troop"),
       (try_end),
       (val_max, ":dest_base_gear_tier", 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", stack_econ_field_base_gear_tier, ":dest_base_gear_tier"),
       ...
       (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         ...
         (ge, ":high_field", 0),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":field_no"),
         (assign, ":source_low", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":high_field"),
         (assign, ":source_high", reg1),
         (val_max, ":source_low", 0),
         (val_max, ":source_high", 0),
         (val_min, ":source_low", ":source_size"),
         (store_sub, ":max_source_high", ":source_size", ":source_low"),
         (val_min, ":source_high", ":max_source_high"),
         (store_sub, ":source_mid", ":source_size", ":source_low"),
         (val_sub, ":source_mid", ":source_high"),
         (val_max, ":source_mid", 0),

         (assign, ":move_high", ":source_high"),
         (val_min, ":move_high", ":upgraded_count"),
         (store_sub, ":remaining_move", ":upgraded_count", ":move_high"),
         (assign, ":move_mid", ":source_mid"),
         (val_min, ":move_mid", ":remaining_move"),
         (val_sub, ":remaining_move", ":move_mid"),
         (assign, ":move_low", ":source_low"),
         (val_min, ":move_low", ":remaining_move"),

         (val_sub, ":source_high", ":move_high"),
         (val_sub, ":source_low", ":move_low"),
         (party_stack_get_size, ":source_cur_size", ":party_no", ":source_stack"),
         (val_max, ":source_cur_size", 0),
         (val_min, ":source_low", ":source_cur_size"),
         (store_sub, ":max_source_high", ":source_cur_size", ":source_low"),
         (val_min, ":source_high", ":max_source_high"),
         (val_max, ":source_high", 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":source_stack", ":field_no", ":source_low"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":source_stack", ":high_field", ":source_high"),

         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", ":field_no"),
         (assign, ":dest_low", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", ":high_field"),
         (assign, ":dest_high", reg1),
         (val_max, ":dest_low", 0),
         (val_max, ":dest_high", 0),
         (val_add, ":dest_low", ":move_mid"),
         (val_add, ":dest_low", ":move_low"),
         (party_stack_get_size, ":dest_size", ":party_no", ":dest_stack"),
         (val_max, ":dest_size", 1),
         (val_min, ":dest_low", ":dest_size"),
         (store_sub, ":max_dest_high", ":dest_size", ":dest_low"),
         (val_min, ":dest_high", ":max_dest_high"),
         (val_max, ":dest_high", 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", ":field_no", ":dest_low"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", ":high_field", ":dest_high"),
       (try_end),
       (assign, ":field_no", stack_econ_field_shield_tier),
       (assign, ":high_field", stack_econ_field_shield_count),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":field_no"),
       (assign, ":source_low", reg1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":high_field"),
       (assign, ":source_high", reg1),
       ...
       (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", ":high_field", ":dest_high"),
       (try_begin),
         (call_script, "script_stack_econ_troop_uses_stack_horse", ":source_troop"),
         (eq, reg0, 1),
         (assign, ":field_no", stack_econ_field_horse_tier),
         (assign, ":high_field", stack_econ_field_horse_count),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":field_no"),
         ...
         (call_script, "script_stack_econ_troop_uses_stack_horse", ":upgrade_troop"),
         (eq, reg0, 1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", ":field_no"),
         (assign, ":dest_low", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", ":high_field"),
  ...
  ("stack_econ_select_item_from_troop_tree",
   [
     (store_script_param, ":troop_no", 1),
     (store_script_param, ":gear_kind", 2),
     (store_script_param, ":desired_tier", 3),
     (store_script_param, ":gear_source_troop", 4),
     (assign, reg0, -1),
     (try_begin),
       (le, ":gear_source_troop", 0),
       (assign, ":gear_source_troop", ":troop_no"),
     (try_end),
     (assign, ":scan_troop", ":gear_source_troop"),
     (call_script, "script_stack_econ_store_troop_base_tier", ":gear_source_troop"),
     (assign, ":base_tier", reg0),
     (val_max, ":desired_tier", 1),
     (val_min, ":desired_tier", 7),
     (store_sub, ":scan_steps", ":desired_tier", ":base_tier"),
     (val_add, ":scan_steps", 1),
     (val_max, ":scan_steps", 1),
     (val_min, ":scan_steps", 7),
     (try_for_range, ":tier_step", 0, ":scan_steps"),
       (val_add, ":tier_step", 0),
       (gt, ":scan_troop", 0),
       (troop_get_inventory_capacity, ":capacity", ":scan_troop"),
       (try_for_range, ":inv_slot", 0, ":capacity"),
         (troop_get_inventory_slot, ":item_no", ":scan_troop", ":inv_slot"),
         (ge, ":item_no", 0),
         (item_get_type, ":item_type", ":item_no"),
         (try_begin),
           (eq, ":gear_kind", stack_econ_gear_armor),
           (eq, ":item_type", itp_type_body_armor),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_helmet),
           (eq, ":item_type", itp_type_head_armor),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_boots),
           (eq, ":item_type", itp_type_foot_armor),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_gauntlets),
           (eq, ":item_type", itp_type_hand_armor),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_horse),
           (eq, ":item_type", itp_type_horse),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_shield),
           (eq, ":item_type", itp_type_shield),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_ranged),
           (this_or_next|eq, ":item_type", itp_type_bow),
           (this_or_next|eq, ":item_type", itp_type_crossbow),
           (eq, ":item_type", itp_type_thrown),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_ammo),
           (this_or_next|eq, ":item_type", itp_type_arrows),
           (eq, ":item_type", itp_type_bolts),
           (assign, reg0, ":item_no"),
         (else_try),
           (eq, ":gear_kind", stack_econ_gear_weapon),
           (this_or_next|eq, ":item_type", itp_type_one_handed_wpn),
           (this_or_next|eq, ":item_type", itp_type_two_handed_wpn),
           (eq, ":item_type", itp_type_polearm),
           (assign, reg0, ":item_no"),
       ...
       (try_end),
       (try_begin),
         (troop_get_upgrade_troop, ":next_troop", ":scan_troop", 0),
         (gt, ":next_troop", 0),
         (assign, ":scan_troop", ":next_troop"),
       (else_try),
         (assign, ":scan_troop", -1),
       (try_end),
     (try_end),
  ...
  ("stack_econ_select_item_from_troop_inventory",
   [
     (store_script_param, ":troop_no", 1),
     (store_script_param, ":gear_kind", 2),
     (assign, reg0, -1),
  ...
  ("stack_econ_troop_uses_shield",
   [
     (store_script_param, ":troop_no", 1),
     (assign, ":uses_shield", 0),
     (try_begin),
       (gt, ":troop_no", 0),
       (call_script, "script_stack_econ_select_item_from_troop_inventory", ":troop_no", stack_econ_gear_shield),
       (ge, reg0, 0),
       (assign, ":uses_shield", 1),
     (else_try),
       (troop_get_upgrade_troop, ":next_troop", ":troop_no", 0),
       (gt, ":next_troop", 0),
       (call_script, "script_stack_econ_select_item_from_troop_inventory", ":next_troop", stack_econ_gear_shield),
       (ge, reg0, 0),
       (assign, ":uses_shield", 1),
     (else_try),
       ...
       (assign, ":uses_shield", 1),
     (try_end),
     (assign, reg0, ":uses_shield"),
   ]),

  ("stack_econ_troop_uses_stack_horse",
   [
     (store_script_param, ":troop_no", 1),
     (assign, ":uses_stack_horse", 0),
     (try_begin),
       (gt, ":troop_no", 0),
       (call_script, "script_improvised_cavalry_get_original_troop", ":troop_no"),
       (lt, reg0, 0),
       (this_or_next|troop_is_mounted, ":troop_no"),
       (troop_is_guarantee_horse, ":troop_no"),
       (assign, ":uses_stack_horse", 1),
     (try_end),
     (assign, reg0, ":uses_stack_horse"),
   ]),

  ("stack_econ_select_item_for_agent_tier",
   [
     (store_script_param, ":troop_no", 1),
     (store_script_param, ":gear_kind", 2),
     (store_script_param, ":desired_tier", 3),
     ...
     (assign, ":troop_tier", reg0),
     (try_begin),
       (lt, ":desired_tier", ":troop_tier"),
       (gt, ":gear_source_troop", 0),
       (call_script, "script_stack_econ_select_item_from_troop_inventory", ":gear_source_troop", ":gear_kind"),
     (else_try),
       (le, ":desired_tier", ":troop_tier"),
       (call_script, "script_stack_econ_select_item_from_troop_inventory", ":troop_no", ":gear_kind"),
     (else_try),
       (troop_get_upgrade_troop, ":next_troop", ":troop_no", 0),
       (gt, ":next_troop", 0),
       (call_script, "script_stack_econ_select_item_from_troop_inventory", ":next_troop", ":gear_kind"),
       (try_begin),
         (lt, reg0, 0),
         (troop_get_upgrade_troop, ":next_troop", ":troop_no", 1),
         (gt, ":next_troop", 0),
  ...
  ("stack_econ_item_is_in_troop_tree_tier",
   [
     (store_script_param, ":troop_no", 1),
     (store_script_param, ":item_to_check", 2),
     (store_script_param, ":gear_kind", 3),
     (store_script_param, ":desired_tier", 4),
     (store_script_param, ":gear_source_troop", 5),
     (assign, ":found_item", 0),
     (try_begin),
       (le, ":gear_source_troop", 0),
       (assign, ":gear_source_troop", ":troop_no"),
     ...
     (call_script, "script_stack_econ_store_troop_base_tier", ":gear_source_troop"),
     (assign, ":base_tier", reg0),
     (store_sub, ":advance_steps", ":desired_tier", ":base_tier"),
     (val_max, ":advance_steps", 0),
     (val_min, ":advance_steps", 6),
     (try_for_range, ":tier_step", 0, ":advance_steps"),
       (val_add, ":tier_step", 0),
       (gt, ":scan_troop", 0),
       (troop_get_upgrade_troop, ":next_troop", ":scan_troop", 0),
       (try_begin),
     ...
     (try_begin),
       (gt, ":scan_troop", 0),
       (item_get_type, ":check_type", ":item_to_check"),
       (troop_get_inventory_capacity, ":capacity", ":scan_troop"),
       (try_for_range, ":inv_slot", 0, ":capacity"),
         (eq, ":found_item", 0),
         (troop_get_inventory_slot, ":item_no", ":scan_troop", ":inv_slot"),
         (eq, ":item_no", ":item_to_check"),
         (item_get_type, ":item_type", ":item_no"),
         (eq, ":item_type", ":check_type"),
         (try_begin),
           (eq, ":gear_kind", stack_econ_gear_armor),
           (eq, ":item_type", itp_type_body_armor),
           (assign, ":found_item", 1),
  ...
  ("stack_econ_apply_to_agent",
   [
     (store_script_param, ":agent_no", 1),
     (try_begin),
       (agent_is_human, ":agent_no"),
       (agent_get_slot, ":applied", ":agent_no", slot_agent_stack_econ_applied),
       (neq, ":applied", 1),
       (agent_get_party_id, ":party_no", ":agent_no"),
       (ge, ":party_no", 0),
       (call_script, "script_stack_econ_process_party", ":party_no"),
       ...
       (gt, ":troop_no", 0),
       (neg|troop_is_hero, ":troop_no"),
       (assign, ":gear_troop_no", ":troop_no"),
       (call_script, "script_improvised_cavalry_get_original_troop", ":troop_no"),
       (try_begin),
         (ge, reg0, 0),
         (assign, ":gear_troop_no", reg0),
       (try_end),
       (call_script, "script_stack_econ_find_stack_by_troop", ":party_no", ":troop_no"),
       (assign, ":stack_no", reg0),
       (ge, ":stack_no", 0),
       (call_script, "script_stack_econ_initialize_stack", ":party_no", ":stack_no"),
       (agent_set_slot, ":agent_no", slot_agent_stack_econ_applied, 1),
       (agent_set_slot, ":agent_no", slot_agent_stack_econ_party, ":party_no"),
       (agent_set_slot, ":agent_no", slot_agent_stack_econ_stack, ":stack_no"),
       (party_stack_get_size, ":stack_size", ":party_no", ":stack_no"),
       (val_max, ":stack_size", 1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_base_gear_tier),
       (assign, ":base_tier", reg1),
       (try_begin),
         (le, ":base_tier", 0),
         (call_script, "script_stack_econ_store_troop_base_tier", ":gear_troop_no"),
         (assign, ":base_tier", reg0),
       (try_end),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_base_gear_troop),
       (assign, ":gear_source_troop", reg1),
       (try_begin),
         (le, ":gear_source_troop", 0),
         (assign, ":gear_source_troop", ":gear_troop_no"),
       (try_end),
       (assign, ":apply_stack_equipment", 0),
       (try_begin),
         (neq, ":gear_source_troop", ":gear_troop_no"),
         (assign, ":apply_stack_equipment", 1),
       (try_end),
       (try_for_range, ":tier_field", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         (eq, ":apply_stack_equipment", 0),
         (neq, ":tier_field", stack_econ_field_horse_tier),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":tier_field"),
         (gt, reg1, 0),
         (assign, ":apply_stack_equipment", 1),
       (try_end),
       ...
       (try_begin),
         ...
         (assign, ":apply_stack_equipment", 1),
       (try_end),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_spawn_index),
       (assign, ":spawn_index", reg1),
       (try_begin),
         (ge, ":spawn_index", ":stack_size"),
         (assign, ":spawn_index", 0),
       (try_end),
       (store_add, ":next_spawn_index", ":spawn_index", 1),
       (try_begin),
         (ge, ":next_spawn_index", ":stack_size"),
         (assign, ":next_spawn_index", 0),
       (try_end),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_spawn_index, ":next_spawn_index"),

       (try_begin),
         (eq, ":apply_stack_equipment", 1),

       (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_armor_tier, ":base_tier", ":spawn_index"),
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_armor, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
         (agent_get_item_slot, ":old_item", ":agent_no", 5),
         (try_begin), (ge, ":old_item", 0), (agent_unequip_item, ":agent_no", ":old_item"), (try_end),
         (agent_equip_item, ":agent_no", reg0),
       (try_end),

       (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_helmet_tier, ":base_tier", ":spawn_index"),
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_helmet, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
         (agent_get_item_slot, ":old_item", ":agent_no", 4),
         (try_begin), (ge, ":old_item", 0), (agent_unequip_item, ":agent_no", ":old_item"), (try_end),
         (agent_equip_item, ":agent_no", reg0),
       (try_end),

       (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_boots_tier, ":base_tier", ":spawn_index"),
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_boots, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
         (agent_get_item_slot, ":old_item", ":agent_no", 6),
         (try_begin), (ge, ":old_item", 0), (agent_unequip_item, ":agent_no", ":old_item"), (try_end),
         (agent_equip_item, ":agent_no", reg0),
       (try_end),

       (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_tier, ":base_tier", ":spawn_index"),
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_gauntlets, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
         (agent_get_item_slot, ":old_item", ":agent_no", 7),
         (try_begin), (ge, ":old_item", 0), (agent_unequip_item, ":agent_no", ":old_item"), (try_end),
         (agent_equip_item, ":agent_no", reg0),
       (try_end),

       (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, ":base_tier", ":spawn_index"),
       (assign, ":weapon_1_tier", reg0),
       (try_for_range, ":weapon_slot", 0, 4),
         (agent_get_item_slot, ":old_item", ":agent_no", ":weapon_slot"),
         (try_begin),
           (ge, ":old_item", 0),
           (agent_unequip_item, ":agent_no", ":old_item", 1),
         (try_end),
       (try_end),
       (try_begin),
         (troop_is_guarantee_ranged, ":gear_troop_no"),
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_ranged, ":weapon_1_tier", ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),

         (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, ":base_tier", ":spawn_index"),
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_ammo, reg0, ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),

         (call_script, "script_stack_econ_select_item_from_troop_inventory", ":gear_troop_no", stack_econ_gear_shield),
         (try_begin),
           (ge, reg0, 0),
           (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_shield_tier, ":base_tier", ":spawn_index"),
           (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_shield, reg0, ":gear_source_troop"),
           (try_begin),
             (ge, reg0, 0),
             (agent_equip_item, ":agent_no", reg0, 1),
           (try_end),
         (try_end),
       (else_try),
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":gear_troop_no", stack_econ_gear_weapon, ":weapon_1_tier", ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),
  ...
  ("assign_horses_to_infantry",
   [
     ...
     (try_begin),
       ...
       (troop_get_inventory_capacity, ":inv_cap", "trp_temp_troop"),
       (try_for_range, ":i_slot", 0, ":inv_cap"),
         (troop_get_inventory_slot, ":item_no", "trp_temp_troop", ":i_slot"),
         (ge, ":item_no", 0),
         (troop_get_inventory_slot_modifier, ":imod", "trp_temp_troop", ":i_slot"),
         (troop_add_item, "trp_player", ":item_no", ":imod"),
         (troop_set_inventory_slot, "trp_temp_troop", ":i_slot", -1),
