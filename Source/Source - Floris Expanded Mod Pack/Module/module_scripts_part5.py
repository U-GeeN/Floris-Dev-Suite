  ...
  ("stack_econ_debug_report_stack",
   [
     ...
     (try_begin),
       ...
       (str_store_string, s2, "@We have {reg1} {s1}, {reg2} denars held for equipment, and unsold loot worth {reg3}. Gear bands: low t{reg5}, standard t{reg4}, high t{reg6}."),
       ...
       (assign, reg0, ":armor_low"), (assign, reg1, ":armor_mid"), (assign, reg2, ":armor_count"),
       (assign, reg3, ":helmet_low"), (assign, reg4, ":helmet_mid"), (assign, reg5, ":helmet_count"),
       (str_store_string, s2, "@{s2}^Armor low/mid/high: {reg0}/{reg1}/{reg2}. Helmet low/mid/high: {reg3}/{reg4}/{reg5}."),
       (assign, reg0, ":boots_low"), (assign, reg1, ":boots_mid"), (assign, reg2, ":boots_count"),
       (assign, reg3, ":gauntlets_low"), (assign, reg4, ":gauntlets_mid"), (assign, reg5, ":gauntlets_count"),
       (str_store_string, s2, "@{s2}^Boots low/mid/high: {reg0}/{reg1}/{reg2}. Gauntlets low/mid/high: {reg3}/{reg4}/{reg5}."),
       ...
       (assign, reg0, ":weapon_1_low"), (assign, reg1, ":weapon_1_mid"), (assign, reg2, ":weapon_1_count"),
       (assign, reg3, ":weapon_2_low"), (assign, reg4, ":weapon_2_mid"), (assign, reg5, ":weapon_2_count"),
       (str_store_string, s2, "@{s2}^Weapon 1 low/mid/high: {reg0}/{reg1}/{reg2}. Weapon 2/ammo low/mid/high: {reg3}/{reg4}/{reg5}."),
       (assign, reg0, ":weapon_3_low"), (assign, reg1, ":weapon_3_mid"), (assign, reg2, ":weapon_3_count"),
       (assign, reg3, ":weapon_4_low"), (assign, reg4, ":weapon_4_mid"), (assign, reg5, ":weapon_4_count"),
       (str_store_string, s2, "@{s2}^Weapon 3 low/mid/high: {reg0}/{reg1}/{reg2}. Weapon 4 low/mid/high: {reg3}/{reg4}/{reg5}."),
     (try_end),
   ]),
