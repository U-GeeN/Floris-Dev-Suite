...
## WINDYPLAINS- ##
  ...
  ("stack_econ_cheat_equip_stack_for_next_upgrade",
   [
     ...
     (try_begin),
       ...
       (assign, ":needs_horse", 0),

       (try_begin),
         (troop_is_guarantee_horse, ":troop_no"),
         (assign, ":needs_horse", 1),
       (try_end),
       ...
       (try_begin),
         (eq, ":needs_horse", 1),
         (call_script, "script_stack_econ_get_count_field", stack_econ_field_horse_tier),
         (assign, ":high_field", reg0),
         (ge, ":high_field", 0),
  ...
  ("stack_econ_debug_report_stack",
   [
     ...
     (try_begin),
       ...
       (store_sub, ":horse_mid", ":stack_size", ":horse_low"), (val_sub, ":horse_mid", ":horse_count"),
       ...
       (assign, reg6, ":horse_low"), (assign, reg7, ":horse_mid"), (assign, reg8, ":horse_count"),
       (str_store_string, s2, "@{s2}^Boots low/mid/high: {reg0}/{reg1}/{reg2}. Gauntlets low/mid/high: {reg3}/{reg4}/{reg5}. Horse low/mid/high: {reg6}/{reg7}/{reg8}."),
  ...
  ("stack_econ_process_stack",
   [
     ...
     (try_begin),
       ...
       (try_begin),
         (troop_is_guarantee_horse, ":troop_no"),
         (call_script, "script_stack_econ_ensure_required_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, 1, stack_econ_cost_horse),
       (try_end),
       (try_begin),
         (troop_is_guarantee_ranged, ":troop_no"),
   ...
   [
     ...
     (try_begin),
       ...
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         ...
         (assign, reg9, ":horse_low"),
         (display_message, "@Stack economy debug: stack {reg0}: {reg1} {s1}; gold {reg2}; armor low/high {reg3}/{reg4}, helmet {reg5}/{reg6}, weapon {reg7}/{reg8}, horse low {reg9}.", 0xFF99DDFF),
       (try_end),
     (try_end),
   ]),
  ...
  ("stack_econ_apply_to_agent",
   [
     ...
     (try_begin),
       ...
       (try_begin),
         (neq, ":gear_source_troop", ":troop_no"),
       ...
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_armor, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_helmet, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_boots, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_gauntlets, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_get_agent_tier_for_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, 0, ":spawn_index"),
       (assign, ":horse_tier", reg0),
       (try_begin),
         (troop_is_guarantee_horse, ":troop_no"),
         (lt, ":horse_tier", 1),
         (assign, ":horse_tier", 1),
       ...
       (try_begin),
         (gt, ":horse_tier", 0),
         # Mounted infantry use their specific looted horse
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_is_mounted_infantry),
         (eq, reg1, 1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_horse_item),
         (ge, reg1, 0),
         (agent_equip_item, ":agent_no", reg1),
       (else_try),
         (gt, ":horse_tier", 0),
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_horse, ":horse_tier", ":gear_source_troop"),
         (ge, reg0, 0),
         (agent_equip_item, ":agent_no", reg0),
       (try_end),
       ...
       (try_begin),
         (troop_is_guarantee_ranged, ":troop_no"),
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_ranged, ":weapon_1_tier", ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
         ...
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_ammo, reg0, ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),
       (else_try),
         (call_script, "script_stack_econ_select_item_for_agent_tier", ":troop_no", stack_econ_gear_weapon, ":weapon_1_tier", ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),
  ...
  ("assign_horses_to_infantry",
   [
     (store_script_param, ":party_no", 1),
     # For each horse in trp_temp_troop, find the best infantry stack that can ride it
     (try_begin),
       (party_is_active, ":party_no"),
       (troop_get_inventory_capacity, ":inv_cap", "trp_temp_troop"),
       (try_for_range, ":i_slot", 0, ":inv_cap"),
         (troop_get_inventory_slot, ":horse_item", "trp_temp_troop", ":i_slot"),
         (ge, ":horse_item", 0),
         (item_get_type, ":horse_type", ":horse_item"),
         (eq, ":horse_type", itp_type_horse),

         # Get riding requirement from difficulty slot
         (item_get_slot, ":riding_req", ":horse_item", slot_item_difficulty),

         # Find best infantry stack: non-cavalry, unm_mounted, sufficient riding skill
         (assign, ":best_stack", -1),
         (assign, ":best_tier", -1),
         ...
         (try_for_range, ":stack_no", 0, ":num_stacks"),
           ...
           (party_stack_get_troop_id, ":troop_no", ":party_no", ":stack_no"),
           (neg|troop_is_hero, ":troop_no"),
           (neg|troop_is_guarantee_horse, ":troop_no"),    # Infantry only

           # Check not already mounted via looted horse
           (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_is_mounted_infantry),
           (eq, reg1, 0),

           # Check riding skill against horse difficulty
           (store_skill_level, ":riding", skl_riding, ":troop_no"),
           (ge, ":riding", ":riding_req"),

           # Prefer higher-tier troop for a better horse
           (call_script, "script_stack_econ_store_troop_base_tier", ":troop_no"),
           (gt, reg0, ":best_tier"),
           (assign, ":best_tier", reg0),
           (assign, ":best_stack", ":stack_no"),
         (try_end),

         (try_begin),
           (ge, ":best_stack", 0),
           # Assign horse to this stack
           (call_script, "script_stack_econ_initialize_stack", ":party_no", ":best_stack"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", stack_econ_field_horse_tier, 0),
           (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", stack_econ_field_horse_count, 1),
           (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", stack_econ_field_horse_item, ":horse_item"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":best_stack", stack_econ_field_is_mounted_infantry, 1),
           # Remove horse from pool
           (troop_set_inventory_slot, "trp_temp_troop", ":i_slot", -1),
         (else_try),
           # No eligible stack found - return horse to player inventory
           (troop_add_item, "trp_player", ":horse_item"),
           (troop_set_inventory_slot, "trp_temp_troop", ":i_slot", -1),
           (str_store_item_name, s1, ":horse_item"),
           (display_message, "@No infantry with sufficient riding skill for {s1}. Returned to inventory.", 0xFFAA6633),
         (try_end),
       (try_end),
       (call_script, "script_stack_econ_process_party_equipment", ":party_no"),
     (try_end),
