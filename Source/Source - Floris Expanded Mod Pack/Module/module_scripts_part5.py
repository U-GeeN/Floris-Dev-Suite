  ...
  ("stack_econ_move_stack_record",
   [
     ...
     (try_begin),
       ...
       (try_for_range, ":field_no", 0, stack_econ_field_base_gear_troop + 1),
   ...
   [
     ...
     (try_begin),
       ...
       (try_begin),
         ...
         (try_for_range, ":upgrade_path", 0, 2),
           ...
           (try_for_range, ":count_field", stack_econ_field_armor_count, stack_econ_field_weapon_4_count + 1),
             (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":count_field"),
             (assign, ":cur_count", reg1),
             (val_min, ":cur_count", ":stack_size"),
             (val_max, ":cur_count", 0),
             (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":count_field", ":cur_count"),
           (try_end),
       ...
       (try_begin),
         ...
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_armor_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_helmet_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_boots_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_tier, ":base_tier"),
         (try_begin),
           (troop_is_guarantee_horse, ":troop_no"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, ":base_tier"),
         (else_try),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, 0),
         (try_end),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_3_tier, ":base_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_4_tier, ":base_tier"),
         ...
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_armor_count, ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_helmet_count, ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_boots_count, ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_count, ":stack_size"),
         (try_begin),
           (troop_is_guarantee_horse, ":troop_no"),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_count, ":stack_size"),
         (else_try),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_count, 0),
         (try_end),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_count, ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_count, ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_3_count, ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_4_count, ":stack_size"),
       (try_end),
  ...
  ("stack_econ_initialize_empty_stack",
   [
     ...
     (try_begin),
       ...
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_armor_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_helmet_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_boots_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, 0),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_3_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_4_tier, 1),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_quality_seed, ":seed"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_spawn_index, 0),
       (try_for_range, ":count_field", stack_econ_field_armor_count, stack_econ_field_weapon_4_count + 1),
  ...
  ("stack_econ_try_upgrade_field",
   [
     ...
     (try_begin),
       ...
       (store_mul, ":cost", ":base_cost", ":next_tier"),
       (ge, ":gold", ":cost"),
       (val_sub, ":gold", ":cost"),
       (val_add, ":cur_count", 1),
       (val_min, ":cur_count", ":stack_size"),

       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", ":next_tier"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":count_field", ":cur_count"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, ":gold"),
     (try_end),
   ]),
  ...
  ("stack_econ_ensure_required_field",
   [
     ...
     (try_begin),
       ...
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":count_field"),
       (assign, ":cur_count", reg1),
       (this_or_next|lt, ":cur_tier", ":min_tier"),
       (lt, ":cur_count", ":stack_size"),

       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gold),
       (assign, ":gold", reg1),
       (store_mul, ":cost", ":base_cost", ":min_tier"),
       (store_sub, ":needed_count", ":stack_size", ":cur_count"),
       (val_max, ":needed_count", 1),
       (val_mul, ":cost", ":needed_count"),
       (val_sub, ":gold", ":cost"),
       (val_max, ":gold", 0),

       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", ":min_tier"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":count_field", ":stack_size"),
       (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, ":gold"),
     (try_end),
   ]),
   ...
   [
     ...
     (try_begin),
       ...
       (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         ...
         (assign, ":count_field", reg0),
         (ge, ":count_field", 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":field_no", ":target_tier"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":count_field"),
         (assign, ":cur_count", reg1),
         (val_add, ":cur_count", ":equip_count"),
         (val_min, ":cur_count", ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":count_field", ":cur_count"),
       (try_end),
       (try_begin),
         (eq, ":needs_horse", 1),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, ":target_tier"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_horse_count),
         (assign, ":cur_count", reg1),
         (val_add, ":cur_count", ":equip_count"),
         (val_min, ":cur_count", ":stack_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_horse_count, ":cur_count"),
       (try_end),
       (try_begin),
         (eq, ":needs_ranged", 1),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, ":target_tier"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, ":target_tier"),
       (try_end),
  ...
  ("stack_econ_debug_report_stack",
   [
     ...
     (try_begin),
       ...
       (assign, reg2, ":gold"),
       (display_message, "@CHEAT stack econ: stack {reg0}: {reg1} {s1}; gold {reg2}.", 0xFF66CCFF),
       (assign, reg0, ":armor_tier"),
       (assign, reg1, ":helmet_tier"),
       (assign, reg2, ":boots_tier"),
       (assign, reg3, ":gauntlets_tier"),
       (assign, reg4, ":horse_tier"),
       (assign, reg5, ":armor_count"),
       (assign, reg6, ":helmet_count"),
       (assign, reg7, ":boots_count"),
       (assign, reg8, ":gauntlets_count"),
       (assign, reg9, ":horse_count"),
       (display_message, "@CHEAT stack econ: armor t{reg0} x{reg5}, helmet t{reg1} x{reg6}, boots t{reg2} x{reg7}, gauntlets t{reg3} x{reg8}, horse t{reg4} x{reg9}.", 0xFF99DDFF),
       (assign, reg0, ":weapon_1_tier"),
       (assign, reg1, ":weapon_2_tier"),
       (assign, reg2, ":weapon_3_tier"),
       (assign, reg3, ":weapon_4_tier"),
       (assign, reg4, ":weapon_1_count"),
       (assign, reg5, ":weapon_2_count"),
       (assign, reg6, ":weapon_3_count"),
       (assign, reg7, ":weapon_4_count"),
       (display_message, "@CHEAT stack econ: weapon1 t{reg0} x{reg4}, weapon2/ammo t{reg1} x{reg5}, weapon3 t{reg2} x{reg6}, weapon4 t{reg3} x{reg7}.", 0xFF99DDFF),
     (try_end),
   ]),
  ...
  ("stack_econ_process_stack",
   [
     ...
     (try_begin),
       ...
       # Wage savings and scavenged low-value loot create gradual self-financing.
       (store_mul, ":income", ":stack_size", ":base_tier"),
       (val_div, ":income", 2),
       (val_max, ":income", 1),
       (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gold),
       (assign, ":gold", reg1),
       ...
       (try_begin),
         (troop_is_guarantee_horse, ":troop_no"),
         (call_script, "script_stack_econ_ensure_required_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, 1, 40),
       (try_end),
       (try_begin),
         (troop_is_guarantee_ranged, ":troop_no"),
         (call_script, "script_stack_econ_ensure_required_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, 1, 18),
         (call_script, "script_stack_econ_ensure_required_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, 1, 8),
       (try_end),

       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_weapon_1_tier, ":target_tier", 18),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_armor_tier, ":target_tier", 30),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_helmet_tier, ":target_tier", 16),
       (try_begin),
         (troop_is_guarantee_horse, ":troop_no"),
         (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_horse_tier, ":target_tier", 40),
       (try_end),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_boots_tier, ":target_tier", 12),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_gauntlets_tier, ":target_tier", 10),
       (call_script, "script_stack_econ_try_upgrade_field", ":party_no", ":stack_no", stack_econ_field_weapon_2_tier, ":target_tier", 14),
     (try_end),
   ]),
     ...
     (try_begin),
       ...
       (else_try),
         (try_for_range, ":count_field", stack_econ_field_armor_count, stack_econ_field_weapon_4_count + 1),
           (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", ":count_field"),
           (assign, ":count", reg1),
           (val_min, ":count", ":stack_size"),
           (val_max, ":count", 0),
           (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", ":count_field", ":count"),
         (try_end),
       (try_end),
     (try_end),
   ]),
   ...
   [
     ...
     (try_begin),
       ...
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         ...
         (assign, reg1, ":stack_size"),
         (assign, reg2, ":gold"),
         (assign, reg3, ":armor_tier"),
         (assign, reg4, ":helmet_tier"),
         (assign, reg5, ":weapon_tier"),
         (assign, reg6, ":horse_tier"),
         (display_message, "@Stack economy debug: stack {reg0}: {reg1} {s1}; gold {reg2}; armor {reg3}, helmet {reg4}, weapon {reg5}, horse {reg6}.", 0xFF99DDFF),
       (try_end),
     (try_end),
   ]),

  ("stack_econ_distribute_loot_value",
   [
     (store_script_param, ":party_no", 1),
     ...
     (try_begin),
       ...
       (try_for_range, ":stack_no", 0, ":num_stacks"),
         ...
         (neg|troop_is_hero, ":troop_no"),
         (call_script, "script_stack_econ_initialize_stack", ":party_no", ":stack_no"),
         (store_mul, ":share", ":loot_value", ":stack_size"),
         (val_div, ":share", ":num_companions"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":stack_no", stack_econ_field_gold),
         (assign, ":gold", reg1),
         (val_add, ":gold", ":share"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":stack_no", stack_econ_field_gold, ":gold"),
   ...
   [
     ...
     (try_begin),
       ...
       (try_begin),
         ...
         (try_begin),
           (lt, ":source_base_gear_tier", ":dest_base_gear_tier"),
           (assign, ":dest_base_gear_tier", ":source_base_gear_tier"),
       ...
       (try_for_range, ":field_no", stack_econ_field_armor_tier, stack_econ_field_weapon_4_tier + 1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":field_no"),
         (assign, ":source_tier", reg1),
         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", ":field_no"),
         (assign, ":old_dest_tier", reg1),
         (assign, ":new_dest_tier", ":old_dest_tier"),
         (try_begin),
           (eq, ":dest_was_initialized", 0),
           (assign, ":new_dest_tier", ":source_tier"),
         (else_try),
           (gt, ":source_tier", ":old_dest_tier"),
           (assign, ":new_dest_tier", ":source_tier"),
         (try_end),
         (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", ":field_no", ":new_dest_tier"),
         (call_script, "script_stack_econ_get_count_field", ":field_no"),
         (assign, ":count_field", reg0),
         (ge, ":count_field", 0),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":count_field"),
         (assign, ":source_count", reg1),
         (val_min, ":source_count", ":upgraded_count"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":dest_stack", ":count_field"),
         (assign, ":dest_count", reg1),
         (try_begin),
           (eq, ":dest_was_initialized", 0),
           (assign, ":dest_count", ":source_count"),
         (else_try),
           (gt, ":source_tier", ":old_dest_tier"),
           (assign, ":dest_count", ":source_count"),
         (else_try),
           (eq, ":source_tier", ":old_dest_tier"),
           (val_add, ":dest_count", ":source_count"),
         (try_end),
         (party_stack_get_size, ":dest_size", ":party_no", ":dest_stack"),
         (val_max, ":dest_size", 1),
         (val_min, ":dest_count", ":dest_size"),
         (call_script, "script_stack_econ_set_field", ":party_no", ":dest_stack", ":count_field", ":dest_count"),
         (call_script, "script_stack_econ_get_field", ":party_no", ":source_stack", ":count_field"),
         (assign, ":remaining_source_count", reg1),
         (val_sub, ":remaining_source_count", ":source_count"),
         (party_stack_get_size, ":source_cur_size", ":party_no", ":source_stack"),
         (val_max, ":source_cur_size", 0),
         (val_min, ":remaining_source_count", ":source_cur_size"),
         (val_max, ":remaining_source_count", 0),
         (call_script, "script_stack_econ_set_field", ":party_no", ":source_stack", ":count_field", ":remaining_source_count"),
       (try_end),
     (try_end),
   ]),
  ...
  ("stack_econ_apply_to_agent",
   [
     ...
     (try_begin),
       ...
       (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_armor, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_helmet, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_boots, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_gauntlets, reg0, ":gear_source_troop"),
       (try_begin),
         (ge, reg0, 0),
       ...
       (try_begin),
         (gt, ":horse_tier", 0),
         (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_horse, ":horse_tier", ":gear_source_troop"),
         (ge, reg0, 0),
         (agent_equip_item, ":agent_no", reg0),
       (try_end),
       ...
       (try_begin),
         (troop_is_guarantee_ranged, ":troop_no"),
         (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_ranged, ":weapon_1_tier", ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
         ...
         (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_ammo, reg0, ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),
       (else_try),
         (call_script, "script_stack_econ_select_item_from_troop_tree", ":troop_no", stack_econ_gear_weapon, ":weapon_1_tier", ":gear_source_troop"),
         (try_begin),
           (ge, reg0, 0),
           (agent_equip_item, ":agent_no", reg0, 1),
         (try_end),
