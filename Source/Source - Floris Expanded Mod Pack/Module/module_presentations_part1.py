     ...
     [(set_fixed_point_multiplier, 1000),
      ...
      (overlay_set_position, reg0, pos1),
				...
				(try_begin),
					...
					(troop_get_slot,":cur_troop","$troop_trees",slot_swadian_chevalier),
				(else_try),
					(eq, "$g_quick_battle_team_2_faction", "fac_kingdom_2"),
					(troop_get_slot,":cur_troop","$troop_trees",slot_vaegir_pansirniy_kazan),
				(else_try),
				...
				(else_try),
					...
					(troop_get_slot,":cur_troop","$troop_trees",slot_sarranid_kapikula),
				(else_try),
					(troop_get_slot,":cur_troop","$troop_trees",slot_bandit_taiga),
				(try_end),
				##Floris MTT end
...
##      (overlay_set_size, "$g_presentation_obj_custom_battle_designer_4", pos1),
      ...
      (try_begin),
        ...
        (overlay_add_item, "$g_presentation_obj_custom_battle_designer_4", s0),
      (else_try),
        (try_for_range, ":cur_faction", kingdoms_begin, kingdoms_end), #Player Faction
          (str_store_faction_name, s0, ":cur_faction"),
          (overlay_add_item, "$g_presentation_obj_custom_battle_designer_4", s0),
        (try_end),
      ...
      (try_begin),
        ...
        (store_sub, ":overlay_value", kingdoms_end, kingdoms_begin), #Player Faction
        (overlay_set_val, "$g_presentation_obj_custom_battle_designer_4", ":overlay_value"),
      (else_try),
        (store_sub, ":team_1_faction", "$g_quick_battle_team_1_faction", kingdoms_begin), #Player Faction
...
##      (overlay_set_size, "$g_presentation_obj_custom_battle_designer_5", pos1),
      ...
      (try_begin),
        (is_trial_version),
        (str_store_faction_name, s0, kingdoms_begin), #Player Faction
        (overlay_add_item, "$g_presentation_obj_custom_battle_designer_5", s0),
        (store_add, ":cur_faction", kingdoms_begin, 1), #Player Faction
        (str_store_faction_name, s0, ":cur_faction"),
        (overlay_add_item, "$g_presentation_obj_custom_battle_designer_5", s0),
      (else_try),
        (try_for_range, ":cur_faction", kingdoms_begin, kingdoms_end), #Player Faction
      ...
      (else_try),
        (store_sub, ":team_2_faction", "$g_quick_battle_team_2_faction", kingdoms_begin), #Player Faction
     ...
     [
       ...
       (else_try),
         ...
         (try_begin),
           ...
           (val_add, "$g_quick_battle_army_1_size", ":random_army_size"),
         (else_try),
           (store_sub, ":num_factions", kingdoms_end, kingdoms_begin), #Player Faction
           ...
           (else_try),
             (val_add, "$g_quick_battle_team_1_faction", kingdoms_begin), #Player Faction
           ...
           (try_for_range, ":unused", 0, ":end_cond"),
             ...
             (else_try),
               (val_add, "$g_quick_battle_team_2_faction", kingdoms_begin), #Player Faction
       ...
       (else_try),
         ...
         (try_begin),
           (store_sub, ":outlaw_index", kingdoms_end, kingdoms_begin), #Player Faction
           (eq, ":value", ":outlaw_index"),
           (assign, "$g_quick_battle_team_1_faction", "fac_outlaws"),
         (else_try),
           (store_add, "$g_quick_battle_team_1_faction", ":value", kingdoms_begin), #Player Faction
         (try_end),
       (else_try),
         ...
         (try_begin),
           ...
           (assign, "$g_quick_battle_team_2_faction", "fac_outlaws"),
         (else_try),
           (store_add, "$g_quick_battle_team_2_faction", ":value", kingdoms_begin), #Player Faction
         (try_end),
         (presentation_set_duration, 0),
         (start_presentation, "prsnt_game_custom_battle_designer"),
       (else_try),
...
#            (assign, "$g_troop_take_back_banner", ":cur_troop"), ## CC 1.324, Floris: Removed because it caused trouble
            (assign, ":end_cond", 0),
			(troop_set_slot, ":cur_troop", slot_troop_banner_scene_prop, banner_scene_props_end_minus_one),
#            (party_set_banner_icon, ":cur_party", banner_map_icons_end_minus_one), ##CC 1.324, Floris: Removed because it caused trouble
