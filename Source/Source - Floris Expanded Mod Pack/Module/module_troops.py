...
upgrade(troops,"nord_e_axeman","nord_e_vikingr_i5")
upgrade2(troops,"nord_e_warrior","nord_e_champion","nord_e_vikingr_i5")
...
upgrade(troops,"nord_e_vikingr_i5","nord_e_marauder")
