...
## CC
  ("player_supporters_faction","Player's Supporters",0, 0.9, [("player_faction",1.00),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02)], [], 0xFF4433), #changed name so that can tell difference if shows up on map
  ("kingdom_1",  "Kingdom of Swadia",   0, 0.9, default_kingdom_relations, [], 0xEE7744),
  ("kingdom_2",  "Grand Principality of the Vaegirs",  0, 0.9, default_kingdom_relations, [], 0xCCBB99),
  ("kingdom_3",  "Khergit Khanate",     0, 0.9, default_kingdom_relations, [], 0xCC99FF),
  ("kingdom_4",  "Kingdom of the Nords",    0, 0.9, default_kingdom_relations, [], 0x33DDDD),
  ("kingdom_5",  "Rhodok Republic",  0, 0.9, default_kingdom_relations, [], 0x33DD33),
...
## CC
  ...
  ("black_khergits","{!}Freelancers", 0, 0.5,[("player_faction",-0.3),("kingdom_1",-0.02),("kingdom_2",-0.02)], []),
...
##  ("rebel_peasants","Rebel Peasants", 0, 0.5,[("vaegirs",-0.5),("player_faction",0.0)], []),
  ...
  ("mountain_bandits","Mountain Bandits", 0, 0.5,[("commoners",-0.2),("merchants",-0.5),("manhunters",-0.6),("player_faction",-0.15)], [], 0x888888), ##Floris: put it back for savegame compatibility.
  ("forest_bandits","Forest Bandits", 0, 0.5,[("commoners",-0.2),("merchants",-0.5),("manhunters",-0.6),("player_faction",-0.15)], [], 0x888888), ##Floris: put it back for savegame compatibility.
