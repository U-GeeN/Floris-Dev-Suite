...
#  ("entrance_to_town_forbidden","It seems that the town guards have been warned of your presence and you won't be able to enter the town unchallenged."),
  ...
  ("hero_taken_prisoner", "{s1} of the {s3} has been taken prisoner by {s2}."),
  ("hero_freed", "{s1} of the {s3} has been freed from captivity by {s2}."),
  ("center_captured", "{s2} have taken {s1} from the {s3}."),
  ...
  ("s3s_s2", "{s3}'s {s2}"),
  ("s5_is_s51", "{s5} is {s51}."),
  ("s5_is_the_ruler_of_s51", "{s5} is the ruler of the {s51}. "),
##diplomacy start+ make gender correct using reg4
  ("s5_is_a_nobleman_of_s6", "{s5} is a {reg4?noblewoman:nobleman} of the {s6}. "),#-- update fix 2011-04-08, ternary was messed up
##diplomacy end+
...
# Surname
  ...
  ("female_name_1", "Aethelgard"),
  ("female_name_2", "Alis"),
  ("female_name_3", "Beatrice"),
  ("female_name_4", "Clara"),
  ("female_name_5", "Edith"),
  ("female_name_6", "Eleanor"),
  ("female_name_7", "Gwendolyn"),
  ("female_name_8", "Heloise"),
  ("female_name_9", "Isolda"),
  ("female_name_10", "Joan"),
  ("female_name_11", "Katherine"),
  ("female_name_12", "Margaret"),
  ("female_name_13", "Matilda"),
  ("female_name_14", "Philippa"),
  ("female_name_15", "Rowena"),
  ("female_name_16", "Sibylla"),
  ("female_name_17", "Ursula"),
  ("female_name_18", "Yolande"),
  ("female_name_19", "Agnes"),
  ("female_name_20", "Cecilia"),
  ("female_name_21", "Emma"),
  ("female_name_22", "Felicia"),
  ("female_name_23", "Lucia"),
  ("female_name_24", "Rosamund"),
  ("female_name_25", "Petronilla"),
  ("female_name_26", "Amelie"),
  ("female_name_27", "Anura"),
  ("female_name_28", "Delia"),
  ("female_name_29", "Hulda"),
  ("female_name_30", "Elaine"),
  ("female_name_31", "Marit"),
  ("female_name_32", "Rosanna"),
  ("female_names_end", "female_names_end"),
...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 and you soon establish yourself as a considerable power in your liege lord's sovereignty.\
...
# Floris companions
  ("npc17_intro", "Dear diary, today I... Ow, hello there. Can I help you?"),
  ("npc18_intro", "Please, {sir/madame}, protect me. They are after me!"),
  ("npc19_intro", "{Hey, pretty boy, have a glass of horse milk on me./What's a fine looking young woman like yourself doing without male admirers around here? Have a glass of horse milk on me.}"),
  ("npc20_intro", "Yes? What do you want?"),
  ("npc21_intro", "Greetings, my friend. Can I interest a fine young {man/lady} like yourself in any of my small wares? Ghazwan's the name, your merchant for these barren streets. I can get you the best prices for anything or guide you anywhere you like. For the right price, of course."),
  ("npc22_intro", "What are you looking at? Leave me to suffer alone!"),
##Extra companions set 1
#  ("npc23_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc24_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc25_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc26_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc27_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc28_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc29_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc30_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc31_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc32_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc33_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc34_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc35_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc36_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc37_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc38_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc39_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc40_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc41_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc42_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc43_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc44_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
##Extra companions set 2
#  ("npc45_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc46_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc47_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc48_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc49_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc50_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc51_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc52_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc53_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc54_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc55_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc56_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc57_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc58_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc59_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc60_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc61_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc62_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc63_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc64_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc65_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc66_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
##Extra companions set 3
#  ("npc67_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc68_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc69_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc70_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc71_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc72_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc73_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc74_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc75_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc76_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc77_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc78_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc79_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc80_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc81_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc82_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc83_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc84_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc85_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc86_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc87_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
#  ("npc88_intro", "I'm an extra companion, and my dialogue hasn't been written yet."),
...
#Native companions
  ...
  ("npc10_intro_response_1", "Why do you say that, soldier?"),
...
# Floris companions
  ("npc17_intro_response_1", "A knight who knows how to write? You must be the first I have met."),
  ("npc18_intro_response_1", "Who is after you?"),
  ("npc19_intro_response_1", "Well, thank you. What's the occasion?"),
  ("npc20_intro_response_1", "You look like a soldier. What are you doing all alone?"),
  ("npc21_intro_response_1", "Perhaps. But aren't you looking a bit posh for a common street merchant?"),
  ("npc22_intro_response_1", "Suffer? What has happened to you?"),
##Extra companions set 1
#  ("npc23_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc24_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc25_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc26_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc27_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc28_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc29_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc30_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc31_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc32_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc33_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc34_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc35_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc36_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc37_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc38_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc39_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc40_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc41_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc42_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc43_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc44_intro_response_1", "I've understood, and won't compain on the forum about it."),
##Extra companions set 2
#  ("npc45_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc46_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc47_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc48_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc49_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc50_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc51_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc52_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc53_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc54_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc55_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc56_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc57_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc58_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc59_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc60_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc61_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc62_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc63_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc64_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc65_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc66_intro_response_1", "I've understood, and won't compain on the forum about it."),
##Extra companions set 3
#  ("npc67_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc68_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc69_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc70_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc71_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc72_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc73_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc74_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc75_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc76_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc77_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc78_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc79_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc80_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc81_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc82_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc83_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc84_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc85_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc86_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc87_intro_response_1", "I've understood, and won't compain on the forum about it."),
#  ("npc88_intro_response_1", "I've understood, and won't compain on the forum about it."),

#Native companions
  ("npc1_intro_response_2", "Step back, cur, and keep your hand away from my purse."),
  ...
  ("npc15_intro_response_2", "I'd be obliged if you minded your own business, knave."),
  ("npc16_intro_response_2", "Mind your own business, lass."),
# Floris companions
  ("npc17_intro_response_2", "Diaries are for sissies. I don't want any help from you."),
  ("npc18_intro_response_2", "I'm not protecting a stranger. Be gone, vile woman!"),
  ("npc19_intro_response_2", "Horse milk? Yuck!"),
  ("npc20_intro_response_2", "Nothing, I'm sorry to bother you."),
  ("npc21_intro_response_2", "No, thanks."),
  ("npc22_intro_response_2", "I'm sorry, I won't bother you again."),
##Extra companions set 1
#  ("npc23_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc24_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc25_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc26_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc27_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc28_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc29_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc30_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc31_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc32_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc33_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc34_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc35_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc36_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc37_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc38_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc39_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc40_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc42_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc43_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc44_intro_response_2", "No dialogues? Sorry, I can't stand that."),
##Extra companions set 2
#  ("npc45_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc46_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc47_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc49_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc50_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc51_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc52_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc53_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc54_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc55_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc56_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc57_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc58_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc59_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc60_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc61_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc62_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc63_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc64_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc65_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc66_intro_response_2", "No dialogues? Sorry, I can't stand that."),
##Extra companions set 3
#  ("npc67_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc68_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc69_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc70_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc71_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc72_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc73_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc75_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc76_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc77_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc78_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc79_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc80_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc81_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc82_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc83_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc84_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc85_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc86_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc87_intro_response_2", "No dialogues? Sorry, I can't stand that."),
#  ("npc88_intro_response_2", "No dialogues? Sorry, I can't stand that."),
...
# Floris companions
  ("npc17_backstory_a", "I haven't met many either in this part of the world. Most Calradian lords only know how to fight and feast. No, back home, in the county of Holland, I learned that a wise ruler occasionally needs to trade, and thus do his own book-keeping. Holland... how I long for my dear land. I haven't been there in twenty-three years. For all I know my children and everyone I love must think I'm dead. All thanks to that stupid tournament in Corbie, in the Kingdom of France."),
  ("npc18_backstory_a", "My father, my brother, the village elder... Everyone! They are searching for me since I ran away. It was awful, {sir/madame}. The Elder... He is mad, I say to you. For the past three years he has taken a new woman every night, only to hang her in the morning. Both my elder sisters have died by his hands already, and every woman in the land is terrified."),
  ("npc19_backstory_a", "My victory, of course. I haven't been able to properly celebrate it since my jealous competitors drove me away. How could I help it I just was the best archer at the yearly competition?"),
  ("npc20_backstory_a", "I could ask you the same. But since you were first... I'm Sajjad, a soldier of the order of the Crescent Moon, send out in to the world to prove my worth and wipe out the shame of my early life. Once I was a bandit... until I saw the light and followed its path to salvation."),
  ("npc21_backstory_a", "You're the first one in a long time to notice -- to really see -- my appearance. Everyone just shoves me away, or buys a small tinklet and forgets me in an instant. But not you, I reckon, You must have the eyes of a hawk to spot my grace beneath the layer of dirt that life on the street has brought me."),
  ("npc22_backstory_a", "It's those blasted knights... They ruined my everything! The aristocracy ain't nothing but common thieves and bandits, that's what they are. How foolish I was putting my trust in them with the hope that they would protect me and my family from any foe. No, I learned the hard way, they are the ones to be feared."),
##Extra companions set 1
#  ("npc23_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc24_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc25_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc26_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc27_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc28_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc29_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc30_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc31_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc32_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc33_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc34_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc35_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc36_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc37_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc38_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc39_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc40_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc41_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc42_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc43_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc44_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
##Extra companions set 2
#  ("npc45_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc46_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc47_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc48_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc49_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc50_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc51_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc52_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc53_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc54_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc55_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc56_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc57_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc58_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc59_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc60_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc61_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc62_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc63_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc64_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc65_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc66_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
##Extra companions set 3
#  ("npc67_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc68_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc69_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc70_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc71_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc72_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc73_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc74_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc75_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc76_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc77_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc78_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc79_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc80_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc81_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc82_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc83_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc84_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc85_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc86_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc87_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
#  ("npc88_backstory_a", "Good, because if you do complain about it, sanctions will follow. All new topics complaining about this will be locked."),
...
# Floris companions
  ("npc17_backstory_b", "A large tournament was held there. I did pretty well, which made quite an impression on Mathildis II of Boulogne. She even wrote me a love letter! That was quite a stupid thing for her to do, since both she and I were married. I even dined with her husband, Philippe Hurepel de Clermont, when I received that letter. Both he and I were honour bound to duel over this, which we of course did. Unfortunately it all ended up pretty badly. We both got hit: Philippe died on the spot, and I dragged myself out of there. Even though I had won the duel, I couldn't face the rest of the participants of the tournament. So I fled. Unfortunately, when I passed through Zeeland, almost home, a storm set up and drove me away."),
  ("npc18_backstory_b", "One evening my father uttered the words I had feared for months: 'Tonight, my dear Nadia, it will be your turn.' How could he say that? How could he lead me to certain death? I screamed and kicked, so that both my father and brother had to drag me out of the house. I was wild and in the struggle I hit knocked over an oil lamp. The leaking oil lit a fire in an instant."),
  ("npc19_backstory_b", "Every year the largest archery games of Calradia are held in my home village of Tulbuk. People from all over the Khergit lands and even beyond travel there, some for months, to compete for the highest honour -- being the Tulbuk Champion -- and the accompaning sum of money. Men and women, children and adults, friend or foe: everyone is equal when holding a bow that day."),
  ("npc20_backstory_b", "Once my faith became strong, I sought out the order that called out to me. They were glad that a warrior like me wanted to amend his ways, but they were also wary.  In times past, many banits have pretended to be pious, only to loot and plunder the monastery after darkness had fallen. But not me. No, I'm here to show everyone that my faith is real."),
  ("npc21_backstory_b", "I used to live in a palace the size you've never seen before, nor ever will. My father ruled all the oases south of the Sarranid lands, where peace and prosperity were in strong contrast to all the constant warfare that dominates Calradia. Unfortunately to all good things comes an end: the oasis dried up, and all the water disappeared in the hot sand, taking all sense and sensibility with it."),
  ("npc22_backstory_b", "I was a mere miller, grinding the wheat the farmers brought in. What was I supposed to do when suddenly a lone knight with his esquire came charging towards my mill, his lance at the ready and his screams that of a wild madman? I turned the sails and hit him on the head as the wind moved them slowly. He fell dead in an instant and his esquire ran off."),
##Extra companions set 1
#  ("npc23_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc24_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc25_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc26_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc27_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc28_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc29_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc30_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc31_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc32_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc33_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc34_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc35_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc36_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc37_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc38_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc39_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc40_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc41_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc42_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc43_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc44_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
##Extra companions set 2
#  ("npc45_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc46_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc47_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc48_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc49_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc50_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc51_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc52_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc53_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc54_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc55_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc56_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc57_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc58_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc59_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc60_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc61_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc62_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc63_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc64_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc65_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc66_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
##Extra companions set 3
#  ("npc67_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc68_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc69_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc70_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc71_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc72_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc73_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc74_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc75_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc76_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc77_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc78_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc79_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc80_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc81_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc82_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc83_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc84_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc85_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc86_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc87_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
#  ("npc88_backstory_b", "If you do want to see some nice dialogues, you'd have to write them yourself, since the team hasn't got the time for it."),
...
# Floris companions
  ("npc17_backstory_c", "For more than twenty years I sailed across the seven seas in search for my home, but never I found it again. And now I'm here, in Calradia. No-one knows me, Count Floris IV of Holland, and I know no-one. I don't know if I ever can go back, so it is easier to forget my past and move on to what lies ahead of me. A whole new world filled with opportunities. Unfortunately twenty-three years of travelling have ruined my finances. If I want to rebuild what I once had, I need a sound investment. But I'm afraid I don't have that, and 'trading' my way to the top will take forever, nor is the most noble pursuit for man of my station. But these times are hard, so I'll have to take any opportunity that arises."),
  ("npc18_backstory_c", "I used the panic of the moment to free myself and fled into the darkness of the night. My feet didn't stop until I reached this tavern. So please, dear {sir/madame}, protect me from everyone who wants to kill me just because I'm a woman!"),
  ("npc19_backstory_c", "This year it was my turn for glory. I hit all targets, beating everyone, only to be accused of cheating! How could they. Even though there was no evidence -- I'm sure of it -- the elders took a stance against me. In the middle of the night I ran away as fast as I could: no need to await their judgement, for it was pretty clear what that would be. Here I am now, celebrating my victory with you."),
  ("npc20_backstory_c", "I confess that I haven't always been the easiest person also in my time at the monastery. That's why the headmaster himself called me one day and send me out into the world, only to return when I truly have amended my old ways. So here I am, looking for guidance in this cruel world."),
  ("npc21_backstory_c", "Everywhere fights broke out and the country collapsed. As my father drank the last drop available, the people turned against him. Soon the palace was turned to dust, and the sultanate was a distant memory. A loyal servant managed to smuggle me out in the chaos, only to die shortly after bringing me to this place. Ever since I grew up on the street, selling whatever I can get my hands on."),
  ("npc22_backstory_c", "It wasn't much later that the esquire returned with a lot of other knights. If they had just punished me, I would have understood or else my name wouldn't be Edwyn the Listener. But no, they raped and killed my wife and daughter then burned the mill with their bodies inside, so I couldn't give them a proper burial. I've drifted since, only to wind up here, drinking away my sadness and feeding my anger."),
##Extra companions set 1
#  ("npc23_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc24_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc25_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc26_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc27_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc28_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc29_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc30_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc31_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc32_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc33_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc34_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc35_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc36_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc37_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc38_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc39_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc40_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc41_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc42_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc43_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc44_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
##Extra companions set 2
#  ("npc45_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc46_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc47_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc48_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc49_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc50_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc51_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc52_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc53_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc54_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc55_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc56_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc57_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc58_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc59_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc60_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc61_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc62_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc63_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc64_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc65_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc66_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
##Extra companions set 3
#  ("npc67_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc68_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc69_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc70_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc71_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc72_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc73_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc74_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc75_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc76_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc77_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc78_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc79_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc80_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc81_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc82_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc83_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc84_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc85_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc86_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc87_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
#  ("npc88_backstory_c", "By the way... what madman did add me to the game? I should be hidden and you shouldn't be able to talk to me!"),
...
# Floris companions
  ("npc17_backstory_later", "I've been travelling around these days, trading and fighting off the occasional bandit. But I'm still a poor outsider compared to the regular lords fighting in their senseless wars. If someone could only help me with a small investment, I could finally begin to form my own warband."),
  ("npc18_backstory_later", "The village elder took a new woman each night, who was hanged in the morning. When it was my turn, I fought, and set my father's house accidentally on fire. In the following panic I ran, only to wind up here. I'm looking for someone to protect me from these evil men."),
  ("npc19_backstory_later", "I won fair and square -- honestly! -- the yearly archery games of Tulbuk, but my jealous competitors accused me of cheating. I didn't await judgement from the elders and have been on the run since."),
  ("npc20_backstory_later", "I used to be a bandit until I found my faith. Now I've been sent out into the world to amend my old ways and cleanse my soul."),
  ("npc21_backstory_later", "I used to be a young prince from an oasis south of the Sarranid Sultanate, but when it dried up, the people rebelled against my father. A loyal servant smuggled me out of that chaos and brought me to Calradia, where I grew up to be a street merchant."),
  ("npc22_backstory_later", "A lone, mad knight attacked my mill and got himself killed by the sails. As a punishment other knights raped and killed my wife and daughter before burning their bodies along with the mill."),
##Extra companions set 1
#  ("npc23_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc24_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc25_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc26_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc27_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc28_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc29_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc30_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc31_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc32_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc33_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc34_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc35_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc36_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc37_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc38_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc39_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc40_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc41_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc42_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc43_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc44_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
##Extra companions set 2
#  ("npc45_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc46_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc47_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc48_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc49_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc50_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc51_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc52_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc53_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc54_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc55_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc56_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc57_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc58_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc59_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc60_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc61_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc62_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc63_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc64_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc65_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc66_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
##Extra companions set 3
#  ("npc67_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc68_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc69_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc70_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc71_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc72_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc73_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc74_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc75_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc76_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc77_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc78_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc79_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc80_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc81_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc82_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc83_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc84_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc85_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc86_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc87_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
#  ("npc88_backstory_later", "Still no dialogues written for me. Who added me, by the way?"),
...
#Native companions
  ...
  ("npc4_backstory_response_1", "I run such a company, my lord, and might be able to hire an extra hand."),
...
# Floris companions
  ("npc17_backstory_response_1", "Maybe I can help, my lord. I travel a lot these days, and could surely use someone to protect me along these bandit-ridden lands."),
  ("npc18_backstory_response_1", "That's terrible! If there is anything I could do to help..."),
  ("npc19_backstory_response_1", "How could they! You know, there is always a place at my side for a good archer."),
  ("npc20_backstory_response_1", "I could always use a good soldier looking for redemption."),
  ("npc21_backstory_response_1", "Despite your bad luck as a child, I see you've grown to be a fine merchant."),
  ("npc22_backstory_response_1", "Don't drink too much, my friend, for else you can't take revenge."),
##Extra companions set 1
#  ("npc23_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc24_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc25_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc26_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc27_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc28_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc29_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc30_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc31_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc32_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc33_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc34_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc35_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc36_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc37_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc38_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc39_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc40_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc41_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc42_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc43_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc44_backstory_response_1", "It was me, {playername}. Please stick with me!"),
##Extra companions set 2
#  ("npc45_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc46_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc47_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc48_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc49_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc50_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc51_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc52_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc53_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc54_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc55_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc56_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc57_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc58_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc59_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc60_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc61_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc62_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc63_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc64_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc65_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc66_backstory_response_1", "It was me, {playername}. Please stick with me!"),
##Extra companions set 3
#  ("npc67_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc68_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc69_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc70_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc71_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc72_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc73_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc74_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc75_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc76_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc77_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc78_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc79_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc80_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc81_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc82_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc83_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc84_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc85_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc86_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc87_backstory_response_1", "It was me, {playername}. Please stick with me!"),
#  ("npc88_backstory_response_1", "It was me, {playername}. Please stick with me!"),
...
#Native companions
  ...
  ("npc4_backstory_response_2", "No, sorry, I haven't heard of one, sir."),
...
# Floris companions
  ("npc17_backstory_response_2", "I'm sorry, but I don't know anyone with a pouch large enough to fill your ambitions, my lord."),
  ("npc18_backstory_response_2", "Wait, you ran away after setting fire to your father's house? Be gone, before you burn down this tavern."),
  ("npc19_backstory_response_2", "You should have awaited fair judgement. I won't drink with a coward."),
  ("npc20_backstory_response_2", "If even your headmaster thinks you're trouble, I definately won't let you anywhere near me."),
  ("npc21_backstory_response_2", "I bet you tell everyone such a story to receive a better deal. You don't fool me!"),
  ("npc22_backstory_response_2", "You deserve your suffering: killing a knight is a bad sign."),
##Extra companions set 1
#  ("npc23_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc24_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc25_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc26_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc27_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc28_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc29_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc30_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc31_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc32_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc33_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc34_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc35_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc36_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc37_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc38_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc39_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc40_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc41_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc42_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc43_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc44_backstory_response_2", "I have no clue. Bye bye."),
##Extra companions set 2
#  ("npc45_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc46_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc47_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc48_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc49_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc50_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc51_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc52_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc53_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc54_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc55_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc56_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc57_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc58_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc59_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc60_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc61_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc62_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc63_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc64_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc65_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc66_backstory_response_2", "I have no clue. Bye bye."),
##Extra companions set 3
#  ("npc67_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc68_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc69_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc70_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc71_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc72_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc73_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc74_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc75_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc76_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc77_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc78_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc79_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc80_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc81_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc82_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc83_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc84_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc85_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc86_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc87_backstory_response_2", "I have no clue. Bye bye."),
#  ("npc88_backstory_response_2", "I have no clue. Bye bye."),
...
# Floris companions
  ("npc17_signup", "That would be wonderful. That way you can show me around and teach me the fine habits of this strange society, while my sword-arm gets some necessary practice."),
  ("npc18_signup", "Really? Do you really want to help me? Thank the Heavens that I met you, and blessed be your soul for your kindness."),
  ("npc19_signup", "That sounds too good to be true. I'm glad I offered you a drink, pretty {boy/face}."),
  ("npc20_signup", "The heavens have guided you to me, {Sir/My lady}. It would help me greatly if you'd help keep me on the right track.  To prevent me from falling for the many distractions this world has to offer."),
  ("npc21_signup", "Absolutely! Not many nobles can claim to be a man of the people as I can. I've seen the world through the eyes of the poor, but with my blue blooded senses to guide me. My expertice is unique, as are the wares I have to offer."),
  ("npc22_signup", "Revenge... How sweet is the sound of it. But they are knights, nobles, aristocrats, and I'm a mere miller, of low birth. It's bad enough that I killed one of them, let alone a whole group. They ran off, you know, so I'd have to track them down."),
##Extra companions set 1
#  ("npc23_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc24_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc25_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc26_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc27_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc28_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc29_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc30_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc31_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc32_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc33_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc34_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc35_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc36_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc37_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc38_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc39_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc40_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc41_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc42_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc43_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc44_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
##Extra companions set 2
#  ("npc45_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc46_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc47_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc48_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc49_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc50_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc51_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc52_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc53_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc54_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc55_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc56_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc57_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc58_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc59_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc60_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc61_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc62_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc63_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc64_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc65_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc66_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
##Extra companions set 3
#  ("npc67_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc68_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc69_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc70_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc71_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc72_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc73_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc74_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc75_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc76_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc77_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc78_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc79_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc80_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc81_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc82_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc83_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc84_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc85_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc86_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc87_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
#  ("npc88_signup", "You? Ha, I can't believe that, not even you would be so stupid."),
...
# Floris companions
  ("npc17_signup_2", "It's been too long since I've seen a major battle. The last one was early in 1234, right before I went to that dreadfull tournament in Corbie: along with count Otto of Gelre, count Diederik of Cleves and an army of 40,000 men I fought against those Frisian Stedingers. I know how to handle armies, and maybe your men can even learn something from me."),
  ("npc18_signup_2", "If I can stay with you, no-one would dare harm me. I'll do my best to be of help around you."),
  ("npc19_signup_2", "At your side I'll be able to prove to these lands my skills with the bow, and when they'll hear about my travels back home, they can shall beg for my return."),
  ("npc20_signup_2", "Being alone in this hostile world is not the best way for a former scoundrel seeking the right path. The Heavens must have let us cross paths so you could show me the way."),
  ("npc21_signup_2", "You know what, my friend? If you'll allow me, I shall show you the land in a way you've never seen before. We'll travel from village to town, crossing the lands with wares you've never laid your eyes upon before."),
  ("npc22_signup_2", "But if I join you, you could teach me how to fight, and together we could teach those... murderers that no punishment is severe enough for their crime."),
##Extra companions set 1
#  ("npc23_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc24_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc25_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc26_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc27_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc28_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc29_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc30_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc31_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc32_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc33_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc34_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc35_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc36_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc37_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc38_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc39_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc40_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc41_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc42_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc43_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc44_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
##Extra companions set 2
#  ("npc45_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc46_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc47_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc48_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc49_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc50_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc51_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc52_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc53_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc54_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc55_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc56_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc57_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc58_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc59_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc60_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc61_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc62_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc63_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc64_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc65_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc66_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
##Extra companions set 3
#  ("npc67_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc68_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc69_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc70_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc71_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc72_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc73_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc74_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc75_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc76_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc77_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc78_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc79_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc80_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc81_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc82_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc83_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc84_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc85_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc86_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc87_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
#  ("npc88_signup_2", "But in case you're right, I'd better stick with you, in case you do write something for me to say."),
...
#Native companions
  ...
  ("npc4_signup_response_1", "Very well. I'll be glad to have you with us, um, 'Lord Baron.'"),
...
# Floris companions
  ("npc17_signup_response_1", "Tournaments, armies: you are a very resourceful man. I'd be pleased to have you alongside me, my lord."),
  ("npc18_signup_response_1", "Pack your stuff, girl, it is time you left these lands."),
  ("npc19_signup_response_1", "Of course, and maybe earn a little while we're at it."),
  ("npc20_signup_response_1", "The Heavens... Definately, yes, they guided me to you. Sure."),
  ("npc21_signup_response_1", "That sounds like a wonderfull experience."),
  ("npc22_signup_response_1", "That's the spirit."),
##Extra companions set 1
#  ("npc23_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc24_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc25_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc26_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc27_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc28_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc29_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc30_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc31_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc32_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc33_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc34_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc35_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc36_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc37_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc38_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc39_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc40_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc41_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc42_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc43_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc44_signup_response_1", "Perhaps. Welcome on board!"),
##Extra companions set 2
#  ("npc45_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc46_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc47_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc48_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc49_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc50_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc51_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc52_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc53_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc54_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc55_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc56_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc57_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc58_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc59_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc60_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc61_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc62_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc63_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc64_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc65_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc66_signup_response_1", "Perhaps. Welcome on board!"),
##Extra companions set 3
#  ("npc67_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc68_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc69_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc70_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc71_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc72_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc73_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc74_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc75_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc76_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc77_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc78_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc79_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc80_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc81_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc82_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc83_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc84_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc85_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc86_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc87_signup_response_1", "Perhaps. Welcome on board!"),
#  ("npc88_signup_response_1", "Perhaps. Welcome on board!"),

#11
#Native companions
  ("npc1_signup_response_2", "I'd prefer not to take the risk. Good day, peasant."),
  ...
  ("npc4_signup_response_2", "Actually, we are not in the habit of hiring bandits with invented pedigrees. Good day, 'my lord.'"),
...
# Floris companions
  ("npc17_signup_response_2", "What are you rabbling about? I never heard of these places! I need a decent fighter, not a storyteller. Good day to you."),
  ("npc18_signup_response_2", "I'm sorry, I meant to help you here, not to drag you around the world. I can't do that."),
  ("npc19_signup_response_2", "I need a soldier to fight a war, not a travelling archer actor!"),
  ("npc20_signup_response_2", "I'm looking for a common soldier, not a religious fanatic!"),
  ("npc21_signup_response_2", "I intend to rise in ranks, not to lower myself to the poor. Our ways will part here."),
  ("npc22_signup_response_2", "No, you need to face them yourself if you wish to redeem your family."),
##Extra companions set 1
#  ("npc23_signup_response_2", "Me, writing? No way!"),
#  ("npc24_signup_response_2", "Me, writing? No way!"),
#  ("npc25_signup_response_2", "Me, writing? No way!"),
#  ("npc26_signup_response_2", "Me, writing? No way!"),
#  ("npc27_signup_response_2", "Me, writing? No way!"),
#  ("npc28_signup_response_2", "Me, writing? No way!"),
#  ("npc29_signup_response_2", "Me, writing? No way!"),
#  ("npc30_signup_response_2", "Me, writing? No way!"),
#  ("npc31_signup_response_2", "Me, writing? No way!"),
#  ("npc32_signup_response_2", "Me, writing? No way!"),
#  ("npc33_signup_response_2", "Me, writing? No way!"),
#  ("npc34_signup_response_2", "Me, writing? No way!"),
#  ("npc35_signup_response_2", "Me, writing? No way!"),
#  ("npc36_signup_response_2", "Me, writing? No way!"),
#  ("npc37_signup_response_2", "Me, writing? No way!"),
#  ("npc38_signup_response_2", "Me, writing? No way!"),
#  ("npc39_signup_response_2", "Me, writing? No way!"),
#  ("npc40_signup_response_2", "Me, writing? No way!"),
#  ("npc41_signup_response_2", "Me, writing? No way!"),
#  ("npc42_signup_response_2", "Me, writing? No way!"),
#  ("npc43_signup_response_2", "Me, writing? No way!"),
#  ("npc44_signup_response_2", "Me, writing? No way!"),
##Extra companions set 2
#  ("npc45_signup_response_2", "Me, writing? No way!"),
#  ("npc46_signup_response_2", "Me, writing? No way!"),
#  ("npc47_signup_response_2", "Me, writing? No way!"),
#  ("npc48_signup_response_2", "Me, writing? No way!"),
#  ("npc49_signup_response_2", "Me, writing? No way!"),
#  ("npc50_signup_response_2", "Me, writing? No way!"),
#  ("npc51_signup_response_2", "Me, writing? No way!"),
#  ("npc52_signup_response_2", "Me, writing? No way!"),
#  ("npc53_signup_response_2", "Me, writing? No way!"),
#  ("npc54_signup_response_2", "Me, writing? No way!"),
#  ("npc55_signup_response_2", "Me, writing? No way!"),
#  ("npc56_signup_response_2", "Me, writing? No way!"),
#  ("npc57_signup_response_2", "Me, writing? No way!"),
#  ("npc58_signup_response_2", "Me, writing? No way!"),
#  ("npc59_signup_response_2", "Me, writing? No way!"),
#  ("npc60_signup_response_2", "Me, writing? No way!"),
#  ("npc61_signup_response_2", "Me, writing? No way!"),
#  ("npc62_signup_response_2", "Me, writing? No way!"),
#  ("npc63_signup_response_2", "Me, writing? No way!"),
#  ("npc64_signup_response_2", "Me, writing? No way!"),
#  ("npc65_signup_response_2", "Me, writing? No way!"),
#  ("npc66_signup_response_2", "Me, writing? No way!"),
##Extra companions set 3
#  ("npc67_signup_response_2", "Me, writing? No way!"),
#  ("npc68_signup_response_2", "Me, writing? No way!"),
#  ("npc69_signup_response_2", "Me, writing? No way!"),
#  ("npc70_signup_response_2", "Me, writing? No way!"),
#  ("npc71_signup_response_2", "Me, writing? No way!"),
#  ("npc72_signup_response_2", "Me, writing? No way!"),
#  ("npc73_signup_response_2", "Me, writing? No way!"),
#  ("npc74_signup_response_2", "Me, writing? No way!"),
#  ("npc75_signup_response_2", "Me, writing? No way!"),
#  ("npc76_signup_response_2", "Me, writing? No way!"),
#  ("npc77_signup_response_2", "Me, writing? No way!"),
#  ("npc78_signup_response_2", "Me, writing? No way!"),
#  ("npc79_signup_response_2", "Me, writing? No way!"),
#  ("npc80_signup_response_2", "Me, writing? No way!"),
#  ("npc81_signup_response_2", "Me, writing? No way!"),
#  ("npc82_signup_response_2", "Me, writing? No way!"),
#  ("npc83_signup_response_2", "Me, writing? No way!"),
#  ("npc84_signup_response_2", "Me, writing? No way!"),
#  ("npc85_signup_response_2", "Me, writing? No way!"),
#  ("npc86_signup_response_2", "Me, writing? No way!"),
#  ("npc87_signup_response_2", "Me, writing? No way!"),
#  ("npc88_signup_response_2", "Me, writing? No way!"),

#Native companions
  ("npc1_payment", "I will be very useful to you, {sir/madame}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} denars? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks and the tavern owners no longer believe that I am loaded with gold as I used to tell them. You know, things could get ugly here if they see me leaving with you before paying them."), #300
  ("npc2_payment", "{!}."), #0
  ("npc3_payment", "{!}."), #0
  ("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} denars? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."), #300
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} denars from you. It's an advice my father gave me. He told me 'Baheshtur, never fight for a barbarian before {he/she} pays you your worth of gold first'."), #400
  ("npc6_payment", "{!}."), #0
  ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} denars first. You aren't expecting me to work for free, do you?"), #300
...
# Floris companions
  ("npc17_payment", "By the sound of it I'd be glad to ride along you too. Now there is only the investment I need to build up my own empire. For a mere {reg3} denars I'll have a nice financial backing, and am I yours to command."), #20.000
  ("npc18_payment", "{!}."), #0
  ("npc19_payment", "Talking about money... Could you spare me {reg3} denars to cover... erm... to pay for a few errands I currently have in town?"), #200
  ("npc20_payment", "But before I could join you, you must show me your true and kind spirit. How about a small donation to the order, which would help them spread the faith more quickly? {reg3} denars would seem fine -- enough to convert a small village."), #300
  ("npc21_payment", "My friend, you are great! Praise the Heavens. Now, if you could buy this small trinket from me for the mere sum of 5000 denars, you'll seal our agreement and show me your trust."), #400
  ("npc22_payment", "There is only one problem... I don't have anything to train with. If you could spare me {reg3} denars, I could buy myself a sword and start practicing."), #300
##Extra companions set 1
#  ("npc23_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc24_payment", "{!}."), #0
#  ("npc25_payment", "{!}."), #0
#  ("npc26_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc27_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc28_payment", "{!}."), #0
#  ("npc29_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc30_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #500
#  ("npc31_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc32_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc33_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #100
#  ("npc34_payment", "{!}."), #0
#  ("npc35_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc36_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc37_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc38_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc39_payment", "{!}."), #0
#  ("npc40_payment", "{!}."), #0
#  ("npc41_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc42_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc43_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc44_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
##Extra companions set 2
#  ("npc45_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc46_payment", "{!}."), #0
#  ("npc47_payment", "{!}."), #0
#  ("npc48_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc49_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc50_payment", "{!}."), #0
#  ("npc51_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc52_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #500
#  ("npc53_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc54_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc55_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #100
#  ("npc56_payment", "{!}."), #0
#  ("npc57_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc58_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc59_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc60_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc61_payment", "{!}."), #0
#  ("npc62_payment", "{!}."), #0
#  ("npc63_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc64_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc65_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc66_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
##Extra companions set 3
#  ("npc67_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc68_payment", "{!}."), #0
#  ("npc69_payment", "{!}."), #0
#  ("npc70_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc71_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc72_payment", "{!}."), #0
#  ("npc73_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc74_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #500
#  ("npc75_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc76_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc77_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #100
#  ("npc78_payment", "{!}."), #0
#  ("npc79_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc80_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc81_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc82_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc83_payment", "{!}."), #0
#  ("npc84_payment", "{!}."), #0
#  ("npc85_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #200
#  ("npc86_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
#  ("npc87_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #400
#  ("npc88_payment", "Before we depart, I'd like to see {reg3} denars from you: else I'll tell the dev team what you did."), #300
...
# Floris companions
  ("npc17_payment_response", "{reg3} denars? You dare! Make yourself ready and maybe there's a nice bonus at the end of the week."),
  ("npc18_payment_response", "{!}."),
  ("npc19_payment_response", "All right, here's {reg3} denars. I'm glad to have you at my side."),
  ("npc20_payment_response", "That seems more than fair. Here are {reg3} denars."),
  ("npc21_payment_response", "I'll give you {reg3} denars, and that's my final offer."),
  ("npc22_payment_response", "Of course. Here are {reg3} denars. Hurry, for I'll be leaving soon."),
##Extra companions set 1
#  ("npc23_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc24_payment_response", "{!}."), #0
#  ("npc25_payment_response", "{!}."), #0
#  ("npc26_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc27_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc28_payment_response", "{!}."), #0
#  ("npc29_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc30_payment_response", "Here's {reg3} denars, please be silent."), #500
#  ("npc31_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc32_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc33_payment_response", "Here's {reg3} denars, please be silent."), #100
#  ("npc34_payment_response", "{!}."), #0
#  ("npc35_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc36_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc37_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc38_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc39_payment_response", "{!}."), #0
#  ("npc40_payment_response", "{!}."), #0
#  ("npc41_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc42_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc43_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc44_payment_response", "Here's {reg3} denars, please be silent."), #300
##Extra companions set 2
#  ("npc45_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc46_payment_response", "{!}."), #0
#  ("npc47_payment_response", "{!}."), #0
#  ("npc48_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc49_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc50_payment_response", "{!}."), #0
#  ("npc51_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc52_payment_response", "Here's {reg3} denars, please be silent."), #500
#  ("npc53_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc54_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc55_payment_response", "Here's {reg3} denars, please be silent."), #100
#  ("npc56_payment_response", "{!}."), #0
#  ("npc57_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc58_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc59_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc60_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc61_payment_response", "{!}."), #0
#  ("npc62_payment_response", "{!}."), #0
#  ("npc63_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc64_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc65_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc66_payment_response", "Here's {reg3} denars, please be silent."), #300
##Extra companions set 3
#  ("npc67_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc68_payment_response", "{!}."), #0
#  ("npc69_payment_response", "{!}."), #0
#  ("npc70_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc71_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc72_payment_response", "{!}."), #0
#  ("npc73_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc74_payment_response", "Here's {reg3} denars, please be silent."), #500
#  ("npc75_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc76_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc77_payment_response", "Here's {reg3} denars, please be silent."), #100
#  ("npc78_payment_response", "{!}."), #0
#  ("npc79_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc80_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc81_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc82_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc83_payment_response", "{!}."), #0
#  ("npc84_payment_response", "{!}."), #0
#  ("npc85_payment_response", "Here's {reg3} denars, please be silent."), #200
#  ("npc86_payment_response", "Here's {reg3} denars, please be silent."), #300
#  ("npc87_payment_response", "Here's {reg3} denars, please be silent."), #400
#  ("npc88_payment_response", "Here's {reg3} denars, please be silent."), #300
...
# Floris companions
  ...
  ("npc18_morality_speech", "Why did you {s21}, my dear {sir/madame}? When I thought you'd protect me, I didn't expect you to act as my village elder would!"),
  ("npc19_morality_speech", "Excuse me, pretty {boy/face}, but what do you think you are doing? Even I wouldn't dare to go as far as {s21}."),
  ("npc20_morality_speech", "Why, {sire/my lady}, why did you {s21}? Is it because they were heathens?  In which case conversion would be better or are you evil in disguise?"),
...
##Extra companions set 1
#  ("npc23_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc24_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc25_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc26_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc27_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc28_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc29_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc30_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc31_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc32_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc33_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc34_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc35_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc36_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc37_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc38_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc39_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc40_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc41_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc42_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc43_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc44_morality_speech", "I don't like {s21}. Now I hate you."),
##Extra companions set 2
#  ("npc45_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc46_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc47_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc48_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc49_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc50_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc51_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc52_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc53_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc54_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc55_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc56_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc57_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc58_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc59_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc60_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc61_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc62_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc63_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc64_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc65_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc66_morality_speech", "I don't like {s21}. Now I hate you."),
##Extra companions set 3
#  ("npc67_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc68_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc69_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc70_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc71_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc72_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc73_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc74_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc75_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc76_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc77_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc78_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc79_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc80_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc81_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc82_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc83_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc84_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc85_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc86_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc87_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc88_morality_speech", "I don't like {s21}. Now I hate you."),
...
# Floris companions
  ...
  ("npc18_2ary_morality_speech", "How could you, my dear {sir/madame}? By {s21} you're acting like my traiterous father. How can I ever trust you not to return me to him?"),
  ("npc19_2ary_morality_speech", "{!}[No secondary moral code]"),
  ("npc20_2ary_morality_speech", "Maybe {s21} is your way to show your faith in the Heavens, but it is definately not mine. Please be carefull, {sir/my lady}, for this behaviour only leads to evil."),
...
##Extra companions set 1
#  ("npc23_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc24_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc25_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc26_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc27_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc28_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc29_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc30_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc31_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc32_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc33_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc34_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc35_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc36_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc37_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc38_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc39_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc40_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc41_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc42_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc43_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc44_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
##Extra companions set 2
#  ("npc45_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc46_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc47_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc48_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc49_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc50_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc51_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc52_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc53_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc54_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc55_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc56_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc57_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc58_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc59_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc60_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc61_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc62_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc63_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc64_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc65_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc66_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
##Extra companions set 3
#  ("npc67_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc68_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc69_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc70_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc71_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc72_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc73_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc74_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc75_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc76_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc77_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc78_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc79_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc80_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc81_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc82_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc83_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc84_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc85_2ary_morality_speech", "{!}[No secondary moral code]"),
#  ("npc86_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc87_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
#  ("npc88_2ary_morality_speech", "I don't like {s21}. Now I hate you."),
...
#Native companions
  ...
  ("npc3_personalityclash_speech", "Captain -- in my opinion, {s11} is a lying and traiterous cheater. She talks of nothing but ways to rig games and tournaments."),
  ...
  ("npc9_personalityclash_speech", "{Sir/My Lady}, I hope you do not mind me telling you this, but in my opinion {s11} is a vile liar. He calls himself 'count', but of what place? Have you ever heard of 'Holland' or 'Corbie'? I think he's just a peasant with a good story."),
  ...
  ("npc13_personalityclash_speech", "Captain, I'm getting weary of {s11}, who talks of nothing but her father and village elder."),
  ...
  ("npc15_personalityclash_speech", "Captain -- Have you recently spoken with {s11}? I did, and thus must warn you for his lying tongue. He claims to be a prince of a fallen oasis, but didn't the old poet say: 'Thy are blind in the darkness of the night and the collapse. Stop doing your job, for Fortune favours the lazy.'"),
  ("npc16_personalityclash_speech", "Oy, captain. Just so you know -- I don't think {s11} is a true believer. His prayers are all wrong, and he even faces the wrong way when kneeling!"),
# Floris companions
  ("npc17_personalityclash_speech", "{playername}, have you seen {s11}? That whore just stole one of my pouches with trade money. I was talking to your men, trying to train them into real warriors, when one of them pointed out that he saw her digging in one of my fourty-two money pouches. I immediately ran towards her, but she slipped away."),
  ("npc18_personalityclash_speech", "My dear {sir/madame}, are you the only one in this group I can really trust? I thought {s11} could be a friend, but all he does is laugh at my past."),
  ("npc19_personalityclash_speech", "Ha pretty {boy/face}, I've seen you looking at {s11}. But don't trust that beautiful face of hers too much, for a serpent's tongue is hidden deep inside it."),
  ("npc20_personalityclash_speech", "{Sir/My lady}, could I have a word with you about {s11}? I believe that she has been misguided, and led astray to wrong beliefs."),
  ("npc21_personalityclash_speech", "My friend, have I ever let you down? I'm just asking, for that traiterous {s11} seems to think I will betray you on a whim. How insulting! Has he never heard of the merchant's word?"),
  ("npc22_personalityclash_speech", "Captain, did you hear what {s11} just said? About the soldiers needing to fear the commander? It is the aristocracy all over again, but this time without the blue blood and heraldry, or even the chivaldry, one of the few good things about knights, I have to admit."),
##Extra companions set 1
#  ("npc23_personalityclash_speech", "I don't like {s11}."),
#  ("npc24_personalityclash_speech", "I don't like {s11}."),
#  ("npc25_personalityclash_speech", "I don't like {s11}."),
#  ("npc26_personalityclash_speech", "I don't like {s11}."),
#  ("npc27_personalityclash_speech", "I don't like {s11}."),
#  ("npc28_personalityclash_speech", "I don't like {s11}."),
#  ("npc29_personalityclash_speech", "I don't like {s11}."),
#  ("npc30_personalityclash_speech", "I don't like {s11}."),
#  ("npc31_personalityclash_speech", "I don't like {s11}."),
#  ("npc32_personalityclash_speech", "I don't like {s11}."),
#  ("npc33_personalityclash_speech", "I don't like {s11}."),
#  ("npc34_personalityclash_speech", "I don't like {s11}."),
#  ("npc35_personalityclash_speech", "I don't like {s11}."),
#  ("npc36_personalityclash_speech", "I don't like {s11}."),
#  ("npc37_personalityclash_speech", "I don't like {s11}."),
#  ("npc38_personalityclash_speech", "I don't like {s11}."),
#  ("npc39_personalityclash_speech", "I don't like {s11}."),
#  ("npc40_personalityclash_speech", "I don't like {s11}."),
#  ("npc41_personalityclash_speech", "I don't like {s11}."),
#  ("npc42_personalityclash_speech", "I don't like {s11}."),
#  ("npc43_personalityclash_speech", "I don't like {s11}."),
#  ("npc44_personalityclash_speech", "I don't like {s11}."),
##Extra companions set 2
#  ("npc45_personalityclash_speech", "I don't like {s11}."),
#  ("npc46_personalityclash_speech", "I don't like {s11}."),
#  ("npc47_personalityclash_speech", "I don't like {s11}."),
#  ("npc48_personalityclash_speech", "I don't like {s11}."),
#  ("npc49_personalityclash_speech", "I don't like {s11}."),
#  ("npc50_personalityclash_speech", "I don't like {s11}."),
#  ("npc51_personalityclash_speech", "I don't like {s11}."),
#  ("npc52_personalityclash_speech", "I don't like {s11}."),
#  ("npc53_personalityclash_speech", "I don't like {s11}."),
#  ("npc54_personalityclash_speech", "I don't like {s11}."),
#  ("npc55_personalityclash_speech", "I don't like {s11}."),
#  ("npc56_personalityclash_speech", "I don't like {s11}."),
#  ("npc57_personalityclash_speech", "I don't like {s11}."),
#  ("npc58_personalityclash_speech", "I don't like {s11}."),
#  ("npc59_personalityclash_speech", "I don't like {s11}."),
#  ("npc60_personalityclash_speech", "I don't like {s11}."),
#  ("npc61_personalityclash_speech", "I don't like {s11}."),
#  ("npc62_personalityclash_speech", "I don't like {s11}."),
#  ("npc63_personalityclash_speech", "I don't like {s11}."),
#  ("npc64_personalityclash_speech", "I don't like {s11}."),
#  ("npc65_personalityclash_speech", "I don't like {s11}."),
#  ("npc66_personalityclash_speech", "I don't like {s11}."),
##Extra companions set 3
#  ("npc67_personalityclash_speech", "I don't like {s11}."),
#  ("npc68_personalityclash_speech", "I don't like {s11}."),
#  ("npc69_personalityclash_speech", "I don't like {s11}."),
#  ("npc70_personalityclash_speech", "I don't like {s11}."),
#  ("npc71_personalityclash_speech", "I don't like {s11}."),
#  ("npc72_personalityclash_speech", "I don't like {s11}."),
#  ("npc73_personalityclash_speech", "I don't like {s11}."),
#  ("npc74_personalityclash_speech", "I don't like {s11}."),
#  ("npc75_personalityclash_speech", "I don't like {s11}."),
#  ("npc76_personalityclash_speech", "I don't like {s11}."),
#  ("npc77_personalityclash_speech", "I don't like {s11}."),
#  ("npc78_personalityclash_speech", "I don't like {s11}."),
#  ("npc79_personalityclash_speech", "I don't like {s11}."),
#  ("npc80_personalityclash_speech", "I don't like {s11}."),
#  ("npc81_personalityclash_speech", "I don't like {s11}."),
#  ("npc82_personalityclash_speech", "I don't like {s11}."),
#  ("npc83_personalityclash_speech", "I don't like {s11}."),
#  ("npc84_personalityclash_speech", "I don't like {s11}."),
#  ("npc85_personalityclash_speech", "I don't like {s11}."),
#  ("npc86_personalityclash_speech", "I don't like {s11}."),
#  ("npc87_personalityclash_speech", "I don't like {s11}."),
#  ("npc88_personalityclash_speech", "I don't like {s11}."),
...
#Native companions
  ...
  ("npc3_personalityclash_speech_b", "I know that in an army some cheating is normal, but I do believe that woman enjoys rigging fair games and tournaments for the sake of cheating. I hope you do not mind me saying so."),
  ...
  ("npc9_personalityclash_speech_b", "The Heavens know what poor lord he looted his gear from, but I don't want to be seen in his company when we meet his family. It will be better for our credibility if you let that liar go.."),
  ...
  ("npc13_personalityclash_speech_b", "Misfortune can happen to even the best among us, but the stories she tells about her home village are even too unbelievable for me. When you make something up it should be at least believable. A village elder who kills a new woman every morning? Ha! He would have ran out of them years ago."),
  ("npc14_personalityclash_speech_b", "That ignorant peasant of an {s11} saw fit to admonish me for this. I will not have my methods questioned in front of the men, and I will not serve any commander who tolerates such insubordination in his company. Thank you for allowing me to speak my peace."),
  ("npc15_personalityclash_speech_b", "I'm afraid that he'll abandon us when times will be tough, for the fallen ones will prosper on lazyness. I can't watch you getting betrayed by a scoundrel like him. I hope you don't mind me saying so."),
  ("npc16_personalityclash_speech_b", "Fearing a heathen in disguise, I asked him about it, and he dared tell me that I was wrong! That I should follow his ways, or be silent like a chit of a girl. Deeply insulted, I took a look in his baggage, and found scolls in a strange language, covered with strange and evil-looking signs. I think he is a bode from Evil, {sir/madame}, and if I hear him trying to convert anyone he'll have a knife in his throat."),
# Floris companions
  ("npc17_personalityclash_speech_b", "How can anyone make a decent living in this party when that thief is around? If I can get my hands on her, she won't do it again, I can assure you that much."),
  ("npc18_personalityclash_speech_b", "After trying to get closer for weeks, I finally dared to open up to him, and all he could do was insult me. He says I tell bad fairy tales and that no-one should believe me! You still believe me, don't you, my dear {sir/madame}?"),
  ("npc19_personalityclash_speech_b", "I've told her about my fair victory at the yearly archery games, and now she spreads filthy lies around the camp! She says that I rigged those games, and that I cheat my way through life. Please don't trust her -- you know me, right?"),
  ("npc20_personalityclash_speech_b", "I recently talked to her, and discovered the differences in our ways, upon which I took the opportunity to correct her errors. The insults she hurled at me! I dare not to repeat them.  Later I discovered that she had gone through my baggage and ruined one of my holy scrolls!  If she stays any longer wih us, I fear I might resort to my old ways and kill her on sight.  Please, {sir/my lady}, don't let that happen."),
  ("npc21_personalityclash_speech_b", "He quotes dead poets to prove his point, but who cares what has been written a thousand years ago while we are alive today? I hope you'll use your common sense and leave {s11} behind at the first opportunity possible."),
  ("npc22_personalityclash_speech_b", "When I spoke my mind to him, he wanted to lash out on me! I will not ride out with people who act just like the knights who murdered my wife and daughter. If you don't do something about it, I will find another company to help me with my revenge."),
##Extra companions set 1
#  ("npc23_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc24_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc25_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc26_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc27_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc28_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc29_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc30_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc31_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc32_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc33_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc34_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc35_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc36_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc37_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc38_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc39_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc40_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc41_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc42_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc43_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc44_personalityclash_speech_b", "Do something about it, or I'll leave."),
##Extra companions set 2
#  ("npc45_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc46_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc47_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc48_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc49_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc50_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc51_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc52_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc53_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc54_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc55_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc56_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc57_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc58_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc59_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc60_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc61_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc62_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc63_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc64_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc65_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc66_personalityclash_speech_b", "Do something about it, or I'll leave."),
##Extra companions set 3
#  ("npc67_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc68_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc69_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc70_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc71_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc72_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc73_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc74_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc75_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc76_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc77_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc78_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc79_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc80_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc81_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc82_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc83_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc84_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc85_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc86_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc87_personalityclash_speech_b", "Do something about it, or I'll leave."),
#  ("npc88_personalityclash_speech_b", "Do something about it, or I'll leave."),

### set off by behavior after victorious battle
#Native companions
  ("npc1_personalityclash2_speech", "Ho there, Captain -- Could you spare a minute with me? During our last battle I fought alongside {s11}, only to see him betray us!"),
  ...
  ("npc3_personalityclash2_speech", "{Sir/Madame}. Since I have joined your company, I have tried to learn how to live like a soldier, and how to honour the warrior's code. But I'm not here on a religios quest, like some of us."),
  ...
  ("npc8_personalityclash2_speech", "Captain. {s11} is the most disloyal and ungrateful peasant I have ever met. I have tried to be polite, even friendly, only to have him rebuff me."),
  ("npc9_personalityclash2_speech", "{Sir/My lady}, I hope you do not mind me telling you this, but in my opinion {s11}, the archer, is trying to receive more honour than she deserves."),
  ...
  ("npc16_personalityclash2_speech", "Beg your pardon, {sir/ma'am}, but didn't we share the loot according to your wisdom? I'm keeping my eye on {s11} for a while now, and saw only a moment ago a chance to dig through his stuff. There I found a pouch with gold hidden from the rest of us all."),
# Floris companions
  ...
  ("npc19_personalityclash2_speech", "Hello there, pretty {boy/face}. I'm afraid I really can't fight alongside {s11} anymore."),
...
##Extra companions set 1
#  ("npc23_personalityclash2_speech", "I don't like {s11}."),
#  ("npc24_personalityclash2_speech", "I don't like {s11}."),
#  ("npc25_personalityclash2_speech", "I don't like {s11}."),
#  ("npc26_personalityclash2_speech", "I don't like {s11}."),
#  ("npc27_personalityclash2_speech", "I don't like {s11}."),
#  ("npc28_personalityclash2_speech", "I don't like {s11}."),
#  ("npc29_personalityclash2_speech", "I don't like {s11}."),
#  ("npc30_personalityclash2_speech", "I don't like {s11}."),
#  ("npc31_personalityclash2_speech", "I don't like {s11}."),
#  ("npc32_personalityclash2_speech", "I don't like {s11}."),
#  ("npc33_personalityclash2_speech", "I don't like {s11}."),
#  ("npc34_personalityclash2_speech", "I don't like {s11}."),
#  ("npc35_personalityclash2_speech", "I don't like {s11}."),
#  ("npc36_personalityclash2_speech", "I don't like {s11}."),
#  ("npc37_personalityclash2_speech", "I don't like {s11}."),
#  ("npc38_personalityclash2_speech", "I don't like {s11}."),
#  ("npc39_personalityclash2_speech", "I don't like {s11}."),
#  ("npc40_personalityclash2_speech", "I don't like {s11}."),
#  ("npc41_personalityclash2_speech", "I don't like {s11}."),
#  ("npc42_personalityclash2_speech", "I don't like {s11}."),
#  ("npc43_personalityclash2_speech", "I don't like {s11}."),
#  ("npc44_personalityclash2_speech", "I don't like {s11}."),
##Extra companions set 2
#  ("npc45_personalityclash2_speech", "I don't like {s11}."),
#  ("npc46_personalityclash2_speech", "I don't like {s11}."),
#  ("npc47_personalityclash2_speech", "I don't like {s11}."),
#  ("npc48_personalityclash2_speech", "I don't like {s11}."),
#  ("npc49_personalityclash2_speech", "I don't like {s11}."),
#  ("npc50_personalityclash2_speech", "I don't like {s11}."),
#  ("npc51_personalityclash2_speech", "I don't like {s11}."),
#  ("npc52_personalityclash2_speech", "I don't like {s11}."),
#  ("npc53_personalityclash2_speech", "I don't like {s11}."),
#  ("npc54_personalityclash2_speech", "I don't like {s11}."),
#  ("npc55_personalityclash2_speech", "I don't like {s11}."),
#  ("npc56_personalityclash2_speech", "I don't like {s11}."),
#  ("npc57_personalityclash2_speech", "I don't like {s11}."),
#  ("npc58_personalityclash2_speech", "I don't like {s11}."),
#  ("npc59_personalityclash2_speech", "I don't like {s11}."),
#  ("npc60_personalityclash2_speech", "I don't like {s11}."),
#  ("npc61_personalityclash2_speech", "I don't like {s11}."),
#  ("npc62_personalityclash2_speech", "I don't like {s11}."),
#  ("npc63_personalityclash2_speech", "I don't like {s11}."),
#  ("npc64_personalityclash2_speech", "I don't like {s11}."),
#  ("npc65_personalityclash2_speech", "I don't like {s11}."),
#  ("npc66_personalityclash2_speech", "I don't like {s11}."),
##Extra companions set 3
#  ("npc67_personalityclash2_speech", "I don't like {s11}."),
#  ("npc68_personalityclash2_speech", "I don't like {s11}."),
#  ("npc69_personalityclash2_speech", "I don't like {s11}."),
#  ("npc70_personalityclash2_speech", "I don't like {s11}."),
#  ("npc71_personalityclash2_speech", "I don't like {s11}."),
#  ("npc72_personalityclash2_speech", "I don't like {s11}."),
#  ("npc73_personalityclash2_speech", "I don't like {s11}."),
#  ("npc74_personalityclash2_speech", "I don't like {s11}."),
#  ("npc75_personalityclash2_speech", "I don't like {s11}."),
#  ("npc76_personalityclash2_speech", "I don't like {s11}."),
#  ("npc77_personalityclash2_speech", "I don't like {s11}."),
#  ("npc78_personalityclash2_speech", "I don't like {s11}."),
#  ("npc79_personalityclash2_speech", "I don't like {s11}."),
#  ("npc80_personalityclash2_speech", "I don't like {s11}."),
#  ("npc81_personalityclash2_speech", "I don't like {s11}."),
#  ("npc82_personalityclash2_speech", "I don't like {s11}."),
#  ("npc83_personalityclash2_speech", "I don't like {s11}."),
#  ("npc84_personalityclash2_speech", "I don't like {s11}."),
#  ("npc85_personalityclash2_speech", "I don't like {s11}."),
#  ("npc86_personalityclash2_speech", "I don't like {s11}."),
#  ("npc87_personalityclash2_speech", "I don't like {s11}."),
#  ("npc88_personalityclash2_speech", "I don't like {s11}."),

#Native companions
  ("npc1_personalityclash2_speech_b", "He fought hard, but the moment his opponent was lying helplessly in front of him, he took the foe's money like a traitor, and wanted to let him go! Luckily I was there to slay the enemy before he escaped. Captain, be warned, fo I'm afraid he'll sell you out at the first opportunity"),#borcha - ghazwan
  ("npc2_personalityclash2_speech_b", "The enemy was bearing down on us, when she started to scream like a little girl and hit me on the back. I wasn't struck down by her weak action, so I turned around and saw a glowing madness in her eyes. How can anyone fight along a woman who has clearly has lost her mind?"), #marnid - alayen
  ("npc3_personalityclash2_speech_b", "After our last victory I was picking through the slain, and availed of one of our foe's purses. No sooner had I don so then {s11} came up behind me and struck it from my hands, saying that I couldn't loot the dead without asking the Heavens for forgiveness. My {lord/lady}, of course I believe, but his ways seem so strange. How can I become a soldier when that religious freak corrects me for things I didn't do wrong?"),#Ymira - sajjad
  ...
  ("npc8_personalityclash2_speech_b", "As we were cleaning our weapons after that last battle, I remarked that I thought him a resourcefull man, and after I regained my lands I would happily find him a mill to work in. I thought it was a generous offer, as a man who killed a knight would have a hard time finding a landlord who'd allow him to stay. But rather than thank me, he simply turned his back without saying a word. It was only out of respect for your leadership that I did not immediately try to teach him some manners."),  #matheld - edwyn
  ("npc9_personalityclash2_speech_b", "During our last battle I caught her sneaking around, putting her arrows in bodies already slain. I do not pretend to understand her motives to do so, but when I asked her about this strange behaviour, she told be to bug off. Me! A man of noble birth, being told to go away by a simple peasant like herself? In my eyes she has lost all honour and should leave us in shame."),# alayen - marnid
  ...
  ("npc16_personalityclash2_speech_b", "How can we trust him to fight when he's clearly more occupied with looting the battlefield? Even thieves could be trusted in a brawl. If I spot him looting instead of fighting, I'll inspect his innards instead of his pouches."), #klethi - borcha
# Floris companions
  ("npc17_personalityclash2_speech_b", "His attitude begins to irritate me. He might be of noble birth, but he has done nothing to earn his titles. Staying out of a fight to keep his armor shiny, complaining when his weapons get dirty: this arrogant prick is trouble all along."), #floris - alayen
  ...
  ("npc19_personalityclash2_speech_b", "During our last battle I was collecting some arrows, since I had run out, when he suddenly leaped up behind me and accused me of rigging the outcome of the battle. How ridiculous is that? You can either win or loose, nothing else. If even that's too hard to grasp for him, you'd be better off to let him go."),
...
##Extra companions set 1
#  ("npc23_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc24_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc25_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc26_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc27_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc28_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc29_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc30_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc31_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc32_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc33_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc34_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc35_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc36_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc37_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc38_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc39_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc40_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc41_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc42_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc43_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc44_personalityclash2_speech_b", "Do something about it, or I'll leave."),
##Extra companions set 2
#  ("npc45_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc46_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc47_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc48_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc49_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc50_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc51_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc52_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc53_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc54_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc55_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc56_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc57_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc58_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc59_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc60_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc61_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc62_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc63_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc64_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc65_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc66_personalityclash2_speech_b", "Do something about it, or I'll leave."),
##Extra companions set 3
#  ("npc67_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc68_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc69_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc70_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc71_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc72_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc73_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc74_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc75_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc76_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc77_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc78_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc79_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc80_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc81_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc82_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc83_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc84_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc85_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc86_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc87_personalityclash2_speech_b", "Do something about it, or I'll leave."),
#  ("npc88_personalityclash2_speech_b", "Do something about it, or I'll leave."),
...
# Floris companions
  ("npc17_personalitymatch_speech", "{playername}, while I was fighting in the frontline this battle I got finally a chance to speak to {s11}. What a revelation it was to hear his story: I finally don't feel alone anymore."),
  ("npc18_personalitymatch_speech", "My dear {sir/madame}, have I been wrong? I thought that everyone in the whole world was out there to kill me -- you excluded of course -- but now that I have spoken to {s11}, I'm not sure about that. He seems so nice and understanding."),
  ("npc19_personalitymatch_speech", "Pretty {boy/face}, today I had a most pleasant talk with {s11}. I believe he and I share the same feelings about all this bloodshed that happens all around us."),
  ("npc20_personalitymatch_speech", "The Heavens be praised that you enlisted {s11} in your company, {sir/my lady}. He's a good fighter, and clearly tries to amend his old ways, just like me."),
  ("npc21_personalitymatch_speech", "My friend, it's good to fight alongside {s11}. He is brave, and most of all, honorable."),
  ("npc22_personalitymatch_speech", "Captain, have you heard {s11}'s story? About the abuse of power by her village elder? Her tale made my blood boil. How I wish I was there to tell him what I think of him."),
##Extra companions set 1
#  ("npc23_personalitymatch_speech",  "I like {s11}."),
#  ("npc24_personalitymatch_speech",  "I like {s11}."),
#  ("npc25_personalitymatch_speech",  "I like {s11}."),
#  ("npc26_personalitymatch_speech",  "I like {s11}."),
#  ("npc27_personalitymatch_speech",  "I like {s11}."),
#  ("npc28_personalitymatch_speech",  "I like {s11}."),
#  ("npc29_personalitymatch_speech",  "I like {s11}."),
#  ("npc30_personalitymatch_speech",  "I like {s11}."),
#  ("npc31_personalitymatch_speech",  "I like {s11}."),
#  ("npc32_personalitymatch_speech",  "I like {s11}."),
#  ("npc33_personalitymatch_speech",  "I like {s11}."),
#  ("npc34_personalitymatch_speech",  "I like {s11}."),
#  ("npc35_personalitymatch_speech",  "I like {s11}."),
#  ("npc36_personalitymatch_speech",  "I like {s11}."),
#  ("npc37_personalitymatch_speech",  "I like {s11}."),
#  ("npc38_personalitymatch_speech",  "I like {s11}."),
#  ("npc39_personalitymatch_speech",  "I like {s11}."),
#  ("npc40_personalitymatch_speech",  "I like {s11}."),
#  ("npc41_personalitymatch_speech",  "I like {s11}."),
#  ("npc42_personalitymatch_speech",  "I like {s11}."),
#  ("npc43_personalitymatch_speech",  "I like {s11}."),
#  ("npc44_personalitymatch_speech",  "I like {s11}."),
##Extra companions set 2
#  ("npc45_personalitymatch_speech",  "I like {s11}."),
#  ("npc46_personalitymatch_speech",  "I like {s11}."),
#  ("npc47_personalitymatch_speech",  "I like {s11}."),
#  ("npc48_personalitymatch_speech",  "I like {s11}."),
#  ("npc49_personalitymatch_speech",  "I like {s11}."),
#  ("npc50_personalitymatch_speech",  "I like {s11}."),
#  ("npc51_personalitymatch_speech",  "I like {s11}."),
#  ("npc52_personalitymatch_speech",  "I like {s11}."),
#  ("npc53_personalitymatch_speech",  "I like {s11}."),
#  ("npc54_personalitymatch_speech",  "I like {s11}."),
#  ("npc55_personalitymatch_speech",  "I like {s11}."),
#  ("npc56_personalitymatch_speech",  "I like {s11}."),
#  ("npc57_personalitymatch_speech",  "I like {s11}."),
#  ("npc58_personalitymatch_speech",  "I like {s11}."),
#  ("npc59_personalitymatch_speech",  "I like {s11}."),
#  ("npc60_personalitymatch_speech",  "I like {s11}."),
#  ("npc61_personalitymatch_speech",  "I like {s11}."),
#  ("npc62_personalitymatch_speech",  "I like {s11}."),
#  ("npc63_personalitymatch_speech",  "I like {s11}."),
#  ("npc64_personalitymatch_speech",  "I like {s11}."),
#  ("npc65_personalitymatch_speech",  "I like {s11}."),
#  ("npc66_personalitymatch_speech",  "I like {s11}."),
##Extra companions set 3
#  ("npc67_personalitymatch_speech",  "I like {s11}."),
#  ("npc68_personalitymatch_speech",  "I like {s11}."),
#  ("npc69_personalitymatch_speech",  "I like {s11}."),
#  ("npc70_personalitymatch_speech",  "I like {s11}."),
#  ("npc71_personalitymatch_speech",  "I like {s11}."),
#  ("npc72_personalitymatch_speech",  "I like {s11}."),
#  ("npc73_personalitymatch_speech",  "I like {s11}."),
#  ("npc74_personalitymatch_speech",  "I like {s11}."),
#  ("npc75_personalitymatch_speech",  "I like {s11}."),
#  ("npc76_personalitymatch_speech",  "I like {s11}."),
#  ("npc77_personalitymatch_speech",  "I like {s11}."),
#  ("npc78_personalitymatch_speech",  "I like {s11}."),
#  ("npc79_personalitymatch_speech",  "I like {s11}."),
#  ("npc80_personalitymatch_speech",  "I like {s11}."),
#  ("npc81_personalitymatch_speech",  "I like {s11}."),
#  ("npc82_personalitymatch_speech",  "I like {s11}."),
#  ("npc83_personalitymatch_speech",  "I like {s11}."),
#  ("npc84_personalitymatch_speech",  "I like {s11}."),
#  ("npc85_personalitymatch_speech",  "I like {s11}."),
#  ("npc86_personalitymatch_speech",  "I like {s11}."),
#  ("npc87_personalitymatch_speech",  "I like {s11}."),
#  ("npc88_personalitymatch_speech",  "I like {s11}."),
...
#Native companions
  ...
  ("npc5_personalitymatch_speech_b", "As for his other attributes, I doubt that he is any more of noble blood than I am, but I have to admire the way he makes that claim."),
  ("npc6_personalitymatch_speech_b", "I must say that {s11} is a source of great comfort to me. I have told him of my sin, and he confessed a likewise murder. He is a wise man who said that the Heavens will forgive our transgressions if we truly repent and truly desire such forgiveness. I am glad I can share my sorrow with him."),
  ...
  ("npc12_personalitymatch_speech_b", "It saddens her deeply to take the lives of her fellow men, however just the cause. She and I have talked together of a brighter future, where there will be no more unnecessary killing -- just games and tournaments -- so that we may see this time of troubles to come to an end."),
...
# Floris companions
  ("npc17_personalitymatch_speech_b", "He has killed his brother by accident, just like I killed Philippe Hurepel de Clermont in that stupid duel back in Corbie. When we talked about our sorrows and burdens, I could hear the remorse in his voice. He's a good man, I reckon that."),
  ("npc18_personalitymatch_speech_b", "It seems that men have done terrible things to his wife and daughter. What I don't understand yet is why he hasn't been corrupted by that experience, as so many men would have. He seems so pure, like a woman, but don't say that last bit to him as he might take it the wrong way. I just want to say that his pressence makes me feel safer, my dear {sir/madame}."),
  ("npc19_personalitymatch_speech_b", "It is a waste of good men, who could better be beaten in games and tournaments. That way they can tell about our glory and victory to their children and children's children."),
  ("npc20_personalitymatch_speech_b", "His story might seem unbelievable -- especially with the way he fights, which I recognized last battle -- but at least he shook his old shackles off and tries to find a better way in life. I believe that I might even be able to convince him to follow the right path."),
  ("npc21_personalitymatch_speech_b", "When I talked to {s11} after our last battle, I understood that he's been far away from home too. I feel we are similar souls, and destined to be friends, my friend."),
  ("npc22_personalitymatch_speech_b", "Maybe it's the way she talks, or the way she walks: somewhere she reminds me of my late wife. I feel sorry for her, that she has had to live through such an experience. But I'm glad hat there is at least one soul in this company that really understands me."),
##Extra companions set 1
#  ("npc23_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc24_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc25_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc26_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc27_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc28_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc29_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc30_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc31_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc32_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc33_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc34_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc35_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc36_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc37_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc38_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc39_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc40_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc41_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc42_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc43_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc44_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
##Extra companions set 2
#  ("npc45_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc46_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc47_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc48_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc49_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc50_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc51_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc52_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc53_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc54_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc55_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc56_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc57_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc58_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc59_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc60_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc61_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc62_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc63_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc64_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc65_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc66_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
##Extra companions set 3
#  ("npc67_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc68_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc69_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc70_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc71_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc72_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc73_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc74_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc75_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc76_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc77_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc78_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc79_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc80_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc81_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc82_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc83_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc84_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc85_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc86_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc87_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
#  ("npc88_personalitymatch_speech_b", "I just wanted to say that, before you started to get the wrong impression."),
...
# Floris companions
  ...
  ("npc18_retirement_speech", "I'm sorry, my dear {sir/madame}, but I'm afraid I can't stay any longer with your band. I've lost my trust in your companions and don't dare to risk them handing me over to the village elder. I thank you for your kindness."),
  ("npc19_retirement_speech", "It's been a wonderful time travelling with you, pretty {boy/face}, but I've seen too much fighting and too little display of my skill for any judges. It is time for me to compete in another tournament -- I've heard about a few with lots of honor and even more prize money."),
  ("npc20_retirement_speech", "I'm sorry, {sir/my lady}, but the Heavens have shown me a different path than the one you are taking. I'm afraid we'll have to part here. If we have enough faith, our paths may one day cross each other again."),
  ...
  ("npc22_retirement_speech", "Where are you heading, captain? I picked up a trail of those vile nobles, and they went that way. Ah, well, I'll just go my own way if I can't convince you to come along to that direction. It isn't like you ever listened to my suggestions after all..."),
##Extra companions set 1
#  ("npc23_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc24_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc25_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc26_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc27_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc28_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc29_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc30_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc31_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc32_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc33_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc34_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc35_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc36_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc37_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc38_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc39_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc40_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc41_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc42_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc43_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc44_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
##Extra companions set 2
#  ("npc45_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc46_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc47_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc48_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc49_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc50_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc51_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc52_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc53_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc54_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc55_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc56_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc57_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc58_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc59_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc60_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc61_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc62_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc63_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc64_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc65_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc66_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
##Extra companions set 3
#  ("npc67_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc68_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc69_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc70_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc71_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc72_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc73_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc74_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc75_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc76_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc77_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc78_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc79_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc80_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc81_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc82_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc83_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc84_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc85_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc86_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc87_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
#  ("npc88_retirement_speech", "You still haven't written a decent dialogue for me. I've had it: bye bye."),
...
# Floris companions
  ("npc17_rehire_speech", "{playername}! It's been a while since we last spoken. I still remember the smell of the battlefields you led us on, the sound of coins exchanging ownership as we traded our way from city to city and the feeling of rescpect we earned with each move we made. Things are going easy for me lately. Too easy. The money is soundly invested, and I've got some men working on my future empire. For me there's nothing left to do. What do you think, shall we revive old times?"),
  ("npc18_rehire_speech", "What a cruel world it is out there! No one believes me, and they all want to return me to my father. Like that will do any good. My dear {sir/madame}, could you show me your mercy once again and let me join your protection once more?"),
  ("npc19_rehire_speech", "Hey there, pretty {boy/face}, remember me? I went to a few tournaments and got once again accused of foul play! It's like the world doesn't like me at all. Would you mind if once again I stayed with you for a little while?"),
  ("npc20_rehire_speech", "The Heavens be praised that we meet again, {sir/my lady}. It is so much easier to stay at the right path in your company. I now know that for sure. If you still appreciate me, I'd like to join your side once again."),
  ...
  ("npc22_rehire_speech", "Ah, captain. I'd hate to admit it, but you were right. The trace I followed led to nowhere. I'd like to join your company again, and this time I promise to heed your words more than I used to do."),
##Extra companions set 1
#  ("npc23_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc24_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc25_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc26_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc27_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc28_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc29_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc30_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc31_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc32_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc33_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc34_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc35_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc36_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc37_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc38_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc39_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc40_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc41_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc42_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc43_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc44_rehire_speech", "I miss you. Can I join you again? Please?"),
##Extra companions set 2
#  ("npc45_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc46_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc47_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc48_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc49_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc50_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc51_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc52_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc53_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc54_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc55_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc56_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc57_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc58_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc59_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc60_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc61_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc62_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc63_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc64_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc65_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc66_rehire_speech", "I miss you. Can I join you again? Please?"),
##Extra companions set 3
#  ("npc67_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc68_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc69_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc70_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc71_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc72_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc73_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc74_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc75_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc76_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc77_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc78_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc79_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc80_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc81_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc82_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc83_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc84_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc85_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc86_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc87_rehire_speech", "I miss you. Can I join you again? Please?"),
#  ("npc88_rehire_speech", "I miss you. Can I join you again? Please?"),

#local color strings
#Native companions
  ("npc1_home_intro", "Boss -- did you know that I was born around here, in the high steppe? This is where I got my eye for horseflesh, because this is good land for horses, although a hard land for men. I suppose that's why the Khergits like it."), #Dashbiga - Khergit
  ("npc2_home_intro", "We're approaching Sargoth. That's where I was headed when the Khergits got me."), #Sargoth - Nord
  ("npc3_home_intro", "Can you smell that? Lemon trees, apples and crocus flowers, it's the scent of Veluca. I spent many a happy summer here when I was a girl, playing in the gardens of my mother's family while my father was away trading."), #Veluca - Rhodok
  ("npc4_home_intro", "The Woods of Ehlerdah. Bah. This place is thick with bandits and outlaws."), #Ehlerdah - Swadia
  ("npc5_home_intro", "Bahadur, we are nearing Halmar, largest town in the lower steppe. My mother's sister went here to marry a townsman and I thought to seek service with the lord here. That is when I ran into you."), #Halmar - Khergit
  ("npc6_home_intro", "I can see by the vines and terraces on the hillside that I am near home. I have no wish to see my family, so I will linger outside the walls if you go into town. I am sure that you will understand."), #Suno - Swadia
  ("npc7_home_intro", "Do you smell that? Salt fish, rotting flax and river mud. The smells of my childhood. I want to retch."), #Kulum - Nord
  ("npc8_home_intro", "Hmf. Do you hear that? It must be the crash of waves on the headland. We must be near Gundig's Point."), #Gundig's Point - Sea Raider Spawn Point
  ("npc9_home_intro", "Behold the Rock of Rivacheg! The strongest fortress in Calradia. My father was one of those who held the line here against the Nords, when they first tried to push inland from the coast."), #Rivacheg - Vaegir
  ("npc10_home_intro", "D'you smell that fresh air, Brother? This was my home, before I went abroad in search of coin. It's good to be up in the hills again. It's the smell of freedom. This is the cradle of Rhodok liberty, here under Grunwalder Castle."), #Grunwalder Castle - Rhodok
  ("npc11_home_intro", "I see the mountains. We must be getting near home."), #Praven - Swadia
  ("npc12_home_intro", "We're passing by the site of one of my greatest medical triumphs, if that interests you."), #Almerra Castle - Rhodok
  ("npc13_home_intro", "Ah, Castle Ergellon! Such a lovely spot, at the foot of the Rhodok highlands. Such happy days I spent here, the summer before last."), #Ergellon Castle - Rhodok
  ("npc14_home_intro", "Do you see that fortress up there, on the spur over the valley? Ismirala? I spent a winter there some years back, trying to train the lord's men."), #Ismirala Castle - Vaegir
  ("npc15_home_intro", "You see that castle up on the hill? Culmarr Castle, it's called. I did some work there, not long ago. It's not as showy as some of the other castles in this land, but it's the finest stonework you ever saw."), #Culmarr Castle - Rhodok
  ("npc16_home_intro", "Aye, captain, do you see those? Those are hare tracks in the snow. We must be getting near to my birthplace."), #Uslum - Vaegir
# Floris companions
  ("npc17_home_intro", "Khudan... One of the few towns where the locals have supported me from the moment I set foot in it."), #Khudan - Vaegir
  ("npc18_home_intro", "I must warn you, my dear {sir/madame}. Behind these dunes lies Sekhtem, the village I ran away from."), #Sekhtem - Sarranid
  ("npc19_home_intro", "Across these plains is Tulbuk, home of the most famous yearly archery games."), #Tulbuk - Khergit
  ("npc20_home_intro", "The Sarrdak desert... Home to bandits like I used to be."), #Sarrdak Desert - Sarranid
  ("npc21_home_intro", "Ah, my friend: the town of Shariz. The place my father's servant left me before passing."), #Shariz - Sarranid
  ("npc22_home_intro", "We're almost in Ibiran, my former home."), #Ibiran - Swadia
##Extra companions set 1
#  ("npc23_home_intro", "Look, there's my home!"),
#  ("npc24_home_intro", "Look, there's my home!"),
#  ("npc25_home_intro", "Look, there's my home!"),
#  ("npc26_home_intro", "Look, there's my home!"),
#  ("npc27_home_intro", "Look, there's my home!"),
#  ("npc28_home_intro", "Look, there's my home!"),
#  ("npc29_home_intro", "Look, there's my home!"),
#  ("npc30_home_intro", "Look, there's my home!"),
#  ("npc31_home_intro", "Look, there's my home!"),
#  ("npc32_home_intro", "Look, there's my home!"),
#  ("npc33_home_intro", "Look, there's my home!"),
#  ("npc34_home_intro", "Look, there's my home!"),
#  ("npc35_home_intro", "Look, there's my home!"),
#  ("npc36_home_intro", "Look, there's my home!"),
#  ("npc37_home_intro", "Look, there's my home!"),
#  ("npc38_home_intro", "Look, there's my home!"),
#  ("npc39_home_intro", "Look, there's my home!"),
#  ("npc40_home_intro", "Look, there's my home!"),
#  ("npc41_home_intro", "Look, there's my home!"),
#  ("npc42_home_intro", "Look, there's my home!"),
#  ("npc43_home_intro", "Look, there's my home!"),
#  ("npc44_home_intro", "Look, there's my home!"),
##Extra companions set 2
#  ("npc45_home_intro", "Look, there's my home!"),
#  ("npc46_home_intro", "Look, there's my home!"),
#  ("npc47_home_intro", "Look, there's my home!"),
#  ("npc48_home_intro", "Look, there's my home!"),
#  ("npc49_home_intro", "Look, there's my home!"),
#  ("npc50_home_intro", "Look, there's my home!"),
#  ("npc51_home_intro", "Look, there's my home!"),
#  ("npc52_home_intro", "Look, there's my home!"),
#  ("npc53_home_intro", "Look, there's my home!"),
#  ("npc54_home_intro", "Look, there's my home!"),
#  ("npc55_home_intro", "Look, there's my home!"),
#  ("npc56_home_intro", "Look, there's my home!"),
#  ("npc57_home_intro", "Look, there's my home!"),
#  ("npc58_home_intro", "Look, there's my home!"),
#  ("npc59_home_intro", "Look, there's my home!"),
#  ("npc60_home_intro", "Look, there's my home!"),
#  ("npc61_home_intro", "Look, there's my home!"),
#  ("npc62_home_intro", "Look, there's my home!"),
#  ("npc63_home_intro", "Look, there's my home!"),
#  ("npc64_home_intro", "Look, there's my home!"),
#  ("npc65_home_intro", "Look, there's my home!"),
#  ("npc66_home_intro", "Look, there's my home!"),
##Extra companions set 3
#  ("npc67_home_intro", "Look, there's my home!"),
#  ("npc68_home_intro", "Look, there's my home!"),
#  ("npc69_home_intro", "Look, there's my home!"),
#  ("npc70_home_intro", "Look, there's my home!"),
#  ("npc71_home_intro", "Look, there's my home!"),
#  ("npc72_home_intro", "Look, there's my home!"),
#  ("npc73_home_intro", "Look, there's my home!"),
#  ("npc74_home_intro", "Look, there's my home!"),
#  ("npc75_home_intro", "Look, there's my home!"),
#  ("npc76_home_intro", "Look, there's my home!"),
#  ("npc77_home_intro", "Look, there's my home!"),
#  ("npc78_home_intro", "Look, there's my home!"),
#  ("npc79_home_intro", "Look, there's my home!"),
#  ("npc80_home_intro", "Look, there's my home!"),
#  ("npc81_home_intro", "Look, there's my home!"),
#  ("npc82_home_intro", "Look, there's my home!"),
#  ("npc83_home_intro", "Look, there's my home!"),
#  ("npc84_home_intro", "Look, there's my home!"),
#  ("npc85_home_intro", "Look, there's my home!"),
#  ("npc86_home_intro", "Look, there's my home!"),
#  ("npc87_home_intro", "Look, there's my home!"),
#  ("npc88_home_intro", "Look, there's my home!"),
...
# Floris companions
  ("npc17_home_description", "Before I met you, I travelled for a few months through Calradia, trying to make my way. Many people thought I was a lunatic, rambling about places they had never heard of. But in Khudan the people never spoke ill of me, certainly not after I had droven off those tundra bandits that roamed the fields along the villages. It's hard to live in this hars environment without any raids, imagine how the folks there suffered while these evildoers stole their precious furs."),
  ("npc18_home_description", "It used to be an oasis amidst the harsh desert. We all respected and loved our village elder, like he deserved. He always traveled hence and forth between the neighboring villages, to improve our standing. One day he had forgotten something, and returned early, only to find his wife in bed with a large, black slave. Immediately he swung his sword and killed them both."),
  ("npc19_home_description", "Every year the elders set out a hunting track, with targets all over the place. No-one knows in advance where they'll be putting them -- unless you sleep with them, of course. The morning of the competition every contestant will be given specially marked arrows, who have been made the previous night. Luckily I knew where it was done, so I could spot the markings given to me."),
  ("npc20_home_description", "It is there that I lost my faith -- in a very unfortunate way, I must say. Me and my bandits were acting like wildmen as usual, and attacked a caravan. We didn't know it wasn't a regular one: this one was filled with pilgrims. To my shame I must confess that we slaughtered them all without mercy -- men, women and children alike."),
  ("npc21_home_description", "There I was, all alone in the gutter and without anyone to take care of me. I would have died for sure if it wasn't for some townsfolk who took me in, teaching me the ways of the street. It was there I learned to haggle and sell goods for the best price. There is no better learning school than a town under the constant threat of war with the Rhodoks."),
  ("npc22_home_description", "I used to live outside the village in the big mill. You can see the ruins from here. I remember that the year already had a bad start. It must have been an omen. Some kind of fungus had gotten in the wheat, spoiling most of the harvest. And even the sacks brought in smelled funny. If that stupid lord hadn't commanded me to mill the wheat anyway, I would have thrown away even the small amount that was left."),
##Extra companions set 1
#  ("npc23_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc24_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc25_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc26_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc27_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc28_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc29_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc30_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc31_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc32_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc33_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc34_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc35_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc36_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc37_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc38_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc39_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc40_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc41_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc42_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc43_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc44_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
##Extra companions set 2
#  ("npc45_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc46_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc47_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc48_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc49_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc50_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc51_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc52_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc53_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc54_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc55_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc56_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc57_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc58_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc59_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc60_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc61_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc62_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc63_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc64_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc65_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc66_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
##Extra companions set 3
#  ("npc67_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc68_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc69_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc70_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc71_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc72_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc73_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc74_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc75_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc76_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc77_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc78_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc79_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc80_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc81_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc82_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc83_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc84_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc85_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc86_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc87_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
#  ("npc88_home_description", "Apparently I lived in {s21}, but I have no clue why, since that part of the dialogue hasn't been written yet."),
...
#Native companions
  ...
  ("npc9_home_description_2", "Just as the Nords can call on their kinfolk overseas, so does the Vaegir grand prince call on his kinfolk from over the mountains. Had my father not disinherited me, I would also have taken an oath of fealty to the lord of Reyvadin. But just as I was shorn of my inheritance, so also was I shown of my obligations, and it is the Vaegir grand prince's loss."),
...
# Floris companions
  ...
  ("npc19_home_description_2", "The morning of the competition all arrows are handed over, and counted in the evening when they are collected by the elders. I really don't know how it's possible that they found more of my arrows in the evening than had been handed to me during the morning. I hit every target, so I won, fair and square."),
  ("npc20_home_description_2", "It was afterwards, when I went through their stuff, that I had found the scrolls I still carry with me. When reading them, I learned the error of my way and converted to a more religious life. I left my old gang to join the monastery the pilgrims were heading for. I seek forgiveness for the slaughter and can only hope my old comrades do the same."),
  ("npc21_home_description_2", "Unfortunately the war also brings out the worst in people. When I knew enough, I left my saviours before the circumstances could turn them into torturers, as they were definately heading that way. As I walked away, I looked one more time at the shining walls and knew that one day I would return as a man. Today that day has come."),
  ("npc22_home_description_2", "After I had done my job, the baker did his, and the knight demanded the first and only bread this harvest had brought forth. Maybe it was the fungus, maybe it was something else: the next day he was charging my mill, which led to his dead. After that everything went downhill for me."),
##Extra companions set 1
#  ("npc23_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc24_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc25_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc26_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc27_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc28_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc29_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc30_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc31_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc32_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc33_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc34_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc35_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc36_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc37_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc38_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc39_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc40_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc41_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc42_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc43_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc44_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
##Extra companions set 2
#  ("npc45_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc46_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc47_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc48_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc49_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc50_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc51_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc52_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc53_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc54_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc55_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc56_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc57_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc58_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc59_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc60_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc61_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc62_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc63_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc64_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc65_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc66_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
##Extra companions set 3
#  ("npc67_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc68_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc69_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc70_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc71_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc72_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc73_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc74_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc75_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc76_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc77_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc78_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc79_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc80_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc81_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc82_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc83_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc84_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc85_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc86_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc87_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
#  ("npc88_home_description_2", "So if you want to know more about {s21}, write it yourself!"),
...
# Floris companions
  ("npc17_home_recap", "I'm the count of Holland, one of the states of the Holy Roman Empire. Pretty far away from Calradia, I'd say. Back in 1234 I went to Corbie, a French town."),
  ("npc18_home_recap", "I ran away from {s21}, where the village elder terrorizes the women."),
  ("npc19_home_recap", "I cheated -- I mean, got accused of cheating at the yearly archery competition of {s21}."),
  ("npc20_home_recap", "I used to be a fierce bandit in {s21}, until I slaughtered pilgrims and saw the error of my way."),
  ("npc21_home_recap", "My father's servant left me as a young boy in {s21} before dropping dead."),
  ("npc22_home_recap", "A knight charged my mill in {s21}, only to get himself killed."),
##Extra companions set 1
#  ("npc23_home_recap", "I come from {s21}, or so they say."),
#  ("npc24_home_recap", "I come from {s21}, or so they say."),
#  ("npc25_home_recap", "I come from {s21}, or so they say."),
#  ("npc26_home_recap", "I come from {s21}, or so they say."),
#  ("npc27_home_recap", "I come from {s21}, or so they say."),
#  ("npc28_home_recap", "I come from {s21}, or so they say."),
#  ("npc29_home_recap", "I come from {s21}, or so they say."),
#  ("npc30_home_recap", "I come from {s21}, or so they say."),
#  ("npc31_home_recap", "I come from {s21}, or so they say."),
#  ("npc32_home_recap", "I come from {s21}, or so they say."),
#  ("npc33_home_recap", "I come from {s21}, or so they say."),
#  ("npc34_home_recap", "I come from {s21}, or so they say."),
#  ("npc35_home_recap", "I come from {s21}, or so they say."),
#  ("npc36_home_recap", "I come from {s21}, or so they say."),
#  ("npc37_home_recap", "I come from {s21}, or so they say."),
#  ("npc38_home_recap", "I come from {s21}, or so they say."),
#  ("npc39_home_recap", "I come from {s21}, or so they say."),
#  ("npc40_home_recap", "I come from {s21}, or so they say."),
#  ("npc41_home_recap", "I come from {s21}, or so they say."),
#  ("npc42_home_recap", "I come from {s21}, or so they say."),
#  ("npc43_home_recap", "I come from {s21}, or so they say."),
#  ("npc44_home_recap", "I come from {s21}, or so they say."),
##Extra companions set 2
#  ("npc45_home_recap", "I come from {s21}, or so they say."),
#  ("npc46_home_recap", "I come from {s21}, or so they say."),
#  ("npc47_home_recap", "I come from {s21}, or so they say."),
#  ("npc48_home_recap", "I come from {s21}, or so they say."),
#  ("npc49_home_recap", "I come from {s21}, or so they say."),
#  ("npc50_home_recap", "I come from {s21}, or so they say."),
#  ("npc51_home_recap", "I come from {s21}, or so they say."),
#  ("npc52_home_recap", "I come from {s21}, or so they say."),
#  ("npc53_home_recap", "I come from {s21}, or so they say."),
#  ("npc54_home_recap", "I come from {s21}, or so they say."),
#  ("npc55_home_recap", "I come from {s21}, or so they say."),
#  ("npc56_home_recap", "I come from {s21}, or so they say."),
#  ("npc57_home_recap", "I come from {s21}, or so they say."),
#  ("npc58_home_recap", "I come from {s21}, or so they say."),
#  ("npc59_home_recap", "I come from {s21}, or so they say."),
#  ("npc60_home_recap", "I come from {s21}, or so they say."),
#  ("npc61_home_recap", "I come from {s21}, or so they say."),
#  ("npc62_home_recap", "I come from {s21}, or so they say."),
#  ("npc63_home_recap", "I come from {s21}, or so they say."),
#  ("npc64_home_recap", "I come from {s21}, or so they say."),
#  ("npc65_home_recap", "I come from {s21}, or so they say."),
#  ("npc66_home_recap", "I come from {s21}, or so they say."),
##Extra companions set 3
#  ("npc67_home_recap", "I come from {s21}, or so they say."),
#  ("npc68_home_recap", "I come from {s21}, or so they say."),
#  ("npc69_home_recap", "I come from {s21}, or so they say."),
#  ("npc70_home_recap", "I come from {s21}, or so they say."),
#  ("npc71_home_recap", "I come from {s21}, or so they say."),
#  ("npc72_home_recap", "I come from {s21}, or so they say."),
#  ("npc73_home_recap", "I come from {s21}, or so they say."),
#  ("npc74_home_recap", "I come from {s21}, or so they say."),
#  ("npc75_home_recap", "I come from {s21}, or so they say."),
#  ("npc76_home_recap", "I come from {s21}, or so they say."),
#  ("npc77_home_recap", "I come from {s21}, or so they say."),
#  ("npc78_home_recap", "I come from {s21}, or so they say."),
#  ("npc79_home_recap", "I come from {s21}, or so they say."),
#  ("npc80_home_recap", "I come from {s21}, or so they say."),
#  ("npc81_home_recap", "I come from {s21}, or so they say."),
#  ("npc82_home_recap", "I come from {s21}, or so they say."),
#  ("npc83_home_recap", "I come from {s21}, or so they say."),
#  ("npc84_home_recap", "I come from {s21}, or so they say."),
#  ("npc85_home_recap", "I come from {s21}, or so they say."),
#  ("npc86_home_recap", "I come from {s21}, or so they say."),
#  ("npc87_home_recap", "I come from {s21}, or so they say."),
#  ("npc88_home_recap", "I come from {s21}, or so they say."),
...
# Floris companions
  ("npc17_honorific", "{playername}"), #floris
  ("npc18_honorific", "my dear {sir/madame}"),
  ("npc19_honorific", "pretty {boy/face}"),
  ("npc20_honorific", "{sir/my lady}"),
  ("npc21_honorific", "my friend"),
  ("npc22_honorific", "captain"),
##Extra companions set 1
#  ("npc23_honorific", "{sir/my lady}"),
#  ("npc24_honorific", "{sir/my lady}"),
#  ("npc25_honorific", "{sir/my lady}"),
#  ("npc26_honorific", "{sir/my lady}"),
#  ("npc27_honorific", "{sir/my lady}"),
#  ("npc28_honorific", "{sir/my lady}"),
#  ("npc29_honorific", "{sir/my lady}"),
#  ("npc30_honorific", "{sir/my lady}"),
#  ("npc31_honorific", "{sir/my lady}"),
#  ("npc32_honorific", "{sir/my lady}"),
#  ("npc33_honorific", "{sir/my lady}"),
#  ("npc34_honorific", "{sir/my lady}"),
#  ("npc35_honorific", "{sir/my lady}"),
#  ("npc36_honorific", "{sir/my lady}"),
#  ("npc37_honorific", "{sir/my lady}"),
#  ("npc38_honorific", "{sir/my lady}"),
#  ("npc39_honorific", "{sir/my lady}"),
#  ("npc40_honorific", "{sir/my lady}"),
#  ("npc41_honorific", "{sir/my lady}"),
#  ("npc42_honorific", "{sir/my lady}"),
#  ("npc43_honorific", "{sir/my lady}"),
#  ("npc44_honorific", "{sir/my lady}"),
##Extra companions set 2
#  ("npc45_honorific", "{sir/my lady}"),
#  ("npc46_honorific", "{sir/my lady}"),
#  ("npc47_honorific", "{sir/my lady}"),
#  ("npc48_honorific", "{sir/my lady}"),
#  ("npc49_honorific", "{sir/my lady}"),
#  ("npc50_honorific", "{sir/my lady}"),
#  ("npc51_honorific", "{sir/my lady}"),
#  ("npc52_honorific", "{sir/my lady}"),
#  ("npc53_honorific", "{sir/my lady}"),
#  ("npc54_honorific", "{sir/my lady}"),
#  ("npc55_honorific", "{sir/my lady}"),
#  ("npc56_honorific", "{sir/my lady}"),
#  ("npc57_honorific", "{sir/my lady}"),
#  ("npc58_honorific", "{sir/my lady}"),
#  ("npc59_honorific", "{sir/my lady}"),
#  ("npc60_honorific", "{sir/my lady}"),
#  ("npc61_honorific", "{sir/my lady}"),
#  ("npc62_honorific", "{sir/my lady}"),
#  ("npc63_honorific", "{sir/my lady}"),
#  ("npc64_honorific", "{sir/my lady}"),
#  ("npc65_honorific", "{sir/my lady}"),
#  ("npc66_honorific", "{sir/my lady}"),
##Extra companions set 3
#  ("npc67_honorific", "{sir/my lady}"),
#  ("npc68_honorific", "{sir/my lady}"),
#  ("npc69_honorific", "{sir/my lady}"),
#  ("npc70_honorific", "{sir/my lady}"),
#  ("npc71_honorific", "{sir/my lady}"),
#  ("npc72_honorific", "{sir/my lady}"),
#  ("npc73_honorific", "{sir/my lady}"),
#  ("npc74_honorific", "{sir/my lady}"),
#  ("npc75_honorific", "{sir/my lady}"),
#  ("npc76_honorific", "{sir/my lady}"),
#  ("npc77_honorific", "{sir/my lady}"),
#  ("npc78_honorific", "{sir/my lady}"),
#  ("npc79_honorific", "{sir/my lady}"),
#  ("npc80_honorific", "{sir/my lady}"),
#  ("npc81_honorific", "{sir/my lady}"),
#  ("npc82_honorific", "{sir/my lady}"),
#  ("npc83_honorific", "{sir/my lady}"),
#  ("npc84_honorific", "{sir/my lady}"),
#  ("npc85_honorific", "{sir/my lady}"),
#  ("npc86_honorific", "{sir/my lady}"),
#  ("npc87_honorific", "{sir/my lady}"),
#  ("npc88_honorific", "{sir/my lady}"),
...
#Native companions
  ...
  ("npc11_kingsupport_1", "Why, that's a fine idea, {laddie/lassie}! I suppose I shall have to learn to call you 'Your Majesty', or 'Your Grace', then..."), #katrin
...
# Floris companions
  ("npc17_kingsupport_1", "I see you've taken over my aspirations. Don't sweat it, you'd make an excellent {king/queen} until my time is ripe."), #floris
  ("npc18_kingsupport_1", "You've always been so kind: I think you'd make a fair ruler."),
  ("npc19_kingsupport_1", "I bet you would, especially with me at your side. You would grant me a general pardon for all things I might or might not have done, wouldn't you?"),
  ("npc20_kingsupport_1", "As long as you praise the Heavens, nothing will stand in your way. I think you'd be a fine ruler."),
  ("npc21_kingsupport_1", "As a blueblood myself I can recognize royalty in an instant, and I dare say you are one of the finest I've met."),
  ("npc22_kingsupport_1", "Don't tell me you want to be one of them... But well, maybe you'd do better and be more sensible."),
##Extra companions set 1
#  ("npc23_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc24_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc25_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc26_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc27_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc28_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc29_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc30_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc31_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc32_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc33_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc34_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc35_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc36_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc37_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc38_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc39_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc40_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc41_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc42_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc43_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc44_kingsupport_1", "You'll be a fine {king/queen}."),
##Extra companions set 2
#  ("npc45_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc46_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc47_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc48_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc49_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc50_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc51_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc52_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc53_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc54_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc55_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc56_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc57_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc58_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc59_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc60_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc61_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc62_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc63_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc64_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc65_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc66_kingsupport_1", "You'll be a fine {king/queen}."),
##Extra companions set 3
#  ("npc67_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc68_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc69_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc70_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc71_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc72_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc73_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc74_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc75_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc76_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc77_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc78_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc79_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc80_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc81_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc82_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc83_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc84_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc85_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc86_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc87_kingsupport_1", "You'll be a fine {king/queen}."),
#  ("npc88_kingsupport_1", "You'll be a fine {king/queen}."),
...
# Floris companions
  ("npc17_kingsupport_2", "You'd do well, I'm sure of it. But is the throne really the highest power in these lands? In the time I've been here, travelling from city to city, I had the pleasure of starting new ventures all over Calradia. It begun in Khudan, but quickly spread over the other cities: the Floris King dining halls are now a common sight in every place. If you want real power, you should control the food distribution. Well, I have that now: maybe you can start a monopoly in another kind of venture."), #floris
  ("npc18_kingsupport_2", "I would, my dear {sir/madame}. But when you assume the throne, you also assume the responsibility for all the women in Calradia. How can you be a just king when village elders can murder innocent women? You should know that women are the bearers of all our children, so they shouldn't be mistreated."),
  ("npc19_kingsupport_2", "Of course I'd support you. You'd be able to hold tournaments all year round, with me as winner of course. People will love it if many games will be held."),
  ("npc20_kingsupport_2", "When you keep on saying the morning prayers I taught you, I would go to hell and back for you, {sir/my lady}. I think that many people will agree with me -- a ruler who knows his faith is one worth supporting."),
  ...
  ("npc22_kingsupport_2", "You're really serious, are you? Well, I guess you won't be too bad, so yes, I'd support you. But I can't forget what those nobles did to me. Without a doubt I'm not the only one who has suffered from their wrongdoing. What can we do against them? They do as they please. Only a real king would and could punish them."),
##Extra companions set 1
#  ("npc23_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc24_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc25_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc26_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc27_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc28_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc29_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc30_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc31_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc32_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc33_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc34_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc35_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc36_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc37_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc38_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc39_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc40_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc41_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc42_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc43_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc44_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
##Extra companions set 2
#  ("npc45_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc46_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc47_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc48_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc49_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc50_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc51_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc52_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc53_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc54_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc55_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc56_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc57_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc58_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc59_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc60_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc61_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc62_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc63_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc64_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc65_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc66_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
##Extra companions set 3
#  ("npc67_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc68_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc69_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc70_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc71_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc72_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc73_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc74_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc75_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc76_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc77_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc78_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc79_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc80_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc81_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc82_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc83_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc84_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc85_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc86_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc87_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
#  ("npc88_kingsupport_2", "Of course I'd support you. But would you promise to write all dialogues if you become {king/queen}?"),
...
#Native companions
  ...
  ("npc4_kingsupport_2a", "Of course - let me tell you all about him, my lord."),
...
# Floris companions
  ("npc17_kingsupport_2a", "I'll keep that in mind. But is there a way to use your Floris King shops to my advantage?"), #floris
  ("npc18_kingsupport_2a", "You're absolutely right. If there is any way I can help to sooth the pain of your village..."),
  ("npc19_kingsupport_2a", "Perhaps you're right -- bread and games keep everyone happy."),
  ("npc20_kingsupport_2a", "Of course, and I'll make everyone in the empire do so too."),
...
##Extra companions set 1
#  ("npc23_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc24_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc25_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc26_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc27_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc28_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc29_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc30_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc31_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc32_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc33_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc34_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc35_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc36_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc37_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc38_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc39_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc40_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc41_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc42_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc43_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc44_kingsupport_2a", "Yes, I'll write them all."),
##Extra companions set 2
#  ("npc45_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc46_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc47_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc48_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc49_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc50_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc51_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc52_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc53_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc54_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc55_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc56_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc57_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc58_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc59_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc60_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc61_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc62_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc63_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc64_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc65_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc66_kingsupport_2a", "Yes, I'll write them all."),
##Extra companions set 3
#  ("npc67_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc68_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc69_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc70_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc71_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc72_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc73_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc74_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc75_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc76_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc77_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc78_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc79_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc80_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc81_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc82_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc83_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc84_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc85_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc86_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc87_kingsupport_2a", "Yes, I'll write them all."),
#  ("npc88_kingsupport_2a", "Yes, I'll write them all."),
...
#Native companions
  ...
  ("npc4_kingsupport_2b", "I will have no part of this, my lord."), #rolf
  ...
  ("npc12_kingsupport_2b", "Enough, knave. I will not have you mock our traditions."), #jeremus
...
# Floris companions
  ("npc17_kingsupport_2b", "I'm a warrior, not a merchant. I don't want to hear anymore of this nonsense."), #floris
  ("npc18_kingsupport_2b", "I can't protect all the women in the world, only the ones close to me."),
  ("npc19_kingsupport_2b", "You'd win all tournaments? That would be unfair!"),
...
##Extra companions set 1
#  ("npc23_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc24_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc25_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc26_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc27_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc28_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc29_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc30_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc31_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc32_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc33_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc34_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc35_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc36_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc37_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc38_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc39_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc40_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc41_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc42_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc43_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc44_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
##Extra companions set 2
#  ("npc45_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc46_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc47_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc48_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc49_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc50_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc51_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc52_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc53_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc54_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc55_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc56_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc57_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc58_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc59_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc60_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc61_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc62_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc63_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc64_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc65_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc66_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
##Extra companions set 3
#  ("npc67_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc68_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc69_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc70_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc71_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc72_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc73_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc74_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc75_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc76_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc77_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc78_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc79_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc80_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc81_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc82_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc83_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc84_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc85_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc86_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc87_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
#  ("npc88_kingsupport_2b", "Are you mad? That would mean 'work'. I'm too lazy for that."),
...
# Floris companions
  ("npc17_kingsupport_3", "Of course. If you give me a few weeks, I'll travel to all my shops to give them some specific instructions. Half Calradia eats at my places now, making it the perfect spots for troubadours to sing your praise. Or for the polaroid parchment painters to make pictures of your upcoming glorious rule. And if people keep resisting after that, it will still be possible to poison the food and get rid of the last opposition."), #floris
  ("npc18_kingsupport_3", "I've heard that more women have escaped the grasp of my village elder. If you would dare to let me out of your sight for just a few weeks, I could seek them out and bring them the promise you've made. Word of your kindness will spread throughout all of Calradia."),
  ("npc19_kingsupport_3", "Absolutely! If you could spare me for a few weeks -- I know, it will be hard for you -- I could announce at every village that you'll hold daily tournaments and organise festivities as no-one has seen before."),
  ("npc20_kingsupport_3", "You'd convert all of Calradia to the right religion? You're even more ambitious than me. If you could give me a few weeks, I'll travel among the true believers and spread your word. Everyone will rejoice your coming, and all heathens will convert when you just ride past them."),
  ...
  ("npc22_kingsupport_3", "Finally, captain, we whole hearthily agree. If you'd give me a few weeks, I could spread the story once you'll ascend to the throne, you'll crush the nobility as the scoundrells they are. That should scare them to the bones, making it even easier for you to gain access to the highest power."),
##Extra companions set 1
#  ("npc23_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc24_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc25_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc26_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc27_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc28_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc29_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc30_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc31_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc32_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc33_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc34_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc35_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc36_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc37_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc38_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc39_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc40_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc41_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc42_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc43_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc44_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
##Extra companions set 2
#  ("npc45_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc46_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc47_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc48_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc49_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc50_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc51_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc52_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc53_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc54_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc55_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc56_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc57_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc58_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc59_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc60_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc61_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc62_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc63_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc64_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc65_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc66_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
##Extra companions set 3
#  ("npc67_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc68_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc69_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc70_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc71_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc72_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc73_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc74_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc75_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc76_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc77_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc78_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc79_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc80_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc81_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc82_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc83_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc84_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc85_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc86_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc87_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
#  ("npc88_kingsupport_3", "Great! I'm going to tell all my friends that you'll be writing new dialogues. That will increase your standing."),
...
#Native companions
  ...
  ("npc3_kingsupport_objection", "Captain -- Edwyn has set off on some sort of expedition, which he says that you countenanced. He says that he will go about the villages of this land, telling the poor villagers that once you are {king/queen}, you intend to crush al nobility into oblivion. {Sir/Madame}, I I know Edwyn has suffered great wrongs, but surely you would see that destroying all aristocracy would only lead to chaos, which is bad for trad. There must be a place for sensibility in your kingdom."),
  ...
  ("npc9_kingsupport_objection", "{Sir/Madame} -- it is with great regret that I have learned that you have told Nadia to let all women know that you will free them from any misdoing -- even the peasants. I hope that I am mistaken about this, {sir/madame}, for it goes directly against the ancient right that nobles can do anything they like with peasants -- especially their women. My {lord/lady}, if your future kingdom abolishes ancient rights, then I for one do not look forward to it."), #alayen
...
# Floris companions
  ...
  ("npc19_kingsupport_objection", "Did you just send Ghazwan away to spread the word that you'd help the street urchins to find a place to live and improve their standing in the world? What if they'll think of using the foul play they learned on the street in tournaments, like me? I won't stand a chance anymore! Games would be ruined. It's a bad idea, pretty {boy/face}, I say you so."),
...
##Extra companions set 1
#  ("npc23_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc24_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc25_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc26_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
...
#  ("npc29_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc30_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc31_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc32_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc33_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc34_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc35_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc36_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc37_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc38_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc39_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc40_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc41_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc42_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc43_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc44_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
##Extra companions set 2
#  ("npc45_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc46_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc47_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc48_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc49_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc50_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc51_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc52_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc53_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc54_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc55_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc56_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc57_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc58_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc59_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc60_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc61_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc62_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc63_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc64_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc65_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc66_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
##Extra companions set 3
#  ("npc67_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc68_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc69_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc70_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc71_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc72_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc73_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc74_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc75_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc76_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc77_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc78_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc79_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc80_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc81_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc82_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc83_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc84_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc85_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc86_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc87_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
#  ("npc88_kingsupport_objection", "{Sir/My lady}, I don't like it that you send someone out to promote your writings. I wanted to do that."),
...
# Floris companions
  ("npc17_intel_mission", "Maybe you've heard it by now, but the Dhirim Polygoon Cinema is turning my diaries into a major stage performance. Of course I need to inspect it to see that they don't make too many mistakes. While I'm at it, I can peek a little around in {s17}. People tend to loosen up in the presence of a star."), #floris
  ("npc18_intel_mission", "My dear {sir/madame}, on our travels I learned about a large group of women hiding in {s17}. If you'd dare to let me out of your sight for just a few days, I could ask them if they have news about my village -- maybe even about the {s18}"),
  ("npc19_intel_mission", "Have you heard, pretty {boy/face}? There will be a large tournament held in {s17}. That will be the perfect opportunity to sneak around, ask questions and learn all about the {s18}. If you could give me a few weeks, I can learn almost anything."),
  ("npc20_intel_mission", "{Sir/My lady}, I just learned that a large part of the population of {s17} has converted to the true religion. If you could miss me for a few days, I could travel there and help them set up their foundations. And of course learn more about {s18}."),
  ("npc21_intel_mission", "Now that I'm a grown man, I dare to go back to {s17} and have a chat with all the people who not only helped me on my feet, but also tried to shove me deeper into the dirt. If you want, I could go back and while I'm at it, get information on the whereabouts of the {s18}."),
  ("npc22_intel_mission", "We didn't have a bakery in our small village: I used to bring the wheat to a large bakery in {s17}. If you would allow me, I could go there and ask him some questions. We might be able to learn more about {s18} than we otherwise would."),
##Extra companions set 1
#  ("npc23_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc24_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc25_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc26_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc27_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc28_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc29_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc30_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc31_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc32_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc33_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc34_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc35_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc36_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc37_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc38_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc39_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc40_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc41_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc42_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc43_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc44_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
##Extra companions set 2
#  ("npc45_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc46_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc47_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc48_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc49_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc50_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc51_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc52_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc53_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc54_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc55_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc56_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc57_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc58_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc59_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc60_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc61_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc62_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc63_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc64_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc65_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc66_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
##Extra companions set 3
#  ("npc67_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc68_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc69_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc70_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc71_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc72_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc73_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc74_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc75_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc76_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc77_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc78_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc79_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc80_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc81_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc82_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc83_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc84_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc85_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc86_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc87_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),
#  ("npc88_intel_mission", "If I visit {s17}, I bet I'll learn something about {s18}. You only need to let me go for a few days."),

#Native companions
  ("npc1_fief_acceptance", "You'd make me lord of {s17}, Boss? Well, that would be the kindest thing that anyone has ever done for me in a long time. Heh. I'll make the most of it -- you can count on that. I have to say, though -- I'm not sure how the other lords of this realm will react, when they find old Borcha in their august company, my liege."), #Borcha
  ...
  ("npc3_fief_acceptance", "{My lord/My lady}, it is most generous of you to offer me {s17}. I would be pleased to hold it, and dedicate myself to the moral and material uplift of its inhabitants."), #ymira
  ("npc4_fief_acceptance", "It is good of you to grant me {s17} as a fief -- and most appropriate. Proud indeed is the prince who has a baron of the House of Rolf as {his/her} vassal."), #rolf
  ...
  ("npc6_fief_acceptance", "{My lord/My lady} -- I am surprised that you find me worthy to govern men, as I am just beginning to learn to govern myself. But if you indeed wish it, I would be most honored to hold {s17} in your name, and dedicate myself to the protection of those who live there."), #firentis
  ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and give it a reputation that strikes fear in the hearts of thieves and brigands across Calradia. Thank you, {smy lord/madame}, for this opportunity."), #deshavi
  ...
  ("npc9_fief_acceptance", "{My lord/My lady}, I was cheated of my inheritance -- but now, with this offer of this estate, you make right what was wrong. It would give me the greatest honor to serve you, to fight for you, and to hold this land in fief to you."), #alayen
  ...
  ("npc11_fief_acceptance", "Ay! You'd grant old Katrin a title of nobility? Well, I'd be daft to turn you down, now wouldn't I? My, the strange turns that life takes... Fancy this old bag of bones becoming a great peer of the realm of Calradia, {m'lord/m'lady}."), #katrin
  ...
  ("npc16_fief_acceptance", "Oh, that's most generous of you, {my liege/my lady}. I've been in and out of many a great hall or manor -- not always with the master's permission, I should add -- but I never thought I'd own one myself. Let me think... When I collect my first year's rents, what baubles shall I buy myself?"), #klethi  
# Floris companions
  ("npc17_fief_acceptance", "I knew that it would be wise to stick around with you. {s17} will be a perfect place to coordinate my planned takeover of Calradia. I do hope that there are some really large cellars, since my doomsday device takes up a lot of space. Euhm... I mean, I need a lot of storage space for my Floris King restaurants. Yes, exactly, that's why I need large cellars and preferably a well-rated dungeon. I thank you again, my liege, and know that your generosity will be remembered when... euhm... I open my next restaurant."), #floris 
  ("npc18_fief_acceptance", "You want to give me {s17}? To rule there as I please? My dear {sir/madame}, this will be the perfect opportunity to let those pigs of men pay for all their sins and crimes. I'll turn {s17} into a female paradise, with no men around. Thank you so much for your trust."),
  ("npc19_fief_acceptance", "You're giving me my own place, making me an elder? I'm not that old, you know. But one day I will be and it will be good to have a place of my own.  Where I can safely return to after all the tournaments have been won. I thank you for giving me {s17}."),
  ("npc20_fief_acceptance", "{Sir/My lady}, I'm not worthy of such an honor, But if you really think I should be leading {s17}, I'll do my best to bring them to the right beliefs, and lead them to a golden age of spiritual richness. And anyone who refuses shall meet my sword!"),
  ("npc21_fief_acceptance", "Well thank you, my friend! By giving me {s17}, you put me on the track back into the higher circles. My blue blod will crawl back up from the dirt. You've earned my eternal gratitude by this gesture."),
  ("npc22_fief_acceptance", "Who would have thought that -- me, a simple miller, getting one day his own fief. Captain, this really comes unexpected. I will do my best to lead {s17} in the best way possible, and to honor the simple folk like I used to be, and in my heart still am."),
##Extra companions set 1
#  ("npc23_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc24_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc25_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc26_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
...
#  ("npc29_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc30_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc31_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc32_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc33_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc34_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc35_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc36_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc37_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc38_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc39_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc40_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc41_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc42_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc43_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc44_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
##Extra companions set 2
#  ("npc45_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc46_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc47_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc48_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc49_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc50_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc51_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc52_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc53_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc54_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc55_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc56_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc57_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc58_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc59_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc60_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc61_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc62_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc63_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc64_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc65_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc66_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
##Extra companions set 3
#  ("npc67_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc68_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc69_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc70_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc71_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc72_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc73_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc74_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc75_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc76_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc77_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc78_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc79_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc80_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc81_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc82_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc83_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc84_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc85_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc86_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc87_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
#  ("npc88_fief_acceptance", "You want to give {s17} to me? Thank you! I'll take good care of it."),
...
# Floris companions
  ("npc17_woman_to_woman", "{!}."), #floris
  ("npc18_woman_to_woman", "My dear madame, how harsh can this world be. Your kindness is beyond any borders, and for that alone you should be rewarded. But those pigs -- pardon me, 'men' -- rule with an iron fist and a tight rope, and have women like us hanged on a whim. Don't let me discourage you, for I'm sure they soon won't be able to get around you."), #nadia
  ("npc19_woman_to_woman", "Pretty face, you are not paying enough attention! If it were me in your shoes, I'd be emperor for a long time now. Don't be sad: with the right attitude you'll become a lady in no time."), #odval
  ("npc20_woman_to_woman", "{!}."), #sajjad
  ("npc21_woman_to_woman", "{!}."), #ghazwan
  ("npc22_woman_to_woman", "{!}."), #edwyn
##Extra companions set 1
#  ("npc23_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc24_woman_to_woman", "{!}."),
#  ("npc25_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
...
#  ("npc32_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc33_woman_to_woman", "{!}."),
#  ("npc34_woman_to_woman", "{!}."),
#  ("npc35_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc36_woman_to_woman", "{!}."),
#  ("npc37_woman_to_woman", "{!}."),
#  ("npc38_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc39_woman_to_woman", "{!}."),
#  ("npc40_woman_to_woman", "{!}."),
#  ("npc41_woman_to_woman", "{!}."),
#  ("npc42_woman_to_woman", "{!}."),
#  ("npc43_woman_to_woman", "{!}."),
#  ("npc44_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
##Extra companions set 2
#  ("npc45_woman_to_woman", "{!}."),
#  ("npc46_woman_to_woman", "{!}."),
#  ("npc47_woman_to_woman", "{!}."),
#  ("npc48_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc49_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded.{!}."),
#  ("npc50_woman_to_woman", "{!}."),
#  ("npc51_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc52_woman_to_woman", "{!}."),
#  ("npc53_woman_to_woman", "{!}."),
#  ("npc54_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc55_woman_to_woman", "{!}."),
#  ("npc56_woman_to_woman", "{!}."),
#  ("npc57_woman_to_woman", "{!}."),
#  ("npc58_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc59_woman_to_woman", "{!}."),
#  ("npc60_woman_to_woman", "{!}."),
#  ("npc61_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
...
#  ("npc68_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc69_woman_to_woman", "{!}."),
#  ("npc70_woman_to_woman", "{!}."),
#  ("npc71_woman_to_woman", "{!}."),
#  ("npc72_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc73_woman_to_woman", "{!}."),
#  ("npc74_woman_to_woman", "{!}."),
#  ("npc75_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc76_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc77_woman_to_woman", "{!}."),
#  ("npc78_woman_to_woman", "{!}."),
#  ("npc79_woman_to_woman", "{!}."),
#  ("npc80_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc81_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
#  ("npc82_woman_to_woman", "{!}."),
#  ("npc83_woman_to_woman", "{!}."),
#  ("npc84_woman_to_woman", "{!}."),
#  ("npc85_woman_to_woman", "Come on, you can do it. If you just write enough dialogues, you might be rewarded."),
...
# Floris companions
  ("npc17_turn_against", "I've been waiting for you, {playername}. We meet again, at last. The circle is now complete. When I left you, you paid me. Now I'm the one who'll pay you a lesson, '{my lord/my lady}'."), #floris
  ...
  ("npc19_turn_against", "I'm sorry to see you at the other side of the field, pretty {boy/face}. I've had a great time at your side, but times change. Other people just offered more than you did, so how could I honestly remain in your service? One day you'll know my true value -- if my arrows don't find you first."),
  ...
  ("npc22_turn_against", "Captain, how could you fall for the ways of the aristocracy? I thought better of you. Now we face each other, and you will feel the wrath I intend to loosen upon every noble. But maybe... maybe one day we might discover that this has all been a big misunderstanding. I hope we will laugh at our foolishness by then."),
##Extra companions set 1
#  ("npc23_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc24_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc25_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc26_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc27_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc28_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc29_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc30_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc31_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc32_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc33_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc34_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc35_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc36_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc37_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc38_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc39_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc40_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc41_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc42_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc43_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc44_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
##Extra companions set 2
#  ("npc45_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc46_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc47_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc48_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc49_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc50_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc51_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc52_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc53_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc54_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc55_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc56_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc57_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc58_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc59_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc60_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc61_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc62_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc63_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc64_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc65_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc66_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
##Extra companions set 3
#  ("npc67_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc68_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc69_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc70_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc71_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc72_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc73_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc74_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc75_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc76_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc77_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc78_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc79_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc80_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc81_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc82_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc83_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc84_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc85_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc86_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc87_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
#  ("npc88_turn_against", "You didn't write my dialogues! Now I'm going to punish you."),
...
#Post 0907 changes begin
  ...
  ("battle_won_unfriendly_martial",         "We have had hard harsh words in the past, but for now let us simply enjoy our victory."),
...
#steve post 0912 changes begin
  ...
  ("rhodok_rebellion_pretender_intro",     "I am Lord Kastor, the rightful Doge of the Rhodoks, who will free them from tyranny."),
  ...
  ("rhodok_rebellion_pretender_story_1",   "The Rhodoks are a free people, and not slaves to any hereditary monarch. The doge must be chosen from one of the leading noble families of the land, by a council drawn by lot from the patricians of the cities of Jelkala, Veluca, and Yalen. The council meets on a field before Jelkala, and no man is allowed to appear in arms during their deliberations, on pain of death."),
 ("sarranid_rebellion_pretender_story_1", "I was born in a faraway land, to a humble family, and made a slave when I was but a girl -- but there is no shame in that, for the mothers of many of our kings were slaves. The old Sultan, Ayzar, spotted me in the markets and was struck by my beauty. I entered his household, and there he also learned to respect my intelligence. As he grew older, he allowed me to govern in his stead. First I managed the affairs of the palace, and later those of the realm."),
  ...
  ("rhodok_rebellion_pretender_story_2",   "During the last selection, there were but two candidates, myself, and Lord Graveth. While the council was deliberating, Graveth appeared, sword in hand, telling them that a Swadian raiding party was about to descend on the field of deliberation -- which was true, by the way -- and if he were not elected doge, then he would leave them to their fate."),
 ("sarranid_rebellion_pretender_story_2", "When Sultan Ayzar died, it seemed to the emirs of the realm only natural that I should succeed him as ruler, thus avoiding any danger of civil war. They insisted, however, that I should marry one of his generals, the Emir Baybak. The emirs then lined up to give us the oath of allegiance together -- to Baybak as Commander of the Armies, and to me as Mother of the Realm. For the brief time that we ruled, our realm prospered."),
  ...
  ("rhodok_rebellion_pretender_story_3",   "Well, Graveth defeated the Swadians, and for that, as a Rhodok, I am grateful. When I am doge, I will myself place the wreath of victory on his head. But after that I will have it separated from his shoulders, for by his actions he has shown himself a traitor to the Rhodok confederacy and its sacred custom."),
...
##Floris: Removed this to make it savegame compatible. - Uncommented the line below because it was causing other errors as Diplomacy counts on it being available.
...
UberWiggett^\
Urist^\
Ursca, urtzi, Vermin, Viajero, Vincenzo^\
Vulkan, Warcat92, Welcome_To_Hell, Wheem, Wu-long^\
Yellonet, Yobbo, Yoshi Murasaki, Yoshiboy, Zyconnic^^^\
...
Created by: Monnikje, Caba'drin, Duh, Windyplains^\
Contributors: an anonimous contributor, cmp, lazeras, taragoth, vbigiani^\
Help with coding: cmp, Cruger, Nord_Champion, SPD_Phoenix^\
Additional Troop Trees: Alakeram, effemb, Knight0815, Oddball_E8, pada, Rallix, Shapic^\
Beta testers 2.0: Duh, Gulatr, JS15, Knight0815, Mno^\
Beta testers 2.5: Alakeram, effemb, kefka95, Ikaguia, jayhoffer, Ogrecorps^\
lazeras, Necropolitan13, Njorthrbiartr Olafr, pada, Shapic, Tenser^\
Language corrections by: Lion, Narfi, Robis, Shapic, TehGanker^\
Other corrections by: vbigiani^\
^Authors of the different mods that are bundled in this mod pack:^\
Adorno, Akmar Nibelung, Albertus Magnus, Alex Dragon, AlienSlof^\
Al_Mansur, AlphaDelta, Arch3r, Aquil, Barf^\
beezarandy, Bismarck, Broken_one, Brytenwalda team, Caba'drin^\
Caliph, Captain_Octavius, Cartread, Charan, Checkmaty^\
chukcha, CHUR, CounterPoint391, CptJoker, CryptoCactus^\
Dejawolf, Dindi, drakharios, Duh, Ealabor^\
Eisenhouwer, Faradon, fisheye, Freelancer Team, frell^\
GothicKnight, gutekfiutek, Hanakoganei, Hatonastick, hayalpeREST, hessuu^\
Ibidil, Iboltax, James, Jedediah Q, Jed_Q^\
JethroKirby, Jinnai, jrider, Keedo420, __Khanate__^\
killkhergit, Kinsume, Kovas, kt0, Lav^\
lazeras, leandrojas_, Lor Dric, lucky lancer, Luigi^\
Lycanus Darkbinder, Marcel, MarkQuinn, massimolippi, Maw, Michal^\
Mirathei, Mjollnir, Monnikje, Narf of Picklestink, NaglFaar^\
neil_v, Njiekovic, Njunja, Oddball_E8, Openshaw^\
painbringer, Papa Lazarou, Raz., rejenorst, Renkoo^\
Rosha, RR_Raptor65, rubik, Ruthven, Sayd Uthman^\
Saregona, SendMeSmile, Shaxx, Shredzorz, Silverwolf^\
Smarmellows, Spak, sphere, Talak, taragoth^\
Tempered, Thel, The Mercenary, The Pope, thick1988^\
Topper, TRC, Ubberdorc, Ursca, Utrehd^\
Waihti, wanderer949, Windyplains, Xenoargh, Yamabusi^\
Yiyang Chen, Wulf, Zaitenko, ZIRA, zParsifal^\
^Of course I'd like to thank everyone who has played and commented on this mod pack!^\
^^Special thanks to count Floris IV of Holland (24 June 1210, The Hague, Holland - 19 July 1234, Corbie, France)\
...
#multiplayer game type names
  ...
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of the {s56}.^:{s54} is a vassal of {s55} of the {s56}.^}}Renown: {reg5}. Controversy: {reg15}.^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}"),
...
##diplomacy end+
  ...
  ("reg1shehe_is_prisoner_of_s1", "{reg1?She:He} is prisoner of the {s1}."),
  ("s39_rival", "{s39} (rival)"),
  ("s40", "{!}{s40}"),
...
#  ("faction_title_female_6", "Sayeda {s0}"),
  ...
  ("faction_title_male_2_town", "Knyaz{reg10?-{s61}:} {s0}"),
  ("faction_title_male_2_king", "Velikiy Knyaz {s0}"),
  ...
  ("faction_title_male_5", "Signore{reg10?-{s61}:} {s0}"), # Italian
  ("faction_title_male_5_village", "Barone{reg10?-{s61}:} {s0}"),
  ("faction_title_male_5_castle", "Conte{reg10?-{s61}:} {s0}"),
  ("faction_title_male_5_town", "Patrizio{reg10?-{s61}:} {s0}"),
  ("faction_title_male_5_king", "Doge {s0}"),
  ...
  ("faction_title_female_2_town", "Knyaginya{reg10?-{s61}:} {s0}"),
  ("faction_title_female_2_queen", "Velikiy Knyaginya {s0}"),
  ...
  ("faction_title_female_5", "Signora{reg10?-{s61}:} {s0}"), # Italian
  ("faction_title_female_5_village", "Baronessa{reg10?-{s61}:} {s0}"),
  ("faction_title_female_5_castle", "Contessa{reg10?-{s61}:} {s0}"),
  ("faction_title_female_5_town", "Patrizia{reg10?-{s61}:} {s0}"),
  ("faction_title_female_5_queen", "Dogaressa {s0}"),
  ("faction_title_female_5_unmarried", "Padrona {s0}"),
...
##Floris: Updated from CC 1.321
  ## CC
  ("faction_king_title_1", "King {s0}"), #Floris: Kept the English title
  ("faction_king_title_2", "Velikiy Knyaz {s0}"), #Floris: Changed the title to something more Russian
  ("faction_king_title_3", "{s0} Khan"), #Floris: Kept the Mongolian Khan
  ("faction_king_title_4", "Konung {s0}"), #Floris: Changed the title to a Swedish one
  ("faction_king_title_5", "Doge {s0}"), #Floris: Kept it as King.
  ("faction_king_title_6", "Sultan {s0}"), #Floris: Kept the title Sultan
  ## CC
##
  
  ("faction_title_male_player", "Lord {s0}"),
  ("faction_title_male_1", "Baron {s0}"),
  ("faction_title_male_2", "Boyar {s0}"),
  ("faction_title_male_3", "{s0} Bey"),
  ("faction_title_male_4", "Thegn {s0}"),
  ("faction_title_male_5", "Barone {s0}"), #Floris: Changed to a more Italian name
  ("faction_title_male_6", "Sheik {s0}"),

  ("faction_title_female_player", "Lady {s0}"),
  ("faction_title_female_1", "Lady {s0}"),
  ("faction_title_female_2", "Ledi {s0}"),
  ("faction_title_female_3", "{s0} Hanim"),
  ("faction_title_female_4", "Fru {s0}"), #Floris: Changed from Grevinne to Grevinna, what it should be according to the dictionary.
  ("faction_title_female_5", "Signora {s0}"), #Floris: Changed to a more Italian name
  ("faction_title_female_6", "Sayeda {s0}"),

  ("name_kingdom_text", "What will be the name of your sovereignty?"),
  ("default_kingdom_name", "{s0}'s Barony"),
...
## CC
###################################################################################
# Autoloot			Kept for CC // Possible Conflict // Floris
###################################################################################
	("none", "none"),
...
###################################################################################
  ...
  # names: forest_bandit_leader
  ("bandit_name_10", "Adair"),
  ("bandit_name_11", "Farrell"),
  ("bandit_name_12", "Laurence"),
  ("bandit_name_13", "Tranter"),
  ("bandit_name_14", "Jepson"),
  ("bandit_name_15", "Creighton"),
  ("bandit_name_16", "Boniface"),
  ("bandit_name_17", "Ghyslain"),
  ("bandit_name_18", "Humbert"),
  ("bandit_name_19", "Josse"),
  
  # names: taiga_bandit_leader
  ("bandit_name_20", "Ipati"),
  ("bandit_name_21", "Volya"),
  ("bandit_name_22", "Dimitri"),
  ("bandit_name_23", "Grigory"),
  ("bandit_name_24", "Kliment"),
  ("bandit_name_25", "Matvei"),
  ("bandit_name_26", "Oleg"),
  ("bandit_name_27", "Prokopy"),
  ("bandit_name_28", "Varlam"),
  ("bandit_name_29", "Yuriy"),
  
  # names: steppe_bandit_leader
  ("bandit_name_30", "Batbayar"),
  ("bandit_name_31", "Bat-Erdene"),
  ("bandit_name_32", "Chingis"),
  ("bandit_name_33", "Ganbaatar"),
  ("bandit_name_34", "Ganzorig"),
  ("bandit_name_35", "Naranbaatar"),
  ("bandit_name_36", "Nergui"),
  ("bandit_name_37", "Otgonbayar"),
  ("bandit_name_38", "Tomorbaatar"),
  ("bandit_name_39", "Batukhan"),
  
  # names: sea_raider_leader
  ("bandit_name_40", "Nels"),
  ("bandit_name_41", "Nikolaus"),
  ("bandit_name_42", "Ralf"),
  ("bandit_name_43", "Aleifr"),
  ("bandit_name_44", "Njorthr"),
  ("bandit_name_45", "Orvar"),
  ("bandit_name_46", "Aghi"),
  ("bandit_name_47", "Radulf"),
  ("bandit_name_48", "Hrolfr"),
  ("bandit_name_49", "Sigsteinn"),

  # names: mountain_bandit_leader
  ("bandit_name_50", "Biaggio"),
  ("bandit_name_51", "Celino"),
  ("bandit_name_52", "Fredo"),
  ("bandit_name_53", "Geronimo"),
  ("bandit_name_54", "Guiseppe"),
  ("bandit_name_55", "Raul"),
  ("bandit_name_56", "Saverio"),
  ("bandit_name_57", "Tiziano"),
  ("bandit_name_58", "Lodovico"),
  ("bandit_name_59", "Ippolito"),

  # names: desert_bandit_leader
  ("bandit_name_60", "Khaled"),
  ("bandit_name_61", "Altan"),
  ("bandit_name_62", "Faizel"),
  ("bandit_name_63", "Ilker"),
  ("bandit_name_64", "Jabbar"),
  ("bandit_name_65", "KMucahit"),
  ("bandit_name_66", "Uthman"),
  ("bandit_name_67", "Derya"),
  ("bandit_name_68", "Qamar"),
  ("bandit_name_69", "Savas"),
  
# New in Custom Commander v1.322
