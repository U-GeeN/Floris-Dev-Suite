...
##Narf's transitional armor begin  
  #Note: This is one part of three. You find the other two parts in module_meshes.py and module_items.py.
  ("ar_pla_t6_heraldic", 0, "ar_pla_t6_heraldic_banner_sample", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (cur_tableau_add_mesh, "mesh_ar_pla_t6_heraldic_tableau_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
##Narf's transitional armor end
