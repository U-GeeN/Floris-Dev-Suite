   ...
   [
     ...
     (try_begin),
       ...
       (try_begin),
        (try_begin),
          (eq, ":event", 0), 
            (display_message, "@{s1} has misbehaved, causing unrest in the camp.", 0xFF3333),
            (call_script, "script_change_player_party_morale", -5),
            (troop_get_slot, ":cur_morale", ":lt_with_dispute", slot_troop_lieutenant_morale),
            (val_sub, ":cur_morale", 10), (val_max, ":cur_morale", 0),
            (troop_set_slot, ":lt_with_dispute", slot_troop_lieutenant_morale, ":cur_morale"),
        (else_try),
          (eq, ":event", 1), 
            (display_message, "@{s1} had a dispute with the men over rations.", 0xFF3333),
            (call_script, "script_change_player_party_morale", -4),
            (troop_get_slot, ":cur_morale", ":lt_with_dispute", slot_troop_lieutenant_morale),
            (val_sub, ":cur_morale", 8), (val_max, ":cur_morale", 0),
            (troop_set_slot, ":lt_with_dispute", slot_troop_lieutenant_morale, ":cur_morale"),
        (else_try),
          # Disputes like with lords and companions
          (assign, ":target_lt", -1),
          (try_for_range, ":other_lt", lieutenants_begin, lieutenants_end),
            (neq, ":other_lt", ":lt_with_dispute"),
            (main_party_has_troop, ":other_lt"),
            (assign, ":target_lt", ":other_lt"),
          (try_end),
          (try_begin),
            (gt, ":target_lt", 0),
            (str_store_troop_name, s2, ":target_lt"),
            (display_message, "@{s1} and {s2} are having a heated argument over leadership.", 0xFF3333),
            (troop_set_slot, ":lt_with_dispute", slot_troop_lieutenant_clash_with, ":target_lt"),
            (troop_set_slot, ":target_lt", slot_troop_lieutenant_clash_with, ":lt_with_dispute"),
            # Reduce morale for both
            (troop_get_slot, ":m1", ":lt_with_dispute", slot_troop_lieutenant_morale), (val_sub, ":m1", 15), (val_max, ":m1", 0), (troop_set_slot, ":lt_with_dispute", slot_troop_lieutenant_morale, ":m1"),
            (troop_get_slot, ":m2", ":target_lt", slot_troop_lieutenant_morale), (val_sub, ":m2", 15), (val_max, ":m2", 0), (troop_set_slot, ":target_lt", slot_troop_lieutenant_morale, ":m2"),
          ...
          (else_try),
            ...
            (troop_get_slot, ":m1", ":lt_with_dispute", slot_troop_lieutenant_morale), (val_sub, ":m1", 12), (val_max, ":m1", 0), (troop_set_slot, ":lt_with_dispute", slot_troop_lieutenant_morale, ":m1"),
          (try_end),
        (try_end),
       (try_end),
     (try_end),
