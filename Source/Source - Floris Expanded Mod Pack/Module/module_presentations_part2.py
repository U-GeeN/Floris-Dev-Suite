...
##
      ...
      # lines
      (call_script, "script_prsnt_lines", 585, 2, 125, 285), ##CC 1.324
      (call_script, "script_prsnt_lines", 585, 2, 125, 175), ##CC 1.324
      ...
      (try_for_range, ":i_stack", 0, ":num_stacks"),
        ...
        (create_button_overlay, reg0, "@{s1}", tf_left_align), ##CC 1.324
        (overlay_set_position, reg0, pos1),
