...
("start_game_options", 0,
	"You hear about Calradia, a land torn between rival sovereignties battling each other for supremacy,\
 ...
 and that whatever course you take, great adventures will await you.",
	"none", [],
	[
		("choose_options", [], "Continue...",
			[
    ...
    [
		("continue",[], "Continue...",
		   [
			...
			(party_set_flags, "$current_town", pf_no_label, 0), ## CC 1.322
			# (party_set_flags, "$current_town", pf_always_visible, 1), ## CC 1.321
			## CC
...
# #         (change_screen_return),
      ...
      # ("town_2",[(eq, "$current_startup_quest_phase", 0),],"Join a caravan to Reyvadin, in the Grand Principality of the Vaegirs.",
       # [
      ...
      # ("tutorial_cheat",[(eq,1,0)],"{!}CHEAT!",
       # [
         ...
         # (troop_raise_skill, "trp_player", skl_inventory_management, 10),
			# ##Floris MTT begin
			# (troop_get_slot,":swadian_baron_mineures","$troop_trees",slot_swadian_baron_mineures),
			# (party_add_members, "p_main_party", ":swadian_baron_mineures", 10),
			# (troop_get_slot,":swadian_retinue_longbowman","$troop_trees",slot_swadian_retinue_longbowman),
			# (party_add_members, "p_main_party", ":swadian_retinue_longbowman", 10),
			# (troop_get_slot,":vaegir_bogatyr","$troop_trees",slot_vaegir_bogatyr),
			# (party_add_members, "p_main_party", ":vaegir_bogatyr", 10),
			# (troop_get_slot,":vaegir_sokoliniy_glaz","$troop_trees",slot_vaegir_sokoliniy_glaz),
			# (party_add_members, "p_main_party", ":vaegir_sokoliniy_glaz", 10),
			# (troop_get_slot,":khergit_cherbi","$troop_trees",slot_khergit_cherbi),
			# (party_add_members, "p_main_party", ":khergit_cherbi", 10),
			# (troop_get_slot,":khergit_mandugai","$troop_trees",slot_khergit_mandugai),
			# (party_add_members, "p_main_party", ":khergit_mandugai", 10),
			# (troop_get_slot,":nord_aetheling","$troop_trees",slot_nord_aetheling),
			# (party_add_members, "p_main_party", ":nord_aetheling", 10),
			# (troop_get_slot,":nord_vaeringi","$troop_trees",slot_nord_vaeringi),
			# (party_add_members, "p_main_party", ":nord_vaeringi", 10),
			# (troop_get_slot,":rhodok_condottiero","$troop_trees",slot_rhodok_condottiero),
			# (party_add_members, "p_main_party", ":rhodok_condottiero", 10),
			# (troop_get_slot,":rhodok_condottiero_d_assedio","$troop_trees",slot_rhodok_condottiero_d_assedio),
			# (party_add_members, "p_main_party", ":rhodok_condottiero_d_assedio", 10),
			# (troop_get_slot,":sarranid_hasham","$troop_trees",slot_sarranid_hasham),
			# (party_add_members, "p_main_party", ":sarranid_hasham", 10),
			# (troop_get_slot,":sarranid_iqta_dar","$troop_trees",slot_sarranid_iqta_dar),
			# (party_add_members, "p_main_party", ":sarranid_iqta_dar", 10),
			# ##Floris MTT end
         # (troop_add_item, "trp_player","itm_ar_swa_ban_scale_a",0),
         # (troop_add_item, "trp_player","itm_he_swa_t6_full_a",0),
         
         # (troop_add_item, "trp_player","itm_we_khe_spear_nagita",0),
         # (troop_add_item, "trp_player","itm_we_khe_spear_viper",0),
         # (troop_add_item, "trp_player","itm_we_swa_blunt_morningstar",0),
         ...
         # (troop_add_item, "trp_player","itm_we_rho_spear_fork_pitch",0),
         # (troop_add_item, "trp_player","itm_we_rho_spear_fork_military",0),
         # (troop_add_item, "trp_player","itm_we_rho_spear_fork_battle",0),
         # (troop_add_item, "trp_player","itm_we_swa_spear_boar",0),
         # (troop_add_item, "trp_player","itm_we_swa_spear_lance_jousting",0),
         # (troop_add_item, "trp_player","itm_we_vae_spear_lance",0),
         # (troop_add_item, "trp_player","itm_we_swa_spear_glaive",0),
         # (troop_add_item, "trp_player","itm_we_nor_spear_sviar",0),
         # (troop_add_item, "trp_player","itm_we_vae_spear_scythe_military",0),
         # (troop_add_item, "trp_player","itm_we_sar_spear_staff",0),
         # (troop_add_item, "trp_player","itm_we_sar_spear_staff_quarter",0),
         # (troop_add_item, "trp_player","itm_we_sar_spear_staff_iron",0),
         # (troop_add_item, "trp_player","itm_we_khe_spear_nagita",0),
         # (troop_add_item, "trp_player","itm_we_khe_spear_viper",0),
         # (troop_add_item, "trp_player","itm_we_khe_spear_haftedblade",0),
         # (troop_add_item, "trp_player","itm_we_vae_spear_scythe_military",0),
         # (troop_add_item, "trp_player","itm_we_swa_spear_lance_light",0),
         # (troop_add_item, "trp_player","itm_we_vae_spear_lance",0),
         # (troop_add_item, "trp_player","itm_we_swa_spear_lance_heavy",0),
         # (troop_add_item, "trp_player","itm_we_swa_spear_lance_great",0),
         # (troop_add_item, "trp_player","itm_we_rho_spear_mountain",0),
         # (troop_add_item, "trp_player","itm_we_rho_spear_large",0),
         # (troop_add_item, "trp_player","itm_we_rho_spear_phalanx",0),
         # (troop_add_item, "trp_player","itm_we_nor_axe_throw_vendelox",0),
         # (troop_add_item, "trp_player","itm_we_sar_spear_javelin",0),
         # (troop_add_item, "trp_player","itm_we_sar_spear_jarid",0),
         
         # (troop_add_item, "trp_player","itm_we_nor_axe_danelong",0),		 
...
##      ]),
      ...
      [
        ...
        (troop_clear_inventory, "$g_player_troop"),
        (troop_add_item, "$g_player_troop","itm_ar_vae_t4_jerkin_a",0),
  ...
  ("reports",0,
   "Hardcoded Menu - Skipped to Presentation", ## Floris
   "none",
   [
   	(try_begin),
		(party_slot_eq, "p_main_party", slot_screen_state, 0),
		...
		(str_store_string, s11, "@Character Renown: {reg5}^Honor Rating: {reg6}^Force Morale: {reg8}^Force Size Limit: {reg7}^^Next pay day:{s1}"),
		#(display_message, "@Called {s11}"),
		(start_presentation, "prsnt_reports"),
	(else_try),
		(party_slot_eq, "p_main_party", slot_screen_state, 1),
		(party_set_slot, "p_main_party", slot_screen_state, 0),
		(change_screen_return),
	(try_end),
  ...
  ("detachment_config", 0,
   "Configure the detachment parameters.^Objective: {s1}^Target: {s2}^Duration: {s11}^Leader: {s3}^^Select a parameter to change or proceed to assign troops.",
   "none",
   [
     (try_begin),
     ...
     (try_begin),
       (eq, "$g_detachment_duration", 0),
       (str_store_string, s11, "@Unlimited"),
     (else_try),
       (str_store_string, s11, "@{reg1} hours"),
     (try_end),
   ...
   [
     ...
     ("detachment_config_proceed", 
      ...
      [
        ...
        (assign, "$g_detachment_buffer_party", reg0),
        (assign, "$g_move_heroes", 1),
        (party_set_name, "$g_detachment_buffer_party", "@Detachment Personnel"),
        (party_set_slot, "$g_detachment_buffer_party", slot_party_type, spt_player_detachment),
        (store_faction_of_party, ":player_fac", "p_main_party"),
        (party_set_faction, "$g_detachment_buffer_party", ":player_fac"),
        (party_set_flags, "$g_detachment_buffer_party", pf_show_faction|pf_default_behavior, 1),
        (party_add_members, "$g_detachment_buffer_party", "$g_detachment_leader", 1),
        (party_remove_members, "p_main_party", "$g_detachment_leader", 1),
        (change_screen_give_members, "$g_detachment_buffer_party"),
      ]),
...
# relocated to prsnt_reports

### REPORTS - REFERENCE MENU - END ###

### REPORTS - KINGDOM MENU - BEGIN ###

# relocated to prsnt_reports

### REPORTS - KINGDOM MENU - END ###

### REPORTS - PERSONAL MENU - BEGIN ###

# Relocated to prsnt_reports

### REPORTS - PERSONAL MENU - END ###

### REPORTS - CHEAT MENU - BEGIN ###
	("cheat_reports",0,
	"Cheat Menu Reports",
	...
	],"{!}CHEAT! - increase your relation with last talktroop {s14}",
       [
...
### REPORTS - CHEAT MENU - END ###

### REPORTS - PARTY MENU - BEGIN ###

# relocated to prsnt_reports

### REPORTS - PARTY MENU - END ###
...
#             (start_presentation, "prsnt_custom_banner"),
  ...
  (
	...
	# relocated to prsnt_reports, calculations done in script initialize_reports
  ...
  ("lord_relations",0,
   ...
   [
	...
	# relocated to prsnt_reports , calculations in script initialize_reports
...
#         (faction_set_slot, "$g_cheat_selected_faction", slot_faction_last_offensive_concluded, ":cur_hours"), ##1.132, apparently it is nowhere defined. My bug
         (faction_set_slot, "$g_cheat_selected_faction", slot_faction_ai_last_offensive_time, ":cur_hours"), ##1.131
      ...
      ("faction_orders_increase_time", [],"{!}Increase last offensive time by 24 hours.",
       [
#         (faction_get_slot, ":faction_ai_last_offensive_time", "$g_cheat_selected_faction", slot_faction_ai_last_offensive_concluded), ##1.132, apparently it is nowhere defined. My bug
         (faction_get_slot, ":faction_ai_last_offensive_time", "$g_cheat_selected_faction", slot_faction_ai_last_offensive_time), ##1.131
         (val_sub, ":faction_ai_last_offensive_time", 24),
#         (faction_set_slot, "$g_cheat_selected_faction", slot_faction_ai_last_offensive_concluded, ":faction_ai_last_offensive_time"), ##1.132, apparently it is nowhere defined. My bug
         (faction_set_slot, "$g_cheat_selected_faction", slot_faction_ai_last_offensive_time, ":faction_ai_last_offensive_time"), ##1.131
         (jump_to_menu, "mnu_faction_orders"),
        ]
       ),
...
##Floris: Changed by Caba'drin to display the bonus for the player troop size in case you are King, Marshall and/or hold fiefs.
...
## 
  ...
  ("faction_relations_report",0,
   ...
   [(str_clear, s2),
    ...
    (try_end),
    (str_store_string, s1, "@Your relation with the sovereignties are:^{s2}"),
    ...
    ("camp_manage_inventory",
      ...
      [
        ...
        (try_for_range, ":i_stack", 0, ":num_stacks"),
          ...
          (call_script, "script_transfer_inventory", ":this_hero", "trp_temp_troop", 0),
        (try_end),
   ...
   [
    ...
    [
      ...
      ("camp_cheat_1",[],"{!}Increase player renown.",
       [
         (str_store_string, s1, "@Your renown has increased by 100. "),
         (call_script, "script_change_troop_renown", "trp_player", 100),
         (jump_to_menu, "mnu_camp_cheat"),
        ]
       ),
	   
      ("camp_cheat_2",[],"{!}Increase player honor.",#Diplomacy 3.2   
       [
      ...
      ("camp_cheat_3",[],"{!}Update political notes.",#Diplomacy 3.2
       [
      ...
      ("camp_cheat_4",[],"{!}Update troop notes.",#Diplomacy 3.2
       [
         (try_for_range, ":hero", active_npcs_begin, active_npcs_end),
           (troop_slot_eq, ":hero", slot_troop_occupation, slto_kingdom_hero),
      ...
      ("camp_cheat_5",[],"{!}Scramble minstrels.",#Diplomacy 3.2
       [
         (call_script, "script_update_tavern_minstrels"),
        ]
       ),	   
	   
      ("camp_cheat_6",[],"{!}Infinite camp",#Diplomacy 3.2
       [
         (assign,"$g_camp_mode", 1),
      ...
      ("camp_lieutenant_promote",
       [
         ...
         (try_for_range, ":lslot", lieutenants_begin, lieutenants_end),
           (eq, ":free_slot", -1),
           (neg|main_party_has_troop, ":lslot"),
...
#Tempered Changes Begin added cheat menu items  DEBUG
...
#Tempered changes end
      ...
      # ("action_redefine_keys",[],"Redefine keys for custom camera.",
       # [
        ...
        # ]
       # ),
      ("action_modify_factions_color",[],"Re-dye your map.",
       [
          (assign, "$temp", 8),
          (start_presentation, "prsnt_change_all_factions_color"),
        ]
       ),
      ("action_export_import",[],"Export or import character history.",
        [
          (assign, "$g_player_troop", "trp_player"),
      ...
      ("camp_recruit_prisoners_accept",[(gt, "$g_prisoner_recruit_troop_id", 0)],"Take them.",
       [(remove_troops_from_prisoners, "$g_prisoner_recruit_troop_id", "$g_prisoner_recruit_size"),
        ...
        (try_begin),
          ...
          (is_between, ":troop_faction", kingdoms_begin, kingdoms_end), #Player Faction
   ...
   ### Check it ###
    ...
    [
      ("action_read_book_"+str(x+1),
        ...
        ]) for x in range(0, itm_book_spotting_reference - itm_book_tactics) #itm_book_wound_treatment_reference - itm_book_tactics) #Floris 2.54 bugfix
    ]+[
...
#TEMPERED CHANGES END
        ...
        (try_begin),
          ...
          (try_begin),
			...
			(neg|is_between, ":template_id", "pt_looters", "pt_merchant_caravan"), #Floris - Prevent bandits from being friends due to join any side script.
...
#          (try_end),
        ...
        (else_try),
		##Floris MTT begin
			(this_or_next|eq, "$g_encountered_party_template", "pt_taiga_bandits"),
			(this_or_next|eq, "$g_encountered_party_template", "pt_taiga_bandits_r"),
...
###Troop commentary changes end          
  ...
  (
    ...
    "Your soldiers prepare to attack the enemy.",
    "none",
    [],
    [
    ...
    [
     (try_begin),
       ...
       (try_begin),  
         ...
         (party_get_template_id, ":encountered_party_template", "$g_encountered_party"),
		##Floris MTT begin
			(this_or_next|eq, ":encountered_party_template", "pt_kingdom_caravan_party"),   
			(this_or_next|eq, ":encountered_party_template", "pt_kingdom_caravan_party_r"),   
			(eq, ":encountered_party_template", "pt_kingdom_caravan_party_e"),   
		##Floris MTT end               
       ...
       (try_begin),
         ...
         (party_stack_get_troop_id, ":stack_troop", "$g_enemy_party", 0),
				...
				(eq, ":stack_troop", ":bandit_mountain"),
				##Floris MTT end
          ...
          (else_try),  
            ...
            ##diplomacy end
              ...
              (else_try), #player took a walled center for player's kingdom
                ...
                ##Floris MTT begin
				(party_template_get_slot,":swadian_retinue_longbowman","$troop_trees",slot_swadian_retinue_longbowman),
                (assign, ":best_troop", ":swadian_retinue_longbowman"),
				##Floris MTT end
				...
				(try_begin),
				   ...
				   (neg|is_between, "$players_kingdom", npc_kingdoms_begin, npc_kingdoms_end),
				##Floris MTT begin
				(party_template_get_slot,":mercenary_armbrust_soldner","$troop_trees",slot_mercenary_armbrust_soldner),
				   (assign, ":best_troop", ":mercenary_armbrust_soldner"),#<- while we're at it, use a mercenary default
				##Floris MTT end
  ...
  (
    ...
    [	
	  ...
	  # ("pre_join_help_attackers",[ 
		 ...
		 # (try_end),
		 # # FLORIS 2.5: Windy-
# #LAZERAS MODIFIED  {Join any Side}
# #          (ge, ":attacker_relation", 0),
# #          (lt, ":defender_relation", 0),
# #LAZERAS MODIFIED  {Join any Side}
          # ],
...
# #LAZERAS MODIFIED  {Join any Side}
  ...
  (
    "join_battle",mnf_enable_hot_keys, ## CC
    "You are helping the {s2} against the {s1}. You have {reg10} troops fit for battle against the enemy's {reg11}. {s4}", ## Floris adds {s4}.
    "none",
    [                
...
##          (ge,reg(5),20),
    ...
    #+Freelancer    
      ("join_leave",[ #(neq, "$freelancer_state", 1), #+freelancer
		],"Leave.",
      [
        (try_begin),
           (neg|troop_is_wounded, "$g_player_troop"), ## CC
...
#      (assign, ":enemy_party_strength_for_p", ":enemy_party_strength"), ##1.131, three lines
#      (val_mul, ":enemy_party_strength_for_p", ":player_party_strength"),
#      (val_div, ":enemy_party_strength_for_p", ":friend_party_strength"), ##
...
# Towns
  (
    ...
    "none",
    [(reset_price_rates,0),(set_price_rate_for_item,"itm_trade_tools",70),(set_price_rate_for_item,"itm_trade_salt",140)],
    [
...
#      ("zendar_leave",[],"Leave town.",[[leave_encounter],[change_screen_return]]),
  ...
  (
    ...
    "none",
    [(reset_price_rates,0),(set_price_rate_for_item,"itm_trade_salt",55)],
    [
...
##  ),
  ...
  (
    "besiegers_camp_with_allies",mnf_enable_hot_keys, ## CC
    "{s1} remains under siege. The banners of the {s2} fly above the camp of the besiegers,\
 where you and your men are welcomed. {s4}", ## Floris adds {s4}.
    "none",
    [        
        (str_store_party_name, s1, "$g_encountered_party"),
        (str_store_party_name, s2, "$g_encountered_party_2"),
...
##          (jump_to_menu, "mnu_total_victory"),
    ...
    [
	 ...
	 ("join_siege_with_allies",[(neg|troop_is_wounded, "$g_player_troop")], "Join the next assault.",
       [
           (assign, "$g_joined_battle_to_help", 1), 
           (party_set_next_battle_simulation_time, "$g_encountered_party", -1),
           (try_begin),
...
#          (assign, "$waiting_for_arena_fight_result", 0),
          ...
          (try_begin),
				...
				(party_slot_eq, "$g_encountered_party", slot_village_infested_by_bandits, ":woman_peasant"),
				##Floris MTT end
            (assign, "$encountered_party_hostile", 1),
            (assign,"$entry_to_town_forbidden",1),            
          (try_end),
      ...
      ("castle_start_siege",
       [
           ##diplomacy begin
				##Floris MTT begin
				(troop_get_slot,":woman_peasant","$troop_trees",slot_woman_peasant),
				(neg|party_slot_eq, "$g_encountered_party", slot_village_infested_by_bandits, ":woman_peasant"),
				##Floris MTT end
           ##diplomacy end 
           ...
           (lt, ":reln", 1),#Tempered changed from 0 to allow attacking neutral castles
           (lt, "$g_encountered_party_2", 1),
           (call_script, "script_party_count_fit_for_battle","p_main_party"),
           (gt, reg(0), 5),
           (try_begin),
...
#                                                       (set_jump_mission,"mt_town_default"),
 ...
 and the guard sergeant informs you that his men will fire if you attempt to come any closer.",
  ...
  (
   ...
   (
    "castle_besiege",mnf_enable_hot_keys|mnf_scale_picture, ## CC
    "You are laying siege to {s1}. {s2} {s3} {s4} ^{s15}", ## Floris adds {s4}, tempered ^{s15}.
    "none",
    [
		  ##diplomacy start+ test gender with script
        #(troop_get_type, ":is_female", "trp_player"),#<- replaced
...
#Tempered   note add new siege methods here			
            (try_begin),
              (eq, "$g_siege_method", 1),
          ...
          (try_end),
        (try_end),
#Tempered added siege camp comment
...
#Tempered changes end
        ...
        (else_try),
          ...
          (this_or_next|eq, ":enemy_finished", 1),
          (eq, "$g_enemy_surrenders", 1),
		  (party_set_slot,"p_main_party",slot_party_siege_camp,0), #Tempered added for siege camp
...
#Tempered begin changes for siege camp
		("siege_camp",[	(party_slot_eq,"p_main_party",slot_party_siege_camp,0),(player_has_item,"itm_trade_tools"),
		...
		("siege_camp_interupted",[(party_slot_eq,"p_main_party",slot_party_siege_camp,-1),(player_has_item,"itm_trade_tools"),],"Continue to entrench your position",
					[	(assign,"$auto_besiege_town","$g_encountered_party"),
						(assign, "$g_siege_force_wait", 1),
...
##           (set_battle_advantage, reg0),
  ...
  (
    "construct_ladders",0,
    "As the most architecturally learned avatar of your company, ({reg2}), {reg3?you estimate:{s3} estimates} that it will take\
 {reg4} hours to build enough scaling ladders for the assault.",
  ...
  (
    ...
    "As the most architecturally learned avatar of your company, ({reg2}), {reg3?you estimate:{s3} estimates} that building a siege tower will take\
 {reg4} hours.",
    "none",
    [(call_script, "script_get_max_skill_of_player_party", "skl_engineer"),
     (assign, ":max_skill", reg0),
...
##        (display_message, "@{!}enemy_party={reg3} ally_party={reg4}"),
        ...
        (else_try),
          ...
          (val_div, ":enemy_party_strength_for_p", ":friend_party_strength"),
        (try_end), ##
#        (assign, ":enemy_party_strength_for_p", ":enemy_party_strength"), ##1.131, four lines
#        (val_mul, ":enemy_party_strength_for_p", ":player_party_strength"),
#        (val_div, ":enemy_party_strength_for_p", ":friend_party_strength"),
#        (val_sub, ":enemy_party_strength", ":enemy_party_strength_for_p"), ##


        (val_sub, ":enemy_party_strength", ":enemy_party_strength_for_p"), ##1.132, new line
        (inflict_casualties_to_party_group, "p_main_party", ":enemy_party_strength_for_p", "p_temp_casualties"),
        (call_script, "script_print_casualties_to_s0", "p_temp_casualties", 0),
        (str_store_string_reg, s8, s0),
...
##diplomacy end+
  ...
  (
    "leave_faction",0,
    "Renouncing your oath is a grave act. Your liege may condemn you and confiscate your lands and holdings.\
...
##  ),
  ...
  (
    "siege_started_defender",mnf_enable_hot_keys, ## CC
    "{s1} is launching an assault against the walls of {s2}. You have {reg10} troops fit for battle against the enemy's {reg11}. Your force's current commander is {s5}. You decide to... {s4}", ## PreBattle Orders & Deployment adds {s4} ## Floris adds {s5}.
    "none",
    [
        (select_enemy,1),
        (assign, "$g_enemy_party", "$g_encountered_party_2"),
  ...
  ##            (lt, ":min_enemy_str", "$g_friend_fit_for_battle"),
		...
		## CC for Floris
		(str_store_troop_name,s5,"$g_player_troop"),
        (set_player_troop, "$g_player_troop"),
		## CC for Floris
        ],
    [
  ...
  (
    ...
    [
	  ...
	  ##diplomacy end+
        ...
        (faction_get_slot, ":faction_leader", "fac_player_supporters_faction", slot_faction_leader),
        (eq, ":faction_leader", "trp_player"),
        (str_store_string, s10, "@As you approach, you are spotted by the castle guards, who welcome you and open the gates for their sovereign."),
      (else_try),  
        ...
        (try_begin),
          ...
          (assign, "$g_ally_party", -1), #new, no known enemy party while saving village from bandits dfdf
				...
				(try_begin),
					...
					(eq, ":bandit_troop", ":bandit_forest"),
					(set_background_mesh, "mesh_pic_forest_bandits"),
				(else_try),
					(troop_get_slot,":bandit_steppe","$troop_trees",slot_bandit_steppe),
					(eq, ":bandit_troop", ":bandit_steppe"),
					(set_background_mesh, "mesh_pic_steppe_bandits"),
				(else_try),
					(troop_get_slot,":bandit_taiga","$troop_trees",slot_bandit_taiga),
					(eq, ":bandit_troop", ":bandit_taiga"),
					(set_background_mesh, "mesh_pic_steppe_bandits"),
				(else_try),
					(troop_get_slot,":bandit_mountain","$troop_trees",slot_bandit_mountain),
					(eq, ":bandit_troop", ":bandit_mountain"),
					(set_background_mesh, "mesh_pic_mountain_bandits"),
				(else_try),
					(troop_get_slot,":bandit_sea_raider","$troop_trees",slot_bandit_sea_raider),
					(eq, ":bandit_troop", ":bandit_sea_raider"),
					(set_background_mesh, "mesh_pic_sea_raiders"),
				(else_try),
				##diplmacy begin
					(troop_get_slot,":woman_peasant","$troop_trees",slot_woman_peasant),
					(eq, ":bandit_troop", ":woman_peasant"),
...
#LAZERAS MODIFIED  {forced recruits}
      ...
      ("village_center",[(neg|party_slot_eq, "$current_town", slot_village_state, svs_looted),
       ...
       [
         ...
         (else_try),
		   ...
		   #Floris STAT Troops
		   	(try_begin),
				...
				(ge, ":chance", 0),
				(party_get_slot, ":troop_no", "$current_town", slot_center_specialist_type),
			   (set_visitor, 11, ":troop_no"),
			(try_end),		   
		   # Floris stat end
		...
		#Custom troops master hired // at village
        (try_begin),
		  (party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
...
##diplomacy end+
      ("village_attack_bandits",[
        ...
        ##diplomacy begin
				##Floris MTT begin
				(troop_get_slot,":woman_peasant","$troop_trees",slot_woman_peasant),
				(neg|party_slot_eq, "$current_town", slot_village_infested_by_bandits, ":woman_peasant"),
				##Floris MTT end
        ##diplmacy end
        ],
       "Attack the bandits.",
       [(party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_bandits),
        ...
        (set_visitors, 0, ":bandit_troop", "$qst_eliminate_bandits_infesting_village_num_bandits"),
				...
				(set_visitors, 2, ":mercenary_farmer", "$qst_eliminate_bandits_infesting_village_num_villagers"),
				##Floris MTT end
        (set_party_battle_mode),
      ...
      ("dplmc_village_counter_insurgency",[
				##Floris MTT begin
				(troop_get_slot,":woman_peasant","$troop_trees",slot_woman_peasant),
				(party_slot_eq, "$current_town", slot_village_infested_by_bandits, ":woman_peasant"),
				##Floris MTT end
        ],
...
#           (party_add_template, "$current_town", "pt_villagers_in_raid"),
  ...
  #Duh Forced Recruit
	...
	("forced_recruits", 
		[
		(party_slot_eq, "$current_town", slot_center_recruits, 0),
		],
...
(
   ...
   #Lazeras MODIFIED (Training Yard)
	    ...
	    (try_begin),
		    (gt, ":volunteer_amount", 1), #CABA - 2.52 bugfix
			...
			(try_end),   
			 ...
			 (assign, reg3, ":volunteer_amount_new"), 
			 (assign, reg4, ":upgrade_troop"), 
			 (str_store_troop_name_by_count, s4, ":upgrade_troop", ":volunteer_amount_new"),
		(try_end),
	    (try_begin),
   #Lazeras MODIFIED (Training Yard)
		  ...
		  (else_try),
			  (try_begin),
				 (gt, ":volunteer_amount_new", 0),
				 (str_store_string, s18, "@{reg5} {s3} volunteer to follow you, as well as {reg3} barracks-trained {s4}."), #CABA - 2.52 bugfix
			  (else_try),
...
#Lazeras MODIFIED (Training Yard)
      ("center_build_barracks",[(eq, reg6, 0),
       ...
       "Build Barracks.",[(assign, "$g_improvement_type", slot_center_has_barracks),
                                  (jump_to_menu, "mnu_center_improve"),]),
#Lazeras MODIFIED (Training Yard)
  ...
  (
    "center_improve",0,
    "{s19} As the most architecturally learned avatar of your company, ({reg2}), {reg3?you reckon:{s3} reckons} that building the {s4} will cost you\
...
#      (call_script, "script_loot_player_items", 0),
 ...
 Or perhaps, it was given to them by someone who wanted to arrange a suitable ending to your life.",
   ...
   (
    ...
    "As the most skilled pilferer of your company, ({reg2}), {reg3?you reckon:{s1} reckons} that you can steal as many as {reg4} heads of village's cattle.",
    "none",
    [
    ...
    [
      ("village_loot",[], "Plunder the village, then raze it.",
       [
          ...
          (rest_for_hours_interactive, 3, 5, 1), ##Floris - change to interactive to allow player to cancel; #rest while attackable (3 hours will be extended by the trigger)
          (change_screen_return),
           ]),
      ("village_raid_leave",[],"Leave this village alone.",[(change_screen_return)]),
    ],
...
#NPC companion changes end
    ...
    [
      ("continue",[], "Continue...",
       [
		  ...
		  #begin of changes																					Port 1.143 // Overhaul
          ...
          (try_for_range, ":cur_goods", trade_goods_begin, trade_goods_end),
			...
			(val_max, ":total_probability", 1), #Floris div by 0 bugfix
          ...
          (troop_add_merchandise,"trp_temp_troop",itp_type_goods,30),					#	End (Overhaul)
          (troop_sort_inventory, "trp_temp_troop"),
          (change_screen_loot, "trp_temp_troop"),
        ]),
    ],
  ...
  (
    ...
    [],
    [
      ("disembark_yes",[],"Yes.",[ (rest_for_hours_interactive, 3, 5, 1), ##Floris - change to interactive to allow player to cancel; #rest while attackable (3 hours will be extended by the trigger)
                              (change_screen_return),
                              ]),
...
## CC 1.322: this was one line, but has turned into this better multiple-line overview.
      ("join_tournament", 
        [
          (neg|is_currently_night),
          (party_slot_ge, "$current_town", slot_town_has_tournament, 1),
...
## CC
       ,"Join the tournament.",
       [
           # TPE+ 1.3 - Hook inserted to switch to TPE tournament system if activated or stay with native if disabled.
		   (try_begin),
      ...
      "Take a walk around the streets.",
       [
         ...
         (else_try),
           ...
           (else_try),
				##Floris MTT begin
				(troop_get_slot,":vaegir_kazak","$troop_trees",slot_vaegir_kazak),
				(assign,reg0,":vaegir_kazak"),
				(troop_get_slot,":vaegir_grid","$troop_trees",slot_vaegir_grid),
				(assign,reg1,":vaegir_grid"),
				(troop_get_slot,":vaegir_kmet","$troop_trees",slot_vaegir_kmet),
				(assign,reg2,":vaegir_kmet"),
				(troop_get_slot,":vaegir_mladshiy_druzhinnik","$troop_trees",slot_vaegir_mladshiy_druzhinnik),
				(assign,reg3,":vaegir_mladshiy_druzhinnik"),
				##Floris MTT end
           (try_end),
           (shuffle_range,0,4),
		   ...
		   #Floris Special troops added to town scenes
		   #STAT
			...
			(try_begin),
				...
				(ge, ":chance", 0),
				(party_get_slot, ":troop_no", "$current_town", slot_center_specialist_type),
				(store_random_in_range, ":entry", 9, 12),
...
##Floris: Upcated from CC 1.321
            ## CC starting merchant
             (try_begin),
...
##
			...
			(try_begin),																					#Custom Troops // Custom Master
				(neg|troop_slot_eq, "trp_custom_master", slot_troop_state, 1),
				(troop_slot_eq, "trp_custom_master", slot_troop_cur_center, "$current_town"),
				(set_visitor, ":cur_entry", "trp_custom_master"),
				(val_add, ":cur_entry", 1),
            (try_end),																						#End
...
##Floris: This block of code was making duplicate merchants appear in taverns. Fix by Caba'drin.             
#             (try_begin),
#               (eq, "$g_starting_town", "$current_town"),
#                              
#               (this_or_next|neg|check_quest_finished, "qst_collect_men"),
...
##             
             ## CC NPCs
##Floris: This block of code was making duplicate npc's appear in taverns. Fix by Caba'drin.
#             (try_for_range, ":companion_candidate", companions_begin, companions_end),
#               (troop_slot_eq, ":companion_candidate", slot_troop_occupation, 0),
#               (troop_slot_eq, ":companion_candidate", slot_troop_cur_center, "$current_town"),
#               (neg|troop_slot_ge, ":companion_candidate", slot_troop_prisoner_of_party, centers_begin),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       [
           ...
           (else_try),
			 ...
			 (set_visitor, 44, ":mercenary_armbrust_komtur"),
				##Floris MTT end
             (set_jump_entry, 50),
       ...
       [
         ...
         (else_try),                   
           ...
           (set_visitor, 24, ":troop_prison_guard"),
			...
			#Floris Stat for Castles / Currently only spawns scouts
			(try_begin),
				(store_random_in_range, ":chance", 0, 100),
				(ge, ":chance", 0),
				(party_get_slot, ":troop_no", "$current_town", slot_center_specialist_type),
				(set_visitor, 24, ":troop_no"),
			(try_end),
			#Floris End
	...
	(assign, "$love_interest_in_town_7", 0), ##1.132, two new lines
...
##Floris: Meeting with the Guild Master is also down in the code, so I remove this one.
#      ## CC
...
##
      ...
      [
        ...
        (try_begin),
          (neg|party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
		  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse), ##1.132, two new lines
...
#Floris End	
      ...
      [
        (assign, "$g_permitted_to_center",0),
        ## CC
        (change_screen_return,0), ## CC 1.322 new line
        (party_slot_eq,"$current_town",slot_party_type, spt_town), ## CC 1.322 new line
        (try_begin),
          (eq, "$g_buy_foods_when_leaving", 1),
          (call_script, "script_auto_buy_food"), ## CC 1.322 new line, replacing the lines below
#          (try_begin),
...
#          (call_script, "script_auto_buy_food", ":merchant_troop"),
        ...
        (try_begin),
          (eq, "$g_sell_items_when_leaving", 1),
          (call_script, "script_auto_sell_all"), ## CC 1.322 new line, replacing the lines below
#          (try_begin),
#            (is_between, "$current_town", towns_begin, towns_end),
...
#          (try_end),
        (try_end),
        ## CC
#        (change_screen_return,0), ## CC 1.322: this line is removed
      ],"Leave Area."),
## CC
  ...
  (
	...
	("visit_lady_7",[(gt, "$love_interest_in_town_7", 0),(str_store_troop_name, s12, "$love_interest_in_town_7"),], ##1.132, five new lines
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
  ...
  (
    ...
    "As the most skilled tradesman of your company, ({reg2}), {reg3?you expect:{s1} expects} that collecting taxes from here will take {reg4} days...",
    "none",
...
# They must learn field discipline and the steadiness to follow orders in combat before they can be thought to use arms.",
  (
    ...
    "As the most experienced taskmaster of your company, ({reg2}), {reg3?you expect:{s1} expects} that getting some peasants ready for practice will take {reg4} hours.",
    "none",
  ...
  (
    ...
    [
     ...
     (try_for_range, ":cur_good", trade_goods_begin, trade_goods_end),
	   (neq, ":cur_good", "itm_trade_pork"), #tied to price of grain
	   (neq, ":cur_good", "itm_trade_chicken"), #tied to price of grain
	   (neq, ":cur_good", "itm_trade_butter"), #tied to price of cheese
	   (neq, ":cur_good", "itm_trade_cattle_meat"),
	   (neq, ":cur_good", "itm_trade_cabbages"), #possibly include later
...
## CC
 ...
 will be sold to {reg2?all merchants:the elder} in current {reg2?town:village} automatically.\
...
##	(call_script, "script_merchant_road_info_to_s42", "$g_encountered_party"),
    ...
    [
      ...
      ## CC
      ("go_back",[],"Go back",[(jump_to_menu,"mnu_town_trade")]), ##This was made official in 1.134
      ## CC
    ]
  ),
  ...
  (
    ...
    "As the most skilled tradesman of your company, ({reg2}), {reg3?you try to figure out:{s1} tries to figure out} the best goods to trade in. {s2}",
    "none",
    [
(call_script, "script_get_max_skill_of_player_party", "skl_trade"),
     (assign, ":max_skill", reg0),
     ...
     (assign, ":best_result_4_item", -1),						#	Port 1.143 // Newly Added
     (assign, ":best_result_4_town", -1),
     (assign, ":best_result_4_profit", 0),
     (assign, ":best_result_5_item", -1),
     (assign, ":best_result_5_town", -1),
     (assign, ":best_result_5_profit", 0),						#	End

     (store_sub, ":num_towns", walled_centers_end, walled_centers_begin),  #	Port 1.143 // towns_ changed to walled_centers
     ...
     (try_for_range, ":unused", 0, ":max_iteration"),
       ...
       (party_get_slot, ":cur_merchant", ":org_encountered_party", slot_town_merchant),       				#	Port 1.143 // Newly added
	   ...
	   (try_begin),
         ...
         (val_add, ":already_best", 1),
       (try_end),
																#	1.143 Port // little changes above, Newly added/overhauled below, see native 1.134
	   (try_begin),
       ...
       (try_begin),
	     (this_or_next|eq, ":best_result_1_item", ":random_trade_good"),		#	1.143 Port // Overhaul
     ...
     (else_try),
       (try_begin),
         (ge, ":best_result_5_item", 0),																							#	1.143 Port // Newly added
...
##diplomacy end+
  ...
  (
    ...
    "Sovereignty Fails to Respond^^The {s1} has not responded to the {s2}'s provocations, and {s3} suffers a loss of face among {reg4?her:his} more bellicose subjects...^",
    "none",
    [
      (str_store_faction_name, s1, "$g_notification_menu_var1"),
      (str_store_faction_name, s2, "$g_notification_menu_var2"),
...
##diplomacy end+
  ...
  [
    ...
    ##diplomacy begin
		##Floris MTT begin
		(troop_get_slot,":woman_peasant","$troop_trees",slot_woman_peasant),
		(neg|party_slot_eq, ":walled_center", slot_village_infested_by_bandits, ":woman_peasant"),
		##Floris MTT end
    ##diplomacy end
		(store_faction_of_party, ":walled_center_faction", ":walled_center"),
		##diplomacy start+ Handle player is co-ruler of NPC kingdom
  ...
  (
    ...
    "Your sovereignty no longer holds fief to any land.",
    "none",
    [
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 65),
...
## CC
  (
    ...
    "Restoration^^{s10} have renounced their allegiance to the {s12} and restorated their home sovereignty: The {s11}.",
    "none",
    [
      (str_clear, s0),
      (assign, ":num_lords", 0),
      (try_for_range, ":cur_troop", lords_begin, lords_end),
        ...
        (eq, ":troop_cur_faction", "$g_notification_menu_var2"),
    ...
    [
      (try_begin),
		...
		##Floris MTT begin
			...
			(neq, ":template", "pt_looter_lair_r"),
			(neq, ":template", "pt_looter_lair_e"),
		##Floris MTT end
      ...
      (else_try),        
        ...
        (str_store_string, s5, "str_bandit_approach_defile"),
				...
				##Floris MTT begin
				(try_begin),
					(troop_slot_eq, "$troop_trees",slot_bandit_desert, ":bandit_type"),
					(str_store_string, s5, "str_bandit_approach_defile"),
				(else_try),
					(troop_slot_eq, "$troop_trees",slot_bandit_mountain, ":bandit_type"),
					(str_store_string, s5, "str_bandit_approach_cliffs"),
				(else_try),
					(troop_slot_eq, "$troop_trees",slot_bandit_forest, ":bandit_type"),
					(str_store_string, s5, "str_bandit_approach_swamp"),
				(else_try),
					(troop_slot_eq, "$troop_trees",slot_bandit_taiga, ":bandit_type"),
					(str_store_string, s5, "str_bandit_approach_swamp"),
				(else_try),
					(troop_slot_eq, "$troop_trees",slot_bandit_steppe, ":bandit_type"),
					(str_store_string, s5, "str_bandit_approach_thickets"),
				(else_try),
					(troop_slot_eq, "$troop_trees",slot_bandit_sea_raider, ":bandit_type"),
		...
		##Floris MTT begin
			...
			(this_or_next|eq, ":template", "pt_looter_lair_r"),
			(eq, ":template", "pt_looter_lair_e"),
		##Floris MTT end
    ...
    [
	  ...
	  [
		...
		##Floris MTT begin
			...
			(this_or_next|eq, ":template", "pt_sea_raider_lair_r"),
			(eq, ":template", "pt_sea_raider_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_sea_raider),
			(assign, ":scene_to_use", "scn_lair_sea_raiders"),
		(else_try),	
		##Floris MTT begin
			(this_or_next|eq, ":template", "pt_forest_bandit_lair"),
			(this_or_next|eq, ":template", "pt_forest_bandit_lair_r"),
			(eq, ":template", "pt_forest_bandit_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_forest),
			(assign, ":scene_to_use", "scn_lair_forest_bandits"),
		(else_try),
		##Floris MTT begin
			(this_or_next|eq, ":template", "pt_desert_bandit_lair"),
			(this_or_next|eq, ":template", "pt_desert_bandit_lair_r"),
			(eq, ":template", "pt_desert_bandit_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_desert),
			(assign, ":scene_to_use", "scn_lair_desert_bandits"),
		(else_try),
		##Floris MTT begin
			(this_or_next|eq, ":template", "pt_mountain_bandit_lair"),
			(this_or_next|eq, ":template", "pt_mountain_bandit_lair_r"),
			(eq, ":template", "pt_mountain_bandit_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_mountain),
			(assign, ":scene_to_use", "scn_lair_mountain_bandits"),
		(else_try),
		##Floris MTT begin
			(this_or_next|eq, ":template", "pt_taiga_bandit_lair"),
			(this_or_next|eq, ":template", "pt_taiga_bandit_lair_r"),
			(eq, ":template", "pt_taiga_bandit_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_taiga),
			(assign, ":scene_to_use", "scn_lair_taiga_bandits"),
		(else_try),
		##Floris MTT begin
			(this_or_next|eq, ":template", "pt_steppe_bandit_lair"),
			(this_or_next|eq, ":template", "pt_steppe_bandit_lair_r"),
			(eq, ":template", "pt_steppe_bandit_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_steppe),
		...
		##Floris MTT begin
			...
			(eq, ":template", "pt_looter_lair_e"),
		##Floris MTT end
			(troop_get_slot,":bandit_troop","$troop_trees",slot_bandit_looter),
		##Floris MTT end
...
################################################################
  ...
  ("auto_loot", 0,
    "Your companions will automatically grab items from the item pool based on their pre-selected upgrade options. Companions listed first in the party order will have first pick. Any equipment no longer needed will be placed back into the item pool. Are you sure you wish to do this?",
    "none", [],
    [
      ("No", [],
...
########################################################
	...
	##Floris MTT: Multiple troop trees
	  ("choose_options_1", 0,
		"Choose the troop trees you'd like to use. Once choosen you can't change it.^^The Native tree is very simple and straight forward, while the Expanded tree is complex with a lot of options and variety. The Reworked tree is a compromise between both other trees.", "none", [],
		[
		  ("native_troop_trees", [], "Native troop trees",
			[
		  ...
		  ("reworked_troop_trees", [], "Reworked troop trees",
			[
		  ...
		  ("expanded_troop_trees", [], "Expanded troop trees",
			[
				(assign, "$troop_trees", troop_trees_2),
				(call_script, "script_initialize_troop_tree_sets"), # Technically not needed for this troop tree, but there are a couple important things in that script / spawn bandits, initialize town mercs
				(jump_to_menu,"mnu_choose_options_2"),
			]
		  ),
		  ("go_back", [], "Go back",
...
## CC
  ("choose_options_2", 0,
    "Assemble all companions at the tavern of the first encountered town?^^When you assemble them, you might take a look upstairs in the tavern, since a lot of companions might be lingering in the hallway, sitting on the stairs or inspecting their rooms. If your favorite companion isn't present, you might want to quit and re-enter the tavern: sometimes they don't all fit.", "none", [],
    [
      ("yes_npcs", [], "Yes",
        [
  ...
  ("choose_options_3", 0,
    "Do you wish to play with the fog of war?", "none", [],
    [
      ("yes_npcs", [], "Yes",
        [
          (assign, "$g_fog", 1),
  ...
  ("choose_options_end", 0,
   "Game options selection complete.", "none", [],
    [
	  ...
	  [
	  (jump_to_menu,"mnu_start_game_0"),
	  (assign, "$g_date", 0),				#	Time starts normal, can be changed in mod options
	  ]),
      ("go_back", [], "Go back", [(jump_to_menu,"mnu_choose_options_3"),]),
    ]),
...
## CC
  ...
  ("town_menu_cheats", 0,
   "CHEATS.", "none", [],
    [
## CC 1.322 new lines, disabled in 1.324
#      ("town_view_defenders", [],
#      "{!}CHEAT: View the details of defenders.",
#      [
#        (party_set_flags, "$current_town", pf_hide_defenders, 0),
#        (change_screen_return),
#      ]),
##
      ("town_alley",
...
##nested diplomacy end+
  ...
  (
    ...
    "You can now shape the domestic policy of your sovereignty. Do you want to change your policy now?",
    "none",
    [
      (try_begin),
...
(
 ...
 He looks at you and says:^What do you want {lad/lass}? Don't ya see that I am busy?",
    "none",
    [
	(set_background_mesh,"mesh_pic_ships_port"),
...
(
	...
	"none",
	[	(set_background_mesh,"mesh_pic_ships_rego"),
		(str_clear, s3),
	    (try_for_range, ":town_no", towns_begin, towns_end),
		    (party_slot_ge, ":town_no", slot_town_is_coastal, 1),
...
##LAZERAS MODIFIED  {Top Tier Troops Recruit}												##	FLORIS WIP Work in Progress
############################################################################
  ("upgrade_to_hero",0,
...
#Tempered entrenched camp menu not currently used
     ...
     ("proceed_promotion", [
       (gt, reg1, 0),
         ...
         (try_begin),
           ...
           (try_end),
           # Clear candidate stat cache (110-270)
           (try_for_range, ":i", 110, 271),
             (troop_set_slot, "trp_temp_array_a", ":i", 0),
           (try_end),
  ...
  ("lieutenant_recruitment", 0,
   "It is time to decide who among the volunteers is worthy of being promoted to Lieutenant.",
   "none",
   [
     (jump_to_menu, "mnu_camp"),
   ],
