...
if os.path.exists(intern_dir_expanded_custom):
   print ("path", intern_dir_expanded_custom, "exists")
else:
   os.makedirs(os.path.dirname(intern_dir_expanded_custom))

# ensure internal Data dir exists
data_dir_internal = intern_dir_expanded_custom + "/Data"
...
# Main Files
shutil.copy("./actions.txt",intern_dir_expanded_custom + "/actions.txt")
shutil.copy("./conversation.txt",intern_dir_expanded_custom + "/conversation.txt")
shutil.copy("./dialog_states.txt",intern_dir_expanded_custom + "/dialog_states.txt")
shutil.copy("./factions.txt",intern_dir_expanded_custom + "/factions.txt")
shutil.copy("./info_pages.txt",intern_dir_expanded_custom + "/info_pages.txt")
shutil.copy("./item_kinds1.txt",intern_dir_expanded_custom + "/item_kinds1.txt")
shutil.copy("./map_icons.txt",intern_dir_expanded_custom + "/map_icons.txt")
shutil.copy("./menus.txt",intern_dir_expanded_custom + "/menus.txt")
shutil.copy("./meshes.txt",intern_dir_expanded_custom + "/meshes.txt")
shutil.copy("./mission_templates.txt",intern_dir_expanded_custom + "/mission_templates.txt")
shutil.copy("./music.txt",intern_dir_expanded_custom + "/music.txt")
shutil.copy("./particle_systems.txt",intern_dir_expanded_custom + "/particle_systems.txt")
shutil.copy("./parties.txt",intern_dir_expanded_custom + "/parties.txt")
shutil.copy("./party_templates.txt",intern_dir_expanded_custom + "/party_templates.txt")
shutil.copy("./postfx.txt",intern_dir_expanded_custom + "/postfx.txt")
shutil.copy("./presentations.txt",intern_dir_expanded_custom + "/presentations.txt")
shutil.copy("./quests.txt",intern_dir_expanded_custom + "/quests.txt")
shutil.copy("./quick_strings.txt",intern_dir_expanded_custom + "/quick_strings.txt")
shutil.copy("./scene_props.txt",intern_dir_expanded_custom + "/scene_props.txt")
shutil.copy("./scenes.txt",intern_dir_expanded_custom + "/scenes.txt")
shutil.copy("./scripts.txt",intern_dir_expanded_custom + "/scripts.txt")
shutil.copy("./simple_triggers.txt",intern_dir_expanded_custom + "/simple_triggers.txt")
shutil.copy("./skills.txt",intern_dir_expanded_custom + "/skills.txt")
shutil.copy("./skins.txt",intern_dir_expanded_custom + "/skins.txt")
shutil.copy("./sounds.txt",intern_dir_expanded_custom + "/sounds.txt")
shutil.copy("./strings.txt",intern_dir_expanded_custom + "/strings.txt")
shutil.copy("./tableau_materials.txt",intern_dir_expanded_custom + "/tableau_materials.txt")
shutil.copy("./tag_uses.txt",intern_dir_expanded_custom + "/tag_uses.txt")
shutil.copy("./triggers.txt",intern_dir_expanded_custom + "/triggers.txt")
shutil.copy("./troops.txt",intern_dir_expanded_custom + "/troops.txt")
shutil.copy("./variable_uses.txt",intern_dir_expanded_custom + "/variable_uses.txt")
shutil.copy("./variables.txt",intern_dir_expanded_custom + "/variables.txt")
# Data Files
shutil.copy("./flora_kinds.txt",intern_dir_expanded_custom + "/Data/flora_kinds.txt")
shutil.copy("./ground_specs.txt",intern_dir_expanded_custom + "/Data/ground_specs.txt")
shutil.copy("./skyboxes.txt",intern_dir_expanded_custom + "/Data/skyboxes.txt")
# Other Files
shutil.copy("./game_variables.txt",intern_dir_expanded_custom + "/game_variables.txt")
shutil.copy("./main.bmp",intern_dir_expanded_custom + "/main.bmp")
shutil.copy("./map.txt",intern_dir_expanded_custom + "/map.txt")
shutil.copy("./module.ini",intern_dir_expanded_custom + "/module.ini")
