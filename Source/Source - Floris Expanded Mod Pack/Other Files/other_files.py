...
sys.path.insert(0, os.path.abspath("../Module Info"))
...
print("export_dir_expanded:", export_dir_expanded)
...
src = os.path.abspath("../Files/Specific Textures/Expanded/warrider_logo.dds")
# Destination path
dst = os.path.normpath(os.path.join(export_dir_main, export_dir_expanded, "Textures", "warrider_logo.dds"))
dst_dir = os.path.dirname(dst)
print("Moving warrider_logo.dds from", src, "to", dst)
...
if os.path.isfile(src):
    ...
    print("Warning: warrider_logo.dds not found at", src)
