...
print " "
print "Copying source files to internal directory 1..."
print "checking path"
print ("checking path", intern_dir_basic_custom)

if os.path.exists(intern_dir_basic_custom):
   print ("path", intern_dir_basic_custom, "exists")
else:
   os.makedirs(os.path.dirname(intern_dir_basic_custom))

# ensure internal Data dir exists
data_dir_internal = intern_dir_basic_custom + "/Data"
if not os.path.exists(data_dir_internal):
  os.makedirs(data_dir_internal)

# ensure game module dirs exist
module_dir = export_dir_main + "/Modules/" + export_dir_custom
if not os.path.exists(module_dir):
  os.makedirs(module_dir)

module_data_dir = module_dir + "/Data"
if not os.path.exists(module_data_dir):
  os.makedirs(module_data_dir)

# Main Files
shutil.copy("./actions.txt",intern_dir_basic_custom + "/actions.txt")
shutil.copy("./conversation.txt",intern_dir_basic_custom + "/conversation.txt")
shutil.copy("./dialog_states.txt",intern_dir_basic_custom + "/dialog_states.txt")
shutil.copy("./factions.txt",intern_dir_basic_custom + "/factions.txt")
shutil.copy("./info_pages.txt",intern_dir_basic_custom + "/info_pages.txt")
shutil.copy("./item_kinds1.txt",intern_dir_basic_custom + "/item_kinds1.txt")
shutil.copy("./map_icons.txt",intern_dir_basic_custom + "/map_icons.txt")
shutil.copy("./menus.txt",intern_dir_basic_custom + "/menus.txt")
shutil.copy("./meshes.txt",intern_dir_basic_custom + "/meshes.txt")
shutil.copy("./mission_templates.txt",intern_dir_basic_custom + "/mission_templates.txt")
shutil.copy("./music.txt",intern_dir_basic_custom + "/music.txt")
shutil.copy("./particle_systems.txt",intern_dir_basic_custom + "/particle_systems.txt")
shutil.copy("./parties.txt",intern_dir_basic_custom + "/parties.txt")
shutil.copy("./party_templates.txt",intern_dir_basic_custom + "/party_templates.txt")
shutil.copy("./postfx.txt",intern_dir_basic_custom + "/postfx.txt")
shutil.copy("./presentations.txt",intern_dir_basic_custom + "/presentations.txt")
shutil.copy("./quests.txt",intern_dir_basic_custom + "/quests.txt")
shutil.copy("./quick_strings.txt",intern_dir_basic_custom + "/quick_strings.txt")
shutil.copy("./scene_props.txt",intern_dir_basic_custom + "/scene_props.txt")
shutil.copy("./scenes.txt",intern_dir_basic_custom + "/scenes.txt")
shutil.copy("./scripts.txt",intern_dir_basic_custom + "/scripts.txt")
shutil.copy("./simple_triggers.txt",intern_dir_basic_custom + "/simple_triggers.txt")
shutil.copy("./skills.txt",intern_dir_basic_custom + "/skills.txt")
shutil.copy("./skins.txt",intern_dir_basic_custom + "/skins.txt")
shutil.copy("./sounds.txt",intern_dir_basic_custom + "/sounds.txt")
shutil.copy("./strings.txt",intern_dir_basic_custom + "/strings.txt")
shutil.copy("./tableau_materials.txt",intern_dir_basic_custom + "/tableau_materials.txt")
shutil.copy("./tag_uses.txt",intern_dir_basic_custom + "/tag_uses.txt")
shutil.copy("./triggers.txt",intern_dir_basic_custom + "/triggers.txt")
shutil.copy("./troops.txt",intern_dir_basic_custom + "/troops.txt")
shutil.copy("./variable_uses.txt",intern_dir_basic_custom + "/variable_uses.txt")
shutil.copy("./variables.txt",intern_dir_basic_custom + "/variables.txt")
# Data Files
shutil.copy("./flora_kinds.txt",intern_dir_basic_custom + "/Data/flora_kinds.txt")
shutil.copy("./ground_specs.txt",intern_dir_basic_custom + "/Data/ground_specs.txt")
shutil.copy("./skyboxes.txt",intern_dir_basic_custom + "/Data/skyboxes.txt")
# Other Files
shutil.copy("./game_variables.txt",intern_dir_basic_custom + "/game_variables.txt")
shutil.copy("./main.bmp",intern_dir_basic_custom + "/main.bmp")
shutil.copy("./map.txt",intern_dir_basic_custom + "/map.txt")
shutil.copy("./module.ini",intern_dir_basic_custom + "/module.ini")
